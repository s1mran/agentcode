...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "com.agentcode.desktop.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "AgentCode Dev")
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("agentcode://"))
    if (urls.length) {
  ...
  app.setAsDefaultProtocolClient("agentcode")
  registerRendererProtocol()
  setDockIcon()
