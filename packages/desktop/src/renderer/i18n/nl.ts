export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van AgentCode is gedownload. Wil je deze installeren en AgentCode opnieuw starten?",
