export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AgentCode er lastet ned. Vil du installere den og starte på nytt?",
