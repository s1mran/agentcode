export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i AgentCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
