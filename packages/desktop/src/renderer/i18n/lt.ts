export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią AgentCode versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "AgentCode versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
