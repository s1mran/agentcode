export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} AgentCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
