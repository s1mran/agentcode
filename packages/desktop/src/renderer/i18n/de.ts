export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AgentCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
