export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko AgentCode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "AgentCode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
