export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo AgentCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "AgentCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää AgentCoden uudelleen?",
