export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av AgentCode har laddats ned. Vill du installera den och starta om programmet?",
