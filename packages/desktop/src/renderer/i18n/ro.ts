export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} AgentCode a fost descărcată. Vrei să o instalezi și să repornești?",
