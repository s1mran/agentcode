export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք AgentCode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "AgentCode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
