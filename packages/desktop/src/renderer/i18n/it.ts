export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di AgentCode è stata scaricata. Vuoi installarla e riavviare l'app?",
