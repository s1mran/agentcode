export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} AgentCode je bila prenesena, jo želite namestiti in znova zagnati?",
