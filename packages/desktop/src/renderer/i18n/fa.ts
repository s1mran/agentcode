export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه AgentCode استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} AgentCode دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
