export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የAgentCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከAgentCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
