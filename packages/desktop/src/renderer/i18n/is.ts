export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af AgentCode hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
