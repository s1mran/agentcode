export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от AgentCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
