export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AgentCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AgentCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
