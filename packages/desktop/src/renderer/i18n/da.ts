export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AgentCode er blevet downloadet. Vil du installere den og genstarte?",
