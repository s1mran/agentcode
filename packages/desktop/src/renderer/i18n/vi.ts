export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của AgentCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của AgentCode đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
