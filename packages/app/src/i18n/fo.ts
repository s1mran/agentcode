export const dict = {
  ...
  "desktop.menu.documentation": "Skjøl",
  ...
  "desktop.menu.ariaLabel": "AgentCode valmynd",
  ...
  "desktop.recovery.loadFailed": "AgentCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "AgentCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "AgentCode svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "command.agent.cycle.hint": "[agentur]",
  ...
  "command.session.compact.hint": "[fokusvegleiðingar]",
  ...
  "command.session.export.hint": "[fílunavn]",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í AgentCode.",
  ...
  "prompt.slash.badge.builtin": "innbygt",
  "prompt.slash.hint.arguments": "[argument]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Ókend skipan: /{{name}}",
  "prompt.slash.unknown.description": "Byrja boðini við einum millumrúmi fyri at senda hana sum tekst.",
  "prompt.slash.unavailable.title": "/{{name}} er ikki tøk her",
  "prompt.slash.noArguments.title": "/{{name}} tekur ikki ímóti argumentum",
  ...
  "dialog.server.description": "Skift hvønn AgentCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna AgentCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring AgentCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør AgentCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set AgentCode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn AgentCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "AgentCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani AgentCode aftur.",
  ...
  "help.tabs.introduction": "AgentCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Onnur samsvar: {{count}}. Koyr /model fyri at velja eitt.",
  "toast.model.noMatch.title": "Einki modell samsvarar við „{{query}}“",
  "toast.agent.noMatch.title": "Eingin agentur við navninum „{{query}}“",
  ...
  "toast.update.description": "Ein nýggj útgáva av AgentCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til AgentCode toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, AgentCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "AgentCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr AgentCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri AgentCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu AgentCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um AgentCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu AgentCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá AgentCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av AgentCode.",
