export const dict = {
  ...
  "desktop.menu.documentation": "Hujjatlar",
  ...
  "desktop.menu.ariaLabel": "AgentCode menyusi",
  ...
  "desktop.recovery.loadFailed": "AgentCode yuklanmadi",
  "desktop.recovery.terminated": "AgentCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "AgentCode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "AgentCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "command.model.choose.hint": "[model]",
  ...
  "command.permissionMode.cycle": "Ruxsat rejimini almashtirish",
  "command.permissionMode.set": "Ruxsat rejimi: {{mode}}",
  "command.permissionMode.bypass": "Ruxsatlarni chetlab oʻtish…",
  "command.plan": "Rejalashtirish rejimi",
  ...
  "command.session.compact.hint": "[diqqat ko'rsatmalari]",
  ...
  "command.session.export.hint": "[fayl nomi]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va AgentCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va AgentCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va AgentCode da {{provider}} modellaridan foydalaning.",
  ...
  "prompt.permissionMode.label": "Ruxsat rejimi",
  "prompt.permissionMode.default": "Ruxsat soʻrash",
  "prompt.permissionMode.default.description": "Buyruqlar, tahrirlar va vebga kirishdan oldin soʻraydi",
  "prompt.permissionMode.acceptEdits": "Tahrirlarni qabul qilish",
  "prompt.permissionMode.acceptEdits.description":
    "Bu loyihadagi tahrirlar tasdiqlanadi; buyruqlar uchun hali ham soʻraydi",
  "prompt.permissionMode.plan": "Rejalashtirish rejimi",
  "prompt.permissionMode.plan.description": "Faqat oʻqish uchun tadqiqot; faqat reja faylini tahrirlash mumkin",
  "prompt.permissionMode.bypassPermissions": "Ruxsatlarni chetlab oʻtish",
  "prompt.permissionMode.bypassPermissions.description":
    "Himoyalangan yoʻllar, muhim oʻchirishlar va «Soʻrang» qoidalaringizdan tashqari hollarda soʻramasdan ishlaydi",
  "prompt.permissionMode.dontAsk": "Soʻramaslik",
  "prompt.permissionMode.dontAsk.description": "Soʻrashni talab qiladigan har qanday amal rad etiladi",
  ...
  "prompt.slash.badge.builtin": "ichki",
  "prompt.slash.hint.arguments": "[argumentlar]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Noma'lum buyruq: /{{name}}",
  "prompt.slash.unknown.description": "Matn sifatida yuborish uchun xabarni bo'sh joy bilan boshlang.",
  "prompt.slash.unavailable.title": "/{{name}} bu yerda mavjud emas",
  "prompt.slash.noArguments.title": "/{{name}} argument qabul qilmaydi",
  ...
  "dialog.bypassPermissions.title": "Ruxsatlar chetlab oʻtilsinmi?",
  "dialog.bypassPermissions.body":
    "Agent soʻramasdan buyruqlarni ishga tushiradi, fayllarni tahrirlaydi va vebga kiradi. Himoyalangan yoʻllar (.git, agent konfiguratsiyasi, shell ishga tushirish fayllari), muhim oʻchirishlar va oʻzingizning «Soʻrang» qoidalaringiz uchun hali ham soʻraydi; «Rad etish» qoidalari amalda qoladi. Buni faqat oʻzingiz ishonadigan loyihada ishlating.",
  "dialog.bypassPermissions.confirm": "Ruxsatlarni chetlab oʻtish",
  "dialog.bypassPermissions.cancel": "Bekor qilish",
  "ui.permission.always.project": "Bu loyihada har doim ruxsat berish",
  "ui.permission.always.session": "Bu sessiya uchun ruxsat berish",
  "ui.permission.always.acceptEdits": "Barcha tahrirlarga ruxsat berish (Tahrirlarni qabul qilish)",
  "ui.permission.always.everything": "bu vosita uchun hamma narsa",
  "ui.permission.guard.floor.title": "Himoyalangan amal",
  "ui.permission.guard.guard.title": "Koʻrib chiqish kerak",
  "ui.permission.guard.noAlways": "Buni faqat bir marta tasdiqlash mumkin",
  "ui.permission.writes": "Yoziladigan joy",
  "ui.question.planFeedback.placeholder": "Agentga rejada nimani oʻzgartirish kerakligini ayting",
  ...
  "dialog.server.description": "Ushbu ilova qaysi AgentCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "AgentCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "AgentCode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "AgentCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "AgentCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "AgentCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "AgentCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "AgentCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "AgentCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra AgentCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "AgentCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Avtomatik qabul qilish endi «Tahrirlarni qabul qilish» deb ataladi",
  "toast.permissions.modeMigrated.description":
    "Bu jilddagi tahrirlar avtomatik tasdiqlanadi; buyruqlar uchun hali ham soʻraydi. Toʻliq avtonomiya uchun kompozitorda «Ruxsatlarni chetlab oʻtish» rejimini tanlang.",
  "toast.permissions.autoAcceptRemoved.title": "Avtomatik qabul qilish oʻchirildi",
  "toast.permissions.autoAcceptRemoved.modes":
    "Ruxsat soʻrovlari yana koʻrsatiladi. Tahrirlarni avtomatik tasdiqlash uchun soʻrov maydoni yonidagi rejim menyusidan «Tahrirlarni qabul qilish» rejimini tanlang yoki Shift+Tab tugmasini bosing.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Ruxsat soʻrovlari yana koʻrsatiladi. Ularni oʻtkazib yuborish uchun ushbu serverning ruxsat konfiguratsiyasida oʻsha vositalarga ruxsat bering.",
  "toast.permissions.mode.error.title": "Ruxsat rejimini oʻzgartirib boʻlmadi",
  ...
  "toast.model.selected.title": "Model: {{name}}",
  "toast.model.selected.others": "Boshqa mosliklar: {{count}}. Birini tanlash uchun /model ni ishga tushiring.",
  "toast.model.noMatch.title": "“{{query}}” ga mos model yo'q",
  "toast.agent.noMatch.title": "“{{query}}” nomli agent yo'q",
  ...
  "toast.update.description": "AgentCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida AgentCode jamoasiga xabar bering",
  "error.page.report.discord": "GitHub-da",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, AgentCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "AgentCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi AgentCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "AgentCode uchun ekran tilini o'zgartiring",
  "settings.general.permissionMode.title": "Birlamchi ruxsat rejimi",
  "settings.general.permissionMode.description": "Bu jilddagi yangi sessiyalar uchun ishlatiladi",
  ...
  "settings.general.row.appearance.description": "AgentCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "AgentCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "AgentCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description":
    "AgentCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz AgentCode oxirgi versiyasini ishga tushiryapsiz.",
