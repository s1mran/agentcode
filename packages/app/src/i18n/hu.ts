...
const desktop = [
  ...
  "Kilépés",
  "Az AgentCode betöltése sikertelen",
  "Az AgentCode ablaka váratlanul leállt",
  "Az AgentCode nem válaszol",
  ...
  "Az AgentCode telepítése sikertelen",
  ...
  "Az AgentCode nincs telepítve ebben: {{distro}}",
  "Az AgentCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "command.agent.cycle.hint": "[ügynök]",
  ...
  "command.permissionMode.cycle": "Engedélyezési mód váltása",
  "command.permissionMode.set": "Engedélyezési mód: {{mode}}",
  "command.permissionMode.bypass": "Engedélyek megkerülése…",
  "command.plan": "Tervezési mód",
  ...
  "command.session.compact.hint": "[fókuszutasítások]",
  ...
  "command.session.export.hint": "[fájlnév]",
  ...
  "dialog.model.unpaid.freeModels.title": "Az AgentCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához az AgentCode-ban.",
  ...
  "provider.connect.opencodeZen.line1":
    "Az OpenCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához az AgentCode-ban.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket az AgentCode-ban.",
  ...
  "prompt.permissionMode.label": "Engedélyezési mód",
  "prompt.permissionMode.default": "Engedélyek kérése",
  "prompt.permissionMode.default.description": "Parancsok, szerkesztések és webes hozzáférés előtt rákérdez",
  "prompt.permissionMode.acceptEdits": "Szerkesztések elfogadása",
  "prompt.permissionMode.acceptEdits.description":
    "Ebben a projektben a szerkesztések jóvá vannak hagyva; a parancsoknál továbbra is rákérdez",
  "prompt.permissionMode.plan": "Tervezési mód",
  "prompt.permissionMode.plan.description": "Csak olvasható kutatás; csak a tervfájl szerkeszthető",
  "prompt.permissionMode.bypassPermissions": "Engedélyek megkerülése",
  "prompt.permissionMode.bypassPermissions.description":
    "Kérdés nélkül fut, kivéve a védett útvonalakat, a kritikus törléseket és a rákérdezési szabályait",
  "prompt.permissionMode.dontAsk": "Ne kérdezzen",
  "prompt.permissionMode.dontAsk.description": "Amire rákérdezne, azt elutasítja",
  ...
  "prompt.slash.badge.builtin": "beépített",
  "prompt.slash.hint.arguments": "[argumentumok]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Ismeretlen parancs: /{{name}}",
  "prompt.slash.unknown.description": "Ha szövegként szeretné elküldeni, kezdje az üzenetet szóközzel.",
  "prompt.slash.unavailable.title": "A(z) /{{name}} itt nem érhető el",
  "prompt.slash.noArguments.title": "A(z) /{{name}} nem fogad argumentumokat",
  ...
  "dialog.bypassPermissions.title": "Megkerüli az engedélyeket?",
  "dialog.bypassPermissions.body":
    "Az ügynök kérdés nélkül futtat parancsokat, szerkeszt fájlokat és fér hozzá a webhez. A védett útvonalaknál (.git, ügynökkonfiguráció, shell indítófájlok), a kritikus törléseknél és a saját rákérdezési szabályainál továbbra is rákérdez; a tiltó szabályok továbbra is érvényesek. Csak megbízható projektben használja.",
  "dialog.bypassPermissions.confirm": "Engedélyek megkerülése",
  "dialog.bypassPermissions.cancel": "Mégsem",
  "ui.permission.always.project": "Mindig engedje meg ebben a projektben",
  "ui.permission.always.session": "Engedje meg ebben a munkamenetben",
  "ui.permission.always.acceptEdits": "Minden szerkesztés engedélyezése (Szerkesztések elfogadása)",
  "ui.permission.always.everything": "minden ennél az eszköznél",
  "ui.permission.guard.floor.title": "Védett művelet",
  "ui.permission.guard.guard.title": "Áttekintést igényel",
  "ui.permission.guard.noAlways": "Ez csak egyszer hagyható jóvá",
  "ui.permission.writes": "Írás ide",
  "ui.question.planFeedback.placeholder": "Mondja meg az ügynöknek, mit változtasson a terven",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik AgentCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "AgentCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "AgentCode frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse az AgentCode-ot a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse az AgentCode-ot",
  "wsl.onboarding.opencodeReadyIn": "Az AgentCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "Az AgentCode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse az AgentCode-ot a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse az AgentCode-ot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Az AgentCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy az AgentCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "Az AgentCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra az AgentCode programot.",
  ...
  "help.tabs.introduction": "Az AgentCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Az automatikus elfogadás mostantól Szerkesztések elfogadása",
  "toast.permissions.modeMigrated.description":
    "Ebben a mappában a szerkesztések automatikusan jóváhagyásra kerülnek; a parancsoknál továbbra is rákérdez. Teljes önállósághoz válassza az Engedélyek megkerülése lehetőséget a beviteli mezőben.",
  "toast.permissions.autoAcceptRemoved.title": "Az automatikus elfogadás ki lett kapcsolva",
  "toast.permissions.autoAcceptRemoved.modes":
    "Az engedélykérések ismét megjelennek. A szerkesztések automatikus jóváhagyásához válassza a Szerkesztések elfogadása lehetőséget az utasítás melletti módmenüben, vagy nyomja meg a Shift+Tab billentyűkombinációt.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Az engedélykérések ismét megjelennek. Kihagyásukhoz engedélyezze ezeket az eszközöket a szerver engedélykonfigurációjában.",
  "toast.permissions.mode.error.title": "Nem sikerült módosítani az engedélyezési módot",
  ...
  "toast.model.selected.others": "További találatok: {{count}}. Futtassa a /model parancsot a választáshoz.",
  "toast.model.noMatch.title": "Egy modell sem egyezik ezzel: „{{query}}”",
  "toast.agent.noMatch.title": "Nincs „{{query}}” nevű ügynök",
  ...
  "toast.update.description": "Az AgentCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát az AgentCode csapatának",
  "error.page.report.discord": "a GitHubon",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: az AgentCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "Az AgentCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "AgentCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa az AgentCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa az AgentCode kijelző nyelvét",
  "settings.general.permissionMode.title": "Alapértelmezett engedélyezési mód",
  "settings.general.permissionMode.description": "Az ebben a mappában indított új munkamenetekhez használatos",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki az AgentCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy az AgentCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre az AgentCode témáját.",
  ...
  "settings.updates.row.startup.description": "Az AgentCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön az AgentCode legújabb verzióját futtatja.",
