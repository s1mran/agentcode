export const dict = {
  ...
  "command.permissionMode.cycle": "권한 모드 순환",
  "command.permissionMode.set": "권한 모드: {{mode}}",
  "command.permissionMode.bypass": "권한 우회…",
  "command.plan": "계획 모드",
  ...
  "command.session.compact.hint": "[요약 초점]",
  ...
  "command.session.export.hint": "[파일 이름]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 AgentCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 AgentCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 AgentCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.permissionMode.label": "권한 모드",
  "prompt.permissionMode.default": "권한 묻기",
  "prompt.permissionMode.default.description": "명령, 편집, 웹 액세스 전에 묻습니다",
  "prompt.permissionMode.acceptEdits": "편집 수락",
  "prompt.permissionMode.acceptEdits.description": "이 프로젝트의 편집은 승인되며, 명령은 계속 묻습니다",
  "prompt.permissionMode.plan": "계획 모드",
  "prompt.permissionMode.plan.description": "읽기 전용 조사이며, 계획 파일만 편집할 수 있습니다",
  "prompt.permissionMode.bypassPermissions": "권한 우회",
  "prompt.permissionMode.bypassPermissions.description":
    "보호된 경로, 중요한 삭제, 사용자의 묻기 규칙을 제외하고 묻지 않고 실행합니다",
  "prompt.permissionMode.dontAsk": "묻지 않음",
  "prompt.permissionMode.dontAsk.description": "묻게 될 모든 작업이 거부됩니다",
  ...
  "prompt.slash.badge.builtin": "기본 제공",
  "prompt.slash.hint.arguments": "[인수]",
  "prompt.slash.hint.positional": "<인수{{n}}>",
  "prompt.slash.unknown.title": "알 수 없는 명령어: /{{name}}",
  "prompt.slash.unknown.description": "텍스트로 보내려면 메시지를 공백으로 시작하세요.",
  "prompt.slash.unavailable.title": "/{{name}}은(는) 여기에서 사용할 수 없습니다",
  "prompt.slash.noArguments.title": "/{{name}}은(는) 인수를 받지 않습니다",
  ...
  "dialog.bypassPermissions.title": "권한을 우회하시겠습니까?",
  "dialog.bypassPermissions.body":
    "에이전트가 묻지 않고 명령을 실행하고, 파일을 편집하고, 웹에 액세스합니다. 보호된 경로(.git, 에이전트 구성, 셸 시작 파일), 중요한 삭제, 사용자의 묻기 규칙은 계속 묻고, 거부 규칙도 계속 적용됩니다. 신뢰하는 프로젝트에서만 사용하세요.",
  "dialog.bypassPermissions.confirm": "권한 우회",
  "dialog.bypassPermissions.cancel": "취소",
  "ui.permission.always.project": "이 프로젝트에서 항상 허용",
  "ui.permission.always.session": "이 세션에서 허용",
  "ui.permission.always.acceptEdits": "모든 편집 허용 (편집 수락)",
  "ui.permission.always.everything": "이 도구의 모든 항목",
  "ui.permission.guard.floor.title": "보호된 작업",
  "ui.permission.guard.guard.title": "검토 필요",
  "ui.permission.guard.noAlways": "한 번만 승인할 수 있습니다",
  "ui.permission.writes": "쓰기 대상",
  "ui.question.planFeedback.placeholder": "계획에서 변경할 내용을 에이전트에게 알려 주세요",
  ...
  "dialog.server.description": "이 앱이 연결할 AgentCode 서버를 전환합니다.",
  ...
  "toast.permissions.modeMigrated.title": "자동 수락이 이제 편집 수락으로 바뀌었습니다",
  "toast.permissions.modeMigrated.description":
    "이 폴더의 편집은 자동으로 승인되며, 명령은 계속 묻습니다. 완전한 자율 실행을 원하면 입력창에서 권한 우회를 선택하세요.",
  "toast.permissions.autoAcceptRemoved.title": "자동 수락이 꺼졌습니다",
  "toast.permissions.autoAcceptRemoved.modes":
    "권한 요청이 다시 표시됩니다. 편집을 자동으로 승인하려면 프롬프트 옆 모드 메뉴에서 편집 수락을 선택하거나 Shift+Tab을 누르세요.",
  "toast.permissions.autoAcceptRemoved.rules":
    "권한 요청이 다시 표시됩니다. 건너뛰려면 이 서버의 권한 구성에서 해당 도구를 허용하세요.",
  "toast.permissions.mode.error.title": "권한 모드를 변경할 수 없습니다",
  "toast.model.none.title": "선택된 모델 없음",
  "toast.model.none.description": "이 세션을 요약하려면 공급자를 연결하세요",
  "toast.model.selected.title": "모델: {{name}}",
  "toast.model.selected.others": "다른 일치 항목: {{count}}개. /model을 실행해 선택하세요.",
  "toast.model.noMatch.title": "“{{query}}”와 일치하는 모델이 없습니다",
  "toast.agent.noMatch.title": "“{{query}}”라는 에이전트가 없습니다",
  ...
  "toast.update.description": "AgentCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 AgentCode 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: AgentCode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 AgentCode 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "AgentCode 표시 언어 변경",
  "settings.general.permissionMode.title": "기본 권한 모드",
  "settings.general.permissionMode.description": "이 폴더의 새 세션에 사용됩니다",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 AgentCode가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "AgentCode가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "AgentCode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "AgentCode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 AgentCode를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 AgentCode 확인 중...",
  "wsl.onboarding.updatingOpencode": "AgentCode 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 AgentCode 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 AgentCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "AgentCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 AgentCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "AgentCode가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 AgentCode를 설치하세요.",
  "wsl.onboarding.installOpencode": "AgentCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "AgentCode에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 AgentCode를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 AgentCode Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.menu.ariaLabel": "AgentCode 메뉴",
  ...
  "desktop.recovery.loadFailed": "AgentCode를 불러오지 못했습니다",
  "desktop.recovery.terminated": "AgentCode 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "AgentCode가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 AgentCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "AgentCode 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
