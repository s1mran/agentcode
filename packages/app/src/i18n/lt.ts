...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "AgentCode įkelti nepavyko",
  "AgentCode langas netikėtai užsidarė",
  "AgentCode neatsako",
  ...
  "AgentCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "AgentCode neįdiegtas distributyve {{distro}}",
  "AgentCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "command.agent.cycle.hint": "[agentas]",
  ...
  "command.permissionMode.cycle": "Perjungti leidimų veikseną",
  "command.permissionMode.set": "Leidimų veiksena: {{mode}}",
  "command.permissionMode.bypass": "Apeiti leidimus…",
  "command.plan": "Planavimo veiksena",
  ...
  "command.session.compact.hint": "[dėmesio nurodymai]",
  ...
  "command.session.export.hint": "[failo pavadinimas]",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami AgentCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius AgentCode.",
  ...
  "prompt.permissionMode.label": "Leidimų veiksena",
  "prompt.permissionMode.default": "Klausti leidimų",
  "prompt.permissionMode.default.description": "Klausia prieš komandas, redagavimus ir prieigą prie interneto",
  "prompt.permissionMode.acceptEdits": "Priimti redagavimus",
  "prompt.permissionMode.acceptEdits.description":
    "Šio projekto redagavimai patvirtinami; dėl komandų vis tiek klausiama",
  "prompt.permissionMode.plan": "Planavimo veiksena",
  "prompt.permissionMode.plan.description": "Tik skaitymui skirtas tyrimas; redaguoti galima tik plano failą",
  "prompt.permissionMode.bypassPermissions": "Apeiti leidimus",
  "prompt.permissionMode.bypassPermissions.description":
    "Vykdoma neklausiant, išskyrus apsaugotus kelius, kritinius trynimus ir jūsų klausimo taisykles",
  "prompt.permissionMode.dontAsk": "Neklausti",
  "prompt.permissionMode.dontAsk.description": "Viskas, dėl ko būtų klausiama, atmetama",
  ...
  "prompt.slash.badge.builtin": "įtaisyta",
  "prompt.slash.hint.arguments": "[argumentai]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Nežinoma komanda: /{{name}}",
  "prompt.slash.unknown.description": "Pradėkite žinutę tarpu, kad ji būtų išsiųsta kaip tekstas.",
  "prompt.slash.unavailable.title": "/{{name}} čia nepasiekiama",
  "prompt.slash.noArguments.title": "/{{name}} nepriima argumentų",
  ...
  "dialog.bypassPermissions.title": "Apeiti leidimus?",
  "dialog.bypassPermissions.body":
    "Agentas neklausdamas vykdys komandas, redaguos failus ir naudosis internetu. Dėl apsaugotų kelių (.git, agento konfigūracijos, apvalkalo paleisties failų), kritinių trynimų ir jūsų pačių klausimo taisyklių vis tiek bus klausiama; draudimo taisyklės tebegalioja. Naudokite tai tik projekte, kuriuo pasitikite.",
  "dialog.bypassPermissions.confirm": "Apeiti leidimus",
  "dialog.bypassPermissions.cancel": "Atšaukti",
  "ui.permission.always.project": "Visada leisti šiame projekte",
  "ui.permission.always.session": "Leisti šiam seansui",
  "ui.permission.always.acceptEdits": "Leisti visus redagavimus (Priimti redagavimus)",
  "ui.permission.always.everything": "viskas šiam įrankiui",
  "ui.permission.guard.floor.title": "Apsaugotas veiksmas",
  "ui.permission.guard.guard.title": "Reikia peržiūros",
  "ui.permission.guard.noAlways": "Tai galima patvirtinti tik vieną kartą",
  "ui.permission.writes": "Rašo į",
  "ui.question.planFeedback.placeholder": "Parašykite agentui, ką pakeisti plane",
  ...
  "dialog.server.description": "Perjunkite, prie kurio AgentCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama AgentCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas AgentCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite AgentCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite AgentCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad AgentCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automatinis priėmimas dabar yra „Priimti redagavimus“",
  "toast.permissions.modeMigrated.description":
    "Šio aplanko redagavimai patvirtinami automatiškai; dėl komandų vis tiek klausiama. Visiškam savarankiškumui užklausos lauke pasirinkite „Apeiti leidimus“.",
  "toast.permissions.autoAcceptRemoved.title": "Automatinis priėmimas išjungtas",
  "toast.permissions.autoAcceptRemoved.modes":
    "Leidimų prašymai vėl bus rodomi. Norėdami automatiškai patvirtinti redagavimus, veiksenų meniu šalia užklausos pasirinkite „Priimti redagavimus“ arba paspauskite Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Leidimų prašymai vėl bus rodomi. Norėdami jų išvengti, leiskite tuos įrankius šio serverio leidimų konfigūracijoje.",
  "toast.permissions.mode.error.title": "Nepavyko pakeisti leidimų veiksenos",
  ...
  "toast.model.selected.others": "Kiti atitikmenys: {{count}}. Paleiskite /model ir pasirinkite.",
  "toast.model.noMatch.title": "Joks modelis neatitinka „{{query}}“",
  "toast.agent.noMatch.title": "Nėra agento pavadinimu „{{query}}“",
  ...
  "toast.update.description": "Dabar galima įdiegti naują AgentCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą AgentCode komandai",
  "error.page.report.discord": "per GitHub",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad AgentCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "AgentCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "AgentCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite AgentCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite AgentCode ekrano kalbą",
  "settings.general.permissionMode.title": "Numatytoji leidimų veiksena",
  "settings.general.permissionMode.description": "Naudojama naujiems seansams šiame aplanke",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip AgentCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar AgentCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite AgentCode temą.",
  ...
  "settings.updates.row.startup.description":
    "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas AgentCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią AgentCode versiją.",
