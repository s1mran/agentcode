export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "AgentCode মেনু",
  ...
  "desktop.recovery.loadFailed": "AgentCode লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "AgentCode উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "AgentCode সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "AgentCode আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "command.model.choose.hint": "[মডেল]",
  ...
  "command.agent.cycle.hint": "[এজেন্ট]",
  ...
  "command.permissionMode.cycle": "অনুমতি মোড পরিবর্তন করুন",
  "command.permissionMode.set": "অনুমতি মোড: {{mode}}",
  "command.permissionMode.bypass": "অনুমতি এড়িয়ে যান…",
  "command.plan": "পরিকল্পনা মোড",
  ...
  "command.session.compact.hint": "[ফোকাস নির্দেশনা]",
  ...
  "command.session.export.hint": "[ফাইলের নাম]",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি AgentCode দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং AgentCode-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি AgentCode-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি AgentCode-এ ব্যবহার করুন৷",
  ...
  "prompt.permissionMode.label": "অনুমতি মোড",
  "prompt.permissionMode.default": "অনুমতি চান",
  "prompt.permissionMode.default.description": "কমান্ড, সম্পাদনা এবং ওয়েব অ্যাক্সেসের আগে জিজ্ঞাসা করে",
  "prompt.permissionMode.acceptEdits": "সম্পাদনা গ্রহণ করুন",
  "prompt.permissionMode.acceptEdits.description":
    "এই প্রকল্পের সম্পাদনা অনুমোদিত হয়; কমান্ডের জন্য এখনও জিজ্ঞাসা করে",
  "prompt.permissionMode.plan": "পরিকল্পনা মোড",
  "prompt.permissionMode.plan.description": "শুধু-পঠনযোগ্য গবেষণা; শুধুমাত্র পরিকল্পনা ফাইল সম্পাদনা করা যায়",
  "prompt.permissionMode.bypassPermissions": "অনুমতি এড়িয়ে যান",
  "prompt.permissionMode.bypassPermissions.description":
    "জিজ্ঞাসা না করেই চলে, তবে সুরক্ষিত পাথ, গুরুত্বপূর্ণ মুছে ফেলা এবং আপনার জিজ্ঞাসা নিয়ম ছাড়া",
  "prompt.permissionMode.dontAsk": "জিজ্ঞাসা করবেন না",
  "prompt.permissionMode.dontAsk.description": "যা কিছুর জন্য জিজ্ঞাসা করা হত, তা অস্বীকার করা হয়",
  ...
  "prompt.slash.badge.builtin": "বিল্ট-ইন",
  "prompt.slash.hint.arguments": "[আর্গুমেন্ট]",
  "prompt.slash.hint.positional": "<আর্গ{{n}}>",
  "prompt.slash.unknown.title": "অজানা কমান্ড: /{{name}}",
  "prompt.slash.unknown.description": "টেক্সট হিসেবে পাঠাতে বার্তাটি একটি স্পেস দিয়ে শুরু করুন।",
  "prompt.slash.unavailable.title": "/{{name}} এখানে উপলব্ধ নয়",
  "prompt.slash.noArguments.title": "/{{name}} কোনো আর্গুমেন্ট নেয় না",
  ...
  "dialog.bypassPermissions.title": "অনুমতি এড়িয়ে যাবেন?",
  "dialog.bypassPermissions.body":
    "এজেন্ট জিজ্ঞাসা না করেই কমান্ড চালাবে, ফাইল সম্পাদনা করবে এবং ওয়েব অ্যাক্সেস করবে। সুরক্ষিত পাথ (.git, এজেন্ট কনফিগারেশন, শেল স্টার্টআপ ফাইল), গুরুত্বপূর্ণ মুছে ফেলা এবং আপনার নিজের জিজ্ঞাসা নিয়মের ক্ষেত্রে এখনও জিজ্ঞাসা করা হবে; অস্বীকার নিয়মও এখনও প্রযোজ্য। শুধুমাত্র আপনার বিশ্বস্ত প্রকল্পে এটি ব্যবহার করুন।",
  "dialog.bypassPermissions.confirm": "অনুমতি এড়িয়ে যান",
  "dialog.bypassPermissions.cancel": "বাতিল করুন",
  "ui.permission.always.project": "এই প্রকল্পে সর্বদা অনুমতি দিন",
  "ui.permission.always.session": "এই সেশনের জন্য অনুমতি দিন",
  "ui.permission.always.acceptEdits": "সব সম্পাদনার অনুমতি দিন (সম্পাদনা গ্রহণ করুন)",
  "ui.permission.always.everything": "এই সরঞ্জামের জন্য সবকিছু",
  "ui.permission.guard.floor.title": "সুরক্ষিত কাজ",
  "ui.permission.guard.guard.title": "পর্যালোচনা প্রয়োজন",
  "ui.permission.guard.noAlways": "এটি শুধুমাত্র একবার অনুমোদন করা যায়",
  "ui.permission.writes": "লেখার গন্তব্য",
  "ui.question.planFeedback.placeholder": "পরিকল্পনায় কী পরিবর্তন করতে হবে তা এজেন্টকে বলুন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন AgentCode সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ AgentCode চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ AgentCode আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ AgentCode আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "AgentCode আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "AgentCode প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ AgentCode ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "AgentCode ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) AgentCode একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "AgentCode এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর AgentCode আবার খুলুন।",
  ...
  "help.tabs.introduction": "AgentCode ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "স্বয়ংক্রিয় গ্রহণ এখন “সম্পাদনা গ্রহণ করুন”",
  "toast.permissions.modeMigrated.description":
    "এই ফোল্ডারের সম্পাদনা স্বয়ংক্রিয়ভাবে অনুমোদিত হয়; কমান্ডের জন্য এখনও জিজ্ঞাসা করে। সম্পূর্ণ স্বাধীনতার জন্য কম্পোজারে “অনুমতি এড়িয়ে যান” বেছে নিন।",
  "toast.permissions.autoAcceptRemoved.title": "স্বয়ংক্রিয় গ্রহণ বন্ধ করা হয়েছে",
  "toast.permissions.autoAcceptRemoved.modes":
    "অনুমতির অনুরোধ আবার দেখানো হবে। স্বয়ংক্রিয়ভাবে সম্পাদনা অনুমোদন করতে প্রম্পটের পাশের মোড মেনুতে “সম্পাদনা গ্রহণ করুন” বেছে নিন বা Shift+Tab চাপুন।",
  "toast.permissions.autoAcceptRemoved.rules":
    "অনুমতির অনুরোধ আবার দেখানো হবে। এগুলি এড়াতে এই সার্ভারের অনুমতি কনফিগারেশনে সেই সরঞ্জামগুলির অনুমতি দিন।",
  "toast.permissions.mode.error.title": "অনুমতি মোড পরিবর্তন করা যায়নি",
  ...
  "toast.model.selected.title": "মডেল: {{name}}",
  "toast.model.selected.others": "অন্যান্য মিল: {{count}}। একটি বেছে নিতে /model চালান।",
  "toast.model.noMatch.title": "“{{query}}” এর সাথে মেলে এমন কোনো মডেল নেই",
  "toast.agent.noMatch.title": "“{{query}}” নামে কোনো এজেন্ট নেই",
  ...
  "toast.update.description": "AgentCode ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি AgentCode টিমের কাছে রিপোর্ট করুন",
  "error.page.report.discord": "GitHub-এ",
  ...
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, AgentCode এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "AgentCode বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "AgentCode ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে AgentCode সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "AgentCode-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  "settings.general.permissionMode.title": "ডিফল্ট অনুমতি মোড",
  "settings.general.permissionMode.description": "এই ফোল্ডারের নতুন সেশনের জন্য ব্যবহৃত হয়",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে AgentCode কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "AgentCode সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে AgentCode থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "AgentCode চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি AgentCode এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
