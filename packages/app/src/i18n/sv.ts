export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCode-meny",
  ...
  "desktop.recovery.loadFailed": "AgentCode kunde inte läsas in",
  "desktop.recovery.terminated": "AgentCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "AgentCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av AgentCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "command.permissionMode.cycle": "Växla behörighetsläge",
  "command.permissionMode.set": "Behörighetsläge: {{mode}}",
  "command.permissionMode.bypass": "Kringgå behörigheter…",
  "command.plan": "Planeringsläge",
  ...
  "command.session.compact.hint": "[fokusinstruktioner]",
  ...
  "command.session.export.hint": "[filnamn]",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i AgentCode.",
  ...
  "prompt.permissionMode.label": "Behörighetsläge",
  "prompt.permissionMode.default": "Fråga om behörigheter",
  "prompt.permissionMode.default.description": "Frågar före kommandon, redigeringar och webbåtkomst",
  "prompt.permissionMode.acceptEdits": "Acceptera redigeringar",
  "prompt.permissionMode.acceptEdits.description":
    "Redigeringar i det här projektet godkänns; för kommandon frågar den fortfarande",
  "prompt.permissionMode.plan": "Planeringsläge",
  "prompt.permissionMode.plan.description": "Skrivskyddad undersökning; endast planfilen kan redigeras",
  "prompt.permissionMode.bypassPermissions": "Kringgå behörigheter",
  "prompt.permissionMode.bypassPermissions.description":
    "Körs utan att fråga, utom för skyddade sökvägar, kritiska borttagningar och dina Fråga-regler",
  "prompt.permissionMode.dontAsk": "Fråga inte",
  "prompt.permissionMode.dontAsk.description": "Allt som skulle kräva en fråga nekas",
  ...
  "prompt.slash.badge.builtin": "inbyggt",
  "prompt.slash.hint.arguments": "[argument]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Okänt kommando: /{{name}}",
  "prompt.slash.unknown.description": "Börja meddelandet med ett mellanslag för att skicka det som text.",
  "prompt.slash.unavailable.title": "/{{name}} är inte tillgängligt här",
  "prompt.slash.noArguments.title": "/{{name}} tar inga argument",
  ...
  "dialog.bypassPermissions.title": "Kringgå behörigheter?",
  "dialog.bypassPermissions.body":
    "Agenten kommer att köra kommandon, redigera filer och komma åt webben utan att fråga. För skyddade sökvägar (.git, agentkonfiguration, startfiler för skalet), kritiska borttagningar och dina egna Fråga-regler frågar den fortfarande; Neka-regler gäller fortfarande. Använd detta endast i ett projekt du litar på.",
  "dialog.bypassPermissions.confirm": "Kringgå behörigheter",
  "dialog.bypassPermissions.cancel": "Avbryt",
  "ui.permission.always.project": "Tillåt alltid i det här projektet",
  "ui.permission.always.session": "Tillåt för den här sessionen",
  "ui.permission.always.acceptEdits": "Tillåt alla redigeringar (Acceptera redigeringar)",
  "ui.permission.always.everything": "allt för det här verktyget",
  "ui.permission.guard.floor.title": "Skyddad åtgärd",
  "ui.permission.guard.guard.title": "Behöver granskas",
  "ui.permission.guard.noAlways": "Detta kan bara godkännas en gång",
  "ui.permission.writes": "Skriver till",
  "ui.question.planFeedback.placeholder": "Berätta för agenten vad som ska ändras i planen",
  ...
  "dialog.server.description": "Växla vilken AgentCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar AgentCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar AgentCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera AgentCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera AgentCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan AgentCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "AgentCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan AgentCode igen.",
  ...
  "help.tabs.introduction": "AgentCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Autoacceptera heter nu Acceptera redigeringar",
  "toast.permissions.modeMigrated.description":
    "Redigeringar i den här mappen godkänns automatiskt; för kommandon frågar den fortfarande. Välj Kringgå behörigheter i inmatningsfältet för full autonomi.",
  "toast.permissions.autoAcceptRemoved.title": "Autoacceptera har stängts av",
  "toast.permissions.autoAcceptRemoved.modes":
    "Behörighetsförfrågningar visas igen. Om du vill godkänna redigeringar automatiskt väljer du Acceptera redigeringar i lägesmenyn bredvid prompten eller trycker på Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Behörighetsförfrågningar visas igen. Om du vill hoppa över dem tillåter du de verktygen i serverns behörighetskonfiguration.",
  "toast.permissions.mode.error.title": "Det gick inte att ändra behörighetsläget",
  ...
  "toast.model.selected.others": "Andra träffar: {{count}}. Kör /model för att välja en.",
  "toast.model.noMatch.title": "Ingen modell matchar ”{{query}}”",
  "toast.agent.noMatch.title": "Ingen agent med namnet ”{{query}}”",
  ...
  "toast.update.description": "En ny version av AgentCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till AgentCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, AgentCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör AgentCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för AgentCode",
  "settings.general.permissionMode.title": "Standardbehörighetsläge",
  "settings.general.permissionMode.description": "Används för nya sessioner i den här mappen",
  ...
  "settings.general.row.appearance.description": "Anpassa hur AgentCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om AgentCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa AgentCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när AgentCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av AgentCode.",
