export const dict = {
  ...
  "desktop.menu.ariaLabel": "Meniu AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra AgentCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "AgentCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea AgentCode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea AgentCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "command.permissionMode.cycle": "Comută modul de permisiuni",
  "command.permissionMode.set": "Mod permisiuni: {{mode}}",
  "command.permissionMode.bypass": "Ocolește permisiunile…",
  "command.plan": "Mod planificare",
  ...
  "command.session.compact.hint": "[instrucțiuni de focalizare]",
  ...
  "command.session.export.hint": "[nume fișier]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în AgentCode.",
  ...
  "prompt.permissionMode.label": "Mod permisiuni",
  "prompt.permissionMode.default": "Cere permisiuni",
  "prompt.permissionMode.default.description": "Cere confirmare înainte de comenzi, editări și acces web",
  "prompt.permissionMode.acceptEdits": "Acceptă editările",
  "prompt.permissionMode.acceptEdits.description":
    "Editările din acest proiect sunt aprobate; comenzile cer în continuare confirmare",
  "prompt.permissionMode.plan": "Mod planificare",
  "prompt.permissionMode.plan.description": "Explorare doar în citire; se poate edita doar fișierul planului",
  "prompt.permissionMode.bypassPermissions": "Ocolește permisiunile",
  "prompt.permissionMode.bypassPermissions.description":
    "Rulează fără să întrebe, cu excepția căilor protejate, a ștergerilor critice și a regulilor tale „Întreabă”",
  "prompt.permissionMode.dontAsk": "Nu întreba",
  "prompt.permissionMode.dontAsk.description": "Tot ce ar necesita confirmare este refuzat",
  ...
  "prompt.slash.badge.builtin": "integrată",
  "prompt.slash.hint.arguments": "[argumente]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Comandă necunoscută: /{{name}}",
  "prompt.slash.unknown.description": "Începe mesajul cu un spațiu pentru a-l trimite ca text.",
  "prompt.slash.unavailable.title": "/{{name}} nu este disponibilă aici",
  "prompt.slash.noArguments.title": "/{{name}} nu acceptă argumente",
  ...
  "dialog.bypassPermissions.title": "Ocolești permisiunile?",
  "dialog.bypassPermissions.body":
    "Agentul va rula comenzi, va edita fișiere și va accesa web-ul fără să întrebe. Pentru căile protejate (.git, configurația agentului, fișierele de pornire ale shell-ului), ștergerile critice și propriile tale reguli „Întreabă” se cere în continuare confirmare; regulile „Refuză” se aplică în continuare. Folosește acest mod doar într-un proiect în care ai încredere.",
  "dialog.bypassPermissions.confirm": "Ocolește permisiunile",
  "dialog.bypassPermissions.cancel": "Anulează",
  "ui.permission.always.project": "Permite mereu în acest proiect",
  "ui.permission.always.session": "Permite pentru această sesiune",
  "ui.permission.always.acceptEdits": "Permite toate editările (Acceptă editările)",
  "ui.permission.always.everything": "totul pentru această unealtă",
  "ui.permission.guard.floor.title": "Acțiune protejată",
  "ui.permission.guard.guard.title": "Necesită revizuire",
  "ui.permission.guard.noAlways": "Aceasta poate fi aprobată o singură dată",
  "ui.permission.writes": "Scrie în",
  "ui.question.planFeedback.placeholder": "Spune-i agentului ce să schimbe în plan",
  ...
  "dialog.server.description": "Schimbă serverul AgentCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică AgentCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează AgentCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează AgentCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează AgentCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca AgentCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Acceptarea automată este acum Acceptă editările",
  "toast.permissions.modeMigrated.description":
    "Editările din acest folder sunt aprobate automat; comenzile cer în continuare confirmare. Alege Ocolește permisiunile în editor pentru autonomie completă.",
  "toast.permissions.autoAcceptRemoved.title": "Acceptarea automată a fost dezactivată",
  "toast.permissions.autoAcceptRemoved.modes":
    "Solicitările de permisiune apar din nou. Pentru a aproba automat editările, alege Acceptă editările din meniul de mod de lângă prompt sau apasă Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Solicitările de permisiune apar din nou. Pentru a le omite, permite acele unelte în configurația de permisiuni a acestui server.",
  "toast.permissions.mode.error.title": "Nu s-a putut schimba modul de permisiuni",
  ...
  "toast.model.selected.others": "Alte potriviri: {{count}}. Rulează /model pentru a alege unul.",
  "toast.model.noMatch.title": "Niciun model nu corespunde cu „{{query}}”",
  "toast.agent.noMatch.title": "Niciun agent numit „{{query}}”",
  ...
  "toast.update.description": "O nouă versiune AgentCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei AgentCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, AgentCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul AgentCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru AgentCode",
  "settings.general.permissionMode.title": "Mod implicit de permisiuni",
  "settings.general.permissionMode.description": "Folosit pentru sesiunile noi din acest folder",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul AgentCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă AgentCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema AgentCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea AgentCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune AgentCode.",
