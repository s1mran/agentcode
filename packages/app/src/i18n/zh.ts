...
export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCode 菜单",
  ...
  "desktop.recovery.loadFailed": "AgentCode 加载失败",
  "desktop.recovery.terminated": "AgentCode 窗口意外终止",
  "desktop.recovery.unresponsive": "AgentCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 AgentCode",
  "desktop.wsl.error.updateVersion":
    "AgentCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "command.permissionMode.cycle": "切换权限模式",
  "command.permissionMode.set": "权限模式：{{mode}}",
  "command.permissionMode.bypass": "绕过权限…",
  "command.plan": "计划模式",
  ...
  "command.session.compact.hint": "[摘要重点]",
  ...
  "command.session.export.hint": "[文件名]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的账户并在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "prompt.permissionMode.label": "权限模式",
  "prompt.permissionMode.default": "询问权限",
  "prompt.permissionMode.default.description": "执行命令、编辑和访问网络前先询问",
  "prompt.permissionMode.acceptEdits": "接受编辑",
  "prompt.permissionMode.acceptEdits.description": "自动批准此项目中的编辑；命令仍需询问",
  "prompt.permissionMode.plan": "计划模式",
  "prompt.permissionMode.plan.description": "只读调研；仅可编辑计划文件",
  "prompt.permissionMode.bypassPermissions": "绕过权限",
  "prompt.permissionMode.bypassPermissions.description": "无需询问直接运行，受保护路径、关键删除操作和你的询问规则除外",
  "prompt.permissionMode.dontAsk": "不询问",
  "prompt.permissionMode.dontAsk.description": "任何需要询问的操作都会被拒绝",
  ...
  "prompt.slash.badge.builtin": "内置",
  "prompt.slash.hint.arguments": "[参数]",
  "prompt.slash.hint.positional": "<参数{{n}}>",
  "prompt.slash.unknown.title": "未知命令：/{{name}}",
  "prompt.slash.unknown.description": "以空格开头即可将消息作为文本发送。",
  "prompt.slash.unavailable.title": "/{{name}} 在此处不可用",
  "prompt.slash.noArguments.title": "/{{name}} 不接受参数",
  ...
  "dialog.bypassPermissions.title": "绕过权限？",
  "dialog.bypassPermissions.body":
    "智能体将在不询问的情况下运行命令、编辑文件和访问网络。受保护路径（.git、智能体配置、shell 启动文件）、关键删除操作和你自己的询问规则仍会询问；拒绝规则仍然有效。仅在你信任的项目中使用此模式。",
  "dialog.bypassPermissions.confirm": "绕过权限",
  "dialog.bypassPermissions.cancel": "取消",

  "ui.permission.always.project": "在此项目中始终允许",
  "ui.permission.always.session": "在此会话中允许",
  "ui.permission.always.acceptEdits": "允许所有编辑（接受编辑）",
  "ui.permission.always.everything": "此工具的所有操作",
  "ui.permission.guard.floor.title": "受保护的操作",
  "ui.permission.guard.guard.title": "需要审查",
  "ui.permission.guard.noAlways": "此操作只能单次批准",
  "ui.permission.writes": "写入",
  "ui.question.planFeedback.placeholder": "告诉智能体计划中需要修改什么",
  ...
  "dialog.server.description": "切换此应用连接的 AgentCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 AgentCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 AgentCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 AgentCode。",
  "wsl.onboarding.updateOpencode": "更新 AgentCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 AgentCode 已就绪。",
  "wsl.onboarding.opencodeReady": "AgentCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 AgentCode。",
  "wsl.onboarding.installOpencode": "安装 AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 AgentCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "AgentCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "AgentCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 AgentCode。",
  ...
  "help.tabs.introduction": "AgentCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "自动接受现已改为“接受编辑”",
  "toast.permissions.modeMigrated.description":
    "此文件夹中的编辑会自动批准；命令仍需询问。如需完全自主，请在输入框中选择“绕过权限”。",
  "toast.permissions.autoAcceptRemoved.title": "已关闭自动接受",
  "toast.permissions.autoAcceptRemoved.modes":
    "权限请求将再次询问。要自动批准编辑，请在输入框旁的模式菜单中选择“接受编辑”，或按 Shift+Tab。",
  "toast.permissions.autoAcceptRemoved.rules": "权限请求将再次询问。要跳过它们，请在此服务器的权限配置中允许这些工具。",
  "toast.permissions.mode.error.title": "无法更改权限模式",
  "toast.model.none.title": "未选择模型",
  "toast.model.none.description": "请先连接提供商以总结此会话",
  "toast.model.selected.title": "模型：{{name}}",
  "toast.model.selected.others": "其他匹配项：{{count}} 个。运行 /model 进行选择。",
  "toast.model.noMatch.title": "没有与“{{query}}”匹配的模型",
  "toast.agent.noMatch.title": "没有名为“{{query}}”的智能体",
  ...
  "toast.update.description": "AgentCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 AgentCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：AgentCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "AgentCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 AgentCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 AgentCode 的显示语言",
  "settings.general.permissionMode.title": "默认权限模式",
  "settings.general.permissionMode.description": "用于此文件夹中的新会话",
  ...
  "settings.general.row.appearance.description": "自定义 AgentCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 AgentCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 AgentCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 AgentCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 AgentCode。",
