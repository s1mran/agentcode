export const dict = {
  ...
  "desktop.menu.ariaLabel": "قائمة AgentCode",
  ...
  "desktop.recovery.loadFailed": "فشل تحميل AgentCode",
  "desktop.recovery.terminated": "توقفت نافذة AgentCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "AgentCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث AgentCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "command.model.choose.hint": "[نموذج]",
  ...
  "command.permissionMode.cycle": "تبديل وضع الأذونات",
  "command.permissionMode.set": "وضع الأذونات: {{mode}}",
  "command.permissionMode.bypass": "تجاوز الأذونات…",
  "command.plan": "وضع التخطيط",
  ...
  "command.session.compact.hint": "[تعليمات التركيز]",
  ...
  "command.session.export.hint": "[اسم الملف]",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من AgentCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في AgentCode.",
  ...
  "prompt.permissionMode.label": "وضع الأذونات",
  "prompt.permissionMode.default": "طلب الأذونات",
  "prompt.permissionMode.default.description": "يسأل قبل تشغيل الأوامر والتعديلات والوصول إلى الويب",
  "prompt.permissionMode.acceptEdits": "قبول التعديلات",
  "prompt.permissionMode.acceptEdits.description":
    "تتم الموافقة على التعديلات في هذا المشروع؛ ولا تزال الأوامر تتطلب السؤال",
  "prompt.permissionMode.plan": "وضع التخطيط",
  "prompt.permissionMode.plan.description": "بحث للقراءة فقط؛ لا يمكن تعديل سوى ملف الخطة",
  "prompt.permissionMode.bypassPermissions": "تجاوز الأذونات",
  "prompt.permissionMode.bypassPermissions.description":
    "يعمل دون سؤال، باستثناء المسارات المحمية وعمليات الحذف الحرجة وقواعد السؤال الخاصة بك",
  "prompt.permissionMode.dontAsk": "عدم السؤال",
  "prompt.permissionMode.dontAsk.description": "يُرفض كل ما يتطلب السؤال",
  ...
  "prompt.slash.badge.builtin": "مضمّن",
  "prompt.slash.hint.arguments": "[وسائط]",
  "prompt.slash.hint.positional": "<وسيط{{n}}>",
  "prompt.slash.unknown.title": "أمر غير معروف: /{{name}}",
  "prompt.slash.unknown.description": "ابدأ الرسالة بمسافة لإرسالها كنص.",
  "prompt.slash.unavailable.title": "‏/{{name}} غير متاح هنا",
  "prompt.slash.noArguments.title": "‏/{{name}} لا يقبل وسائط",
  ...
  "dialog.bypassPermissions.title": "هل تريد تجاوز الأذونات؟",
  "dialog.bypassPermissions.body":
    "سيشغّل الوكيل الأوامر ويعدّل الملفات ويصل إلى الويب دون سؤال. لا تزال المسارات المحمية (.git، وتكوين الوكيل، وملفات بدء تشغيل shell) وعمليات الحذف الحرجة وقواعد السؤال الخاصة بك تتطلب السؤال؛ ولا تزال قواعد الرفض سارية. لا تستخدم هذا الوضع إلا في مشروع تثق به.",
  "dialog.bypassPermissions.confirm": "تجاوز الأذونات",
  "dialog.bypassPermissions.cancel": "إلغاء",
  "ui.permission.always.project": "السماح دائمًا في هذا المشروع",
  "ui.permission.always.session": "السماح لهذه الجلسة",
  "ui.permission.always.acceptEdits": "السماح بجميع التعديلات (قبول التعديلات)",
  "ui.permission.always.everything": "كل شيء لهذه الأداة",
  "ui.permission.guard.floor.title": "إجراء محمي",
  "ui.permission.guard.guard.title": "يحتاج إلى مراجعة",
  "ui.permission.guard.noAlways": "لا يمكن الموافقة على هذا إلا مرة واحدة",
  "ui.permission.writes": "يكتب إلى",
  "ui.question.planFeedback.placeholder": "أخبر الوكيل بما يجب تغييره في الخطة",
  ...
  "dialog.server.description": "تبديل خادم AgentCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من AgentCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث AgentCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث AgentCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت AgentCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن AgentCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على AgentCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح AgentCode.",
  ...
  "help.tabs.introduction": "أصبح AgentCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "أصبح القبول التلقائي الآن «قبول التعديلات»",
  "toast.permissions.modeMigrated.description":
    "تتم الموافقة تلقائيًا على التعديلات في هذا المجلد؛ ولا تزال الأوامر تتطلب السؤال. اختر «تجاوز الأذونات» في محرر الرسائل للحصول على استقلالية كاملة.",
  "toast.permissions.autoAcceptRemoved.title": "تم إيقاف القبول التلقائي",
  "toast.permissions.autoAcceptRemoved.modes":
    "ستظهر طلبات الأذونات مجددًا. للموافقة على التعديلات تلقائيًا، اختر «قبول التعديلات» من قائمة الأوضاع بجوار الموجّه أو اضغط Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "ستظهر طلبات الأذونات مجددًا. لتخطيها، اسمح بهذه الأدوات في تكوين الأذونات لهذا الخادم.",
  "toast.permissions.mode.error.title": "تعذر تغيير وضع الأذونات",
  "toast.model.none.title": "لم يتم تحديد نموذج",
  "toast.model.none.description": "قم بتوصيل موفر لتلخيص هذه الجلسة",
  "toast.model.selected.title": "النموذج: {{name}}",
  "toast.model.selected.others": "تطابقات أخرى: {{count}}. شغّل /model لاختيار واحد.",
  "toast.model.noMatch.title": "لا يوجد نموذج يطابق «{{query}}»",
  "toast.agent.noMatch.title": "لا يوجد وكيل باسم «{{query}}»",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من AgentCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق AgentCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن AgentCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن AgentCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم AgentCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ AgentCode",
  "settings.general.permissionMode.title": "وضع الأذونات الافتراضي",
  "settings.general.permissionMode.description": "يُستخدم للجلسات الجديدة في هذا المجلد",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور AgentCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان AgentCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة AgentCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل AgentCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من AgentCode.",
