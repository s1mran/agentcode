...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "AgentCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "AgentCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av AgentCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av AgentCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "command.permissionMode.cycle": "Bytt tillatelsesmodus",
  "command.permissionMode.set": "Tillatelsesmodus: {{mode}}",
  "command.permissionMode.bypass": "Omgå tillatelser…",
  ...
  "command.session.compact.hint": "[fokusinstruksjoner]",
  ...
  "command.session.export.hint": "[filnavn]",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AgentCode.",
  ...
  "prompt.permissionMode.label": "Tillatelsesmodus",
  "prompt.permissionMode.default": "Be om tillatelse",
  "prompt.permissionMode.default.description": "Spør før kommandoer, redigeringer og nettilgang",
  "prompt.permissionMode.acceptEdits": "Godta redigeringer",
  "prompt.permissionMode.acceptEdits.description":
    "Redigeringer i dette prosjektet godkjennes; for kommandoer spørres det fortsatt",
  "prompt.permissionMode.plan": "Planmodus",
  "prompt.permissionMode.plan.description": "Skrivebeskyttet undersøkelse; bare planfilen kan redigeres",
  "prompt.permissionMode.bypassPermissions": "Omgå tillatelser",
  "prompt.permissionMode.bypassPermissions.description":
    "Kjører uten å spørre, bortsett fra beskyttede baner, kritiske slettinger og dine spørreregler",
  "prompt.permissionMode.dontAsk": "Ikke spør",
  "prompt.permissionMode.dontAsk.description": "Alt som ville krevd spørsmål, avslås",
  ...
  "prompt.slash.badge.builtin": "innebygd",
  "prompt.slash.hint.arguments": "[argumenter]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Ukjent kommando: /{{name}}",
  "prompt.slash.unknown.description": "Start meldingen med et mellomrom for å sende den som tekst.",
  "prompt.slash.unavailable.title": "/{{name}} er ikke tilgjengelig her",
  "prompt.slash.noArguments.title": "/{{name}} tar ikke argumenter",
  ...
  "dialog.bypassPermissions.title": "Omgå tillatelser?",
  "dialog.bypassPermissions.body":
    "Agenten kjører kommandoer, redigerer filer og bruker nettet uten å spørre. For beskyttede baner (.git, agentkonfigurasjon, oppstartsfiler for skallet), kritiske slettinger og dine egne spørreregler spørres det fortsatt; avslagsregler gjelder fortsatt. Bruk dette bare i et prosjekt du stoler på.",
  "dialog.bypassPermissions.confirm": "Omgå tillatelser",
  "dialog.bypassPermissions.cancel": "Avbryt",
  "ui.permission.always.project": "Tillat alltid i dette prosjektet",
  "ui.permission.always.session": "Tillat for denne sesjonen",
  "ui.permission.always.acceptEdits": "Tillat alle redigeringer (Godta redigeringer)",
  "ui.permission.always.everything": "alt for dette verktøyet",
  "ui.permission.guard.floor.title": "Beskyttet handling",
  "ui.permission.guard.guard.title": "Krever gjennomgang",
  "ui.permission.guard.noAlways": "Dette kan bare godkjennes én gang",
  "ui.permission.writes": "Skriver til",
  "ui.question.planFeedback.placeholder": "Fortell agenten hva som skal endres i planen",
  ...
  "dialog.server.description": "Bytt hvilken AgentCode-server denne appen kobler til.",
  ...
  "toast.permissions.modeMigrated.title": "Automatisk akseptering er nå Godta redigeringer",
  "toast.permissions.modeMigrated.description":
    "Redigeringer i denne mappen godkjennes automatisk; for kommandoer spørres det fortsatt. Velg Omgå tillatelser i skrivefeltet for full autonomi.",
  "toast.permissions.autoAcceptRemoved.title": "Automatisk akseptering ble slått av",
  "toast.permissions.autoAcceptRemoved.modes":
    "Du blir spurt om tillatelse igjen. For å godkjenne redigeringer automatisk, velg Godta redigeringer i modusmenyen ved siden av prompten eller trykk Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Du blir spurt om tillatelse igjen. For å hoppe over dette, tillat disse verktøyene i serverens tillatelseskonfigurasjon.",
  "toast.permissions.mode.error.title": "Kunne ikke endre tillatelsesmodus",
  ...
  "toast.model.selected.others": "Andre treff: {{count}}. Kjør /model for å velge én.",
  "toast.model.noMatch.title": "Ingen modell samsvarer med «{{query}}»",
  "toast.agent.noMatch.title": "Ingen agent med navnet «{{query}}»",
  ...
  "toast.update.description": "En ny versjon av AgentCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AgentCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AgentCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AgentCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AgentCode",
  "settings.general.permissionMode.title": "Standard tillatelsesmodus",
  "settings.general.permissionMode.description": "Brukes for nye sesjoner i denne mappen",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AgentCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om AgentCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i AgentCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AgentCode starter",
  ...
  "settings.updates.toast.latest.title": "AgentCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AgentCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker AgentCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer AgentCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater AgentCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer AgentCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før AgentCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "AgentCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter AgentCode på nytt.",
  ...
  "help.tabs.introduction": "AgentCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
