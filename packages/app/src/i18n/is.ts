...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða AgentCode",
  "AgentCode-glugganum var óvænt lokað",
  "AgentCode svarar ekki",
  ...
  "AgentCode er ekki uppsett í {{distro}}",
  "Uppfærslu AgentCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "command.model.choose.hint": "[líkan]",
  ...
  "command.agent.cycle.hint": "[fulltrúi]",
  ...
  "command.permissionMode.cycle": "Skipta um heimildaham",
  "command.permissionMode.set": "Heimildahamur: {{mode}}",
  "command.permissionMode.bypass": "Sniðganga heimildir…",
  "command.plan": "Áætlunarhamur",
  ...
  "command.session.compact.hint": "[áhersluleiðbeiningar]",
  ...
  "command.session.export.hint": "[skráarheiti]",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í AgentCode.",
  ...
  "prompt.permissionMode.label": "Heimildahamur",
  "prompt.permissionMode.default": "Biðja um heimildir",
  "prompt.permissionMode.default.description": "Spyr á undan skipunum, breytingum og vefaðgangi",
  "prompt.permissionMode.acceptEdits": "Samþykkja breytingar",
  "prompt.permissionMode.acceptEdits.description":
    "Breytingar í þessu verkefni eru samþykktar; áfram er spurt um skipanir",
  "prompt.permissionMode.plan": "Áætlunarhamur",
  "prompt.permissionMode.plan.description": "Rannsókn með lesaðgangi eingöngu; aðeins má breyta áætlunarskránni",
  "prompt.permissionMode.bypassPermissions": "Sniðganga heimildir",
  "prompt.permissionMode.bypassPermissions.description":
    "Keyrir án þess að spyrja, nema um varðar slóðir, mikilvægar eyðingar og þínar spurnarreglur",
  "prompt.permissionMode.dontAsk": "Ekki spyrja",
  "prompt.permissionMode.dontAsk.description": "Öllu sem krefðist spurningar er hafnað",
  ...
  "prompt.slash.badge.builtin": "innbyggð",
  "prompt.slash.hint.arguments": "[breytur]",
  "prompt.slash.hint.positional": "<breyta{{n}}>",
  "prompt.slash.unknown.title": "Óþekkt skipun: /{{name}}",
  "prompt.slash.unknown.description": "Byrjaðu skilaboðin á bili til að senda þau sem texta.",
  "prompt.slash.unavailable.title": "/{{name}} er ekki í boði hér",
  "prompt.slash.noArguments.title": "/{{name}} tekur ekki við breytum",
  ...
  "dialog.bypassPermissions.title": "Sniðganga heimildir?",
  "dialog.bypassPermissions.body":
    "Fulltrúinn mun keyra skipanir, breyta skrám og fá aðgang að vefnum án þess að spyrja. Áfram er spurt um varðar slóðir (.git, stillingar fulltrúa, ræsiskrár skeljar), mikilvægar eyðingar og þínar eigin spurnarreglur; bannreglur gilda áfram. Notaðu þetta aðeins í verkefni sem þú treystir.",
  "dialog.bypassPermissions.confirm": "Sniðganga heimildir",
  "dialog.bypassPermissions.cancel": "Hætta við",
  "ui.permission.always.project": "Leyfa alltaf í þessu verkefni",
  "ui.permission.always.session": "Leyfa fyrir þessa setu",
  "ui.permission.always.acceptEdits": "Leyfa allar breytingar (Samþykkja breytingar)",
  "ui.permission.always.everything": "allt fyrir þetta verkfæri",
  "ui.permission.guard.floor.title": "Varin aðgerð",
  "ui.permission.guard.guard.title": "Þarfnast yfirferðar",
  "ui.permission.guard.noAlways": "Aðeins er hægt að samþykkja þetta einu sinni",
  "ui.permission.writes": "Skrifar í",
  "ui.question.planFeedback.placeholder": "Segðu fulltrúanum hverju á að breyta í áætluninni",
  ...
  "dialog.server.description": "Skiptu um hvaða AgentCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar AgentCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir AgentCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu AgentCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp AgentCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en AgentCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "AgentCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan AgentCode aftur.",
  ...
  "help.tabs.introduction": "AgentCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Sjálfvirkt samþykki heitir nú Samþykkja breytingar",
  "toast.permissions.modeMigrated.description":
    "Breytingar í þessari möppu eru samþykktar sjálfkrafa; áfram er spurt um skipanir. Veldu Sniðganga heimildir í innsláttarreitnum fyrir fullt sjálfræði.",
  "toast.permissions.autoAcceptRemoved.title": "Slökkt var á sjálfvirku samþykki",
  "toast.permissions.autoAcceptRemoved.modes":
    "Beðið verður aftur um heimildir. Til að samþykkja breytingar sjálfkrafa skaltu velja Samþykkja breytingar í hamavalmyndinni við hliðina á kvaðningunni eða ýta á Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Beðið verður aftur um heimildir. Til að sleppa þeim skaltu leyfa þessi verkfæri í heimildastillingum þessa þjóns.",
  "toast.permissions.mode.error.title": "Ekki tókst að breyta heimildaham",
  "toast.model.none.title": "Engin gerð valin",
  "toast.model.none.description": "Tengdu þjónustuaðila til að draga saman þessa lotu",
  "toast.model.selected.title": "Líkan: {{name}}",
  "toast.model.selected.others": "Aðrar samsvaranir: {{count}}. Keyrðu /model til að velja eitt.",
  "toast.model.noMatch.title": "Ekkert líkan passar við „{{query}}“",
  "toast.agent.noMatch.title": "Enginn fulltrúi heitir „{{query}}“",
  ...
  "toast.update.description": "Ný útgáfa af AgentCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til AgentCode teymisins",
  "error.page.report.discord": "á GitHub",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, AgentCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "AgentCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "AgentCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu AgentCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir AgentCode",
  "settings.general.permissionMode.title": "Sjálfgefinn heimildahamur",
  "settings.general.permissionMode.description": "Notað fyrir nýjar setur í þessari möppu",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig AgentCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort AgentCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig AgentCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar AgentCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af AgentCode.",
