...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode 載入失敗",
  "desktop.recovery.terminated": "AgentCode 視窗意外終止",
  "desktop.recovery.unresponsive": "AgentCode 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 AgentCode",
  "desktop.wsl.error.updateVersion":
    "AgentCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "command.permissionMode.cycle": "切換權限模式",
  "command.permissionMode.set": "權限模式：{{mode}}",
  "command.permissionMode.bypass": "略過權限…",
  "command.plan": "規劃模式",
  ...
  "command.session.compact.hint": "[摘要重點]",
  ...
  "command.session.export.hint": "[檔案名稱]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 AgentCode 中使用 {{provider}} 模型。",
  ...
  "prompt.permissionMode.label": "權限模式",
  "prompt.permissionMode.default": "詢問權限",
  "prompt.permissionMode.default.description": "執行命令、編輯及存取網路前先詢問",
  "prompt.permissionMode.acceptEdits": "接受編輯",
  "prompt.permissionMode.acceptEdits.description": "自動核准此專案中的編輯；命令仍需詢問",
  "prompt.permissionMode.plan": "規劃模式",
  "prompt.permissionMode.plan.description": "唯讀研究；僅可編輯計畫檔案",
  "prompt.permissionMode.bypassPermissions": "略過權限",
  "prompt.permissionMode.bypassPermissions.description": "不經詢問直接執行，受保護路徑、重大刪除操作及你的詢問規則除外",
  "prompt.permissionMode.dontAsk": "不詢問",
  "prompt.permissionMode.dontAsk.description": "任何需要詢問的操作都會遭到拒絕",
  ...
  "prompt.slash.badge.builtin": "內建",
  "prompt.slash.hint.arguments": "[引數]",
  "prompt.slash.hint.positional": "<引數{{n}}>",
  "prompt.slash.unknown.title": "未知的命令：/{{name}}",
  "prompt.slash.unknown.description": "以空格開頭即可將訊息作為文字傳送。",
  "prompt.slash.unavailable.title": "/{{name}} 在此無法使用",
  "prompt.slash.noArguments.title": "/{{name}} 不接受引數",
  ...
  "dialog.bypassPermissions.title": "要略過權限嗎？",
  "dialog.bypassPermissions.body":
    "代理程式將在不詢問的情況下執行命令、編輯檔案及存取網路。受保護路徑（.git、代理程式設定、Shell 啟動檔案）、重大刪除操作及你自己的詢問規則仍會詢問；拒絕規則依然有效。請僅在你信任的專案中使用。",
  "dialog.bypassPermissions.confirm": "略過權限",
  "dialog.bypassPermissions.cancel": "取消",

  "ui.permission.always.project": "在此專案中永遠允許",
  "ui.permission.always.session": "在此工作階段中允許",
  "ui.permission.always.acceptEdits": "允許所有編輯（接受編輯）",
  "ui.permission.always.everything": "此工具的所有操作",
  "ui.permission.guard.floor.title": "受保護的操作",
  "ui.permission.guard.guard.title": "需要檢閱",
  "ui.permission.guard.noAlways": "此操作只能單次核准",
  "ui.permission.writes": "寫入",
  "ui.question.planFeedback.placeholder": "告訴代理程式計畫中需要修改的內容",
  ...
  "dialog.server.description": "切換此應用程式連線的 AgentCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 AgentCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 AgentCode 已就緒。",
  "wsl.onboarding.opencodeReady": "AgentCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 AgentCode。",
  "wsl.onboarding.installOpencode": "安裝 AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 AgentCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "AgentCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 AgentCode。",
  ...
  "help.tabs.introduction": "AgentCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "自動接受現已改為「接受編輯」",
  "toast.permissions.modeMigrated.description":
    "此資料夾中的編輯會自動核准；命令仍需詢問。若要完全自主，請在輸入區選擇「略過權限」。",
  "toast.permissions.autoAcceptRemoved.title": "已關閉自動接受",
  "toast.permissions.autoAcceptRemoved.modes":
    "權限要求將再次詢問。若要自動核准編輯，請在輸入區旁的模式選單中選擇「接受編輯」，或按下 Shift+Tab。",
  "toast.permissions.autoAcceptRemoved.rules": "權限要求將再次詢問。若要略過，請在此伺服器的權限設定中允許這些工具。",
  "toast.permissions.mode.error.title": "無法變更權限模式",

  "toast.model.none.title": "未選擇模型",
  "toast.model.none.description": "請先連線提供者以摘要此工作階段",
  "toast.model.selected.title": "模型：{{name}}",
  "toast.model.selected.others": "其他符合項目：{{count}} 個。執行 /model 以選擇。",
  "toast.model.noMatch.title": "沒有符合「{{query}}」的模型",
  "toast.agent.noMatch.title": "沒有名為「{{query}}」的代理程式",
  ...
  "toast.update.description": "AgentCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 AgentCode 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：AgentCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "AgentCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 AgentCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 AgentCode 的顯示語言",
  "settings.general.permissionMode.title": "預設權限模式",
  "settings.general.permissionMode.description": "用於此資料夾中的新工作階段",
  ...
  "settings.general.row.appearance.description": "自訂 AgentCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 AgentCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 AgentCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 AgentCode 啟動時自動檢查更新",
