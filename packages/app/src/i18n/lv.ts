export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentācija",
  ...
  "desktop.menu.ariaLabel": "AgentCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt AgentCode",
  "desktop.recovery.terminated": "AgentCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "AgentCode neatbild",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode instalēšana neizdevās",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "command.model.choose.hint": "[modelis]",
  ...
  "command.agent.cycle.hint": "[aģents]",
  ...
  "command.permissionMode.cycle": "Mainīt atļauju režīmu",
  "command.permissionMode.set": "Atļauju režīms: {{mode}}",
  "command.permissionMode.bypass": "Apiet atļaujas…",
  "command.plan": "Plānošanas režīms",
  ...
  "command.session.compact.hint": "[fokusa norādes]",
  ...
  "command.session.export.hint": "[faila nosaukums]",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus AgentCode.",
  ...
  "prompt.permissionMode.label": "Atļauju režīms",
  "prompt.permissionMode.default": "Jautāt atļaujas",
  "prompt.permissionMode.default.description": "Jautā pirms komandām, labojumiem un piekļuves tīmeklim",
  "prompt.permissionMode.acceptEdits": "Pieņemt labojumus",
  "prompt.permissionMode.acceptEdits.description":
    "Labojumi šajā projektā tiek apstiprināti; par komandām joprojām jautā",
  "prompt.permissionMode.plan": "Plānošanas režīms",
  "prompt.permissionMode.plan.description": "Izpēte tikai lasīšanas režīmā; rediģēt var tikai plāna failu",
  "prompt.permissionMode.bypassPermissions": "Apiet atļaujas",
  "prompt.permissionMode.bypassPermissions.description":
    "Darbojas bez jautāšanas, izņemot aizsargātus ceļus, kritiskas dzēšanas un jūsu jautāšanas noteikumus",
  "prompt.permissionMode.dontAsk": "Nejautāt",
  "prompt.permissionMode.dontAsk.description": "Viss, par ko būtu jājautā, tiek liegts",
  ...
  "prompt.slash.badge.builtin": "iebūvēta",
  "prompt.slash.hint.arguments": "[argumenti]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Nezināma komanda: /{{name}}",
  "prompt.slash.unknown.description": "Sāciet ziņojumu ar atstarpi, lai to nosūtītu kā tekstu.",
  "prompt.slash.unavailable.title": "/{{name}} šeit nav pieejama",
  "prompt.slash.noArguments.title": "/{{name}} nepieņem argumentus",
  ...
  "dialog.bypassPermissions.title": "Apiet atļaujas?",
  "dialog.bypassPermissions.body":
    "Aģents bez jautāšanas izpildīs komandas, rediģēs failus un piekļūs tīmeklim. Par aizsargātiem ceļiem (.git, aģenta konfigurācija, čaulas palaišanas faili), kritiskām dzēšanām un jūsu pašu jautāšanas noteikumiem joprojām tiks jautāts; liegšanas noteikumi joprojām ir spēkā. Izmantojiet to tikai projektā, kuram uzticaties.",
  "dialog.bypassPermissions.confirm": "Apiet atļaujas",
  "dialog.bypassPermissions.cancel": "Atcelt",
  "ui.permission.always.project": "Vienmēr atļaut šajā projektā",
  "ui.permission.always.session": "Atļaut šai sesijai",
  "ui.permission.always.acceptEdits": "Atļaut visus labojumus (Pieņemt labojumus)",
  "ui.permission.always.everything": "viss šim rīkam",
  "ui.permission.guard.floor.title": "Aizsargāta darbība",
  "ui.permission.guard.guard.title": "Nepieciešams pārskats",
  "ui.permission.guard.noAlways": "To var apstiprināt tikai vienu reizi",
  "ui.permission.writes": "Raksta uz",
  "ui.question.planFeedback.placeholder": "Pastāstiet aģentam, ko mainīt plānā",
  ...
  "dialog.server.description": "Mainiet, pie kura AgentCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu AgentCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu AgentCode distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet AgentCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet AgentCode distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms AgentCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "AgentCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet AgentCode no jauna.",
  ...
  "help.tabs.introduction": "AgentCode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automātiskā apstiprināšana tagad ir “Pieņemt labojumus”",
  "toast.permissions.modeMigrated.description":
    "Labojumi šajā mapē tiek apstiprināti automātiski; par komandām joprojām jautā. Pilnai autonomijai ievades laukā izvēlieties “Apiet atļaujas”.",
  "toast.permissions.autoAcceptRemoved.title": "Automātiskā apstiprināšana ir izslēgta",
  "toast.permissions.autoAcceptRemoved.modes":
    "Atļauju pieprasījumi atkal tiks rādīti. Lai labojumus apstiprinātu automātiski, režīmu izvēlnē blakus uzvednei izvēlieties “Pieņemt labojumus” vai nospiediet Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Atļauju pieprasījumi atkal tiks rādīti. Lai tos izlaistu, atļaujiet šos rīkus šī servera atļauju konfigurācijā.",
  "toast.permissions.mode.error.title": "Neizdevās mainīt atļauju režīmu",
  ...
  "toast.model.selected.title": "Modelis: {{name}}",
  "toast.model.selected.others": "Citas atbilstības: {{count}}. Palaidiet /model, lai izvēlētos.",
  "toast.model.noMatch.title": "Neviens modelis neatbilst “{{query}}”",
  "toast.agent.noMatch.title": "Nav aģenta ar nosaukumu “{{query}}”",
  ...
  "toast.update.description": "Pieejama jauna AgentCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu AgentCode komandai",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, AgentCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "AgentCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist AgentCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt AgentCode saskarnes valodu",
  "settings.general.permissionMode.title": "Noklusējuma atļauju režīms",
  "settings.general.permissionMode.description": "Tiek izmantots jaunām sesijām šajā mapē",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā AgentCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai AgentCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet AgentCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot AgentCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko AgentCode versiju.",
