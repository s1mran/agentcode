export const dict = {
  ...
  "desktop.menu.documentation": "დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "AgentCode მენიუ",
  ...
  "desktop.recovery.loadFailed": "AgentCode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "AgentCode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "AgentCode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "command.model.choose.hint": "[მოდელი]",
  ...
  "command.agent.cycle.hint": "[აგენტი]",
  ...
  "command.permissionMode.cycle": "ნებართვების რეჟიმის შეცვლა",
  "command.permissionMode.set": "ნებართვების რეჟიმი: {{mode}}",
  "command.permissionMode.bypass": "ნებართვების უგულებელყოფა…",
  "command.plan": "დაგეგმვის რეჟიმი",
  ...
  "command.session.compact.hint": "[ფოკუსის ინსტრუქციები]",
  ...
  "command.session.export.hint": "[ფაილის სახელი]",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია AgentCode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები AgentCode-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები AgentCode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები AgentCode-ში.",
  ...
  "prompt.permissionMode.label": "ნებართვების რეჟიმი",
  "prompt.permissionMode.default": "ნებართვის მოთხოვნა",
  "prompt.permissionMode.default.description": "კითხულობს ბრძანებების, რედაქტირებისა და ვებზე წვდომის წინ",
  "prompt.permissionMode.acceptEdits": "რედაქტირების მიღება",
  "prompt.permissionMode.acceptEdits.description":
    "ამ პროექტში რედაქტირება დამტკიცებულია; ბრძანებებისთვის კვლავ კითხულობს",
  "prompt.permissionMode.plan": "დაგეგმვის რეჟიმი",
  "prompt.permissionMode.plan.description":
    "კვლევა მხოლოდ წაკითხვის რეჟიმში; რედაქტირება შესაძლებელია მხოლოდ გეგმის ფაილში",
  "prompt.permissionMode.bypassPermissions": "ნებართვების უგულებელყოფა",
  "prompt.permissionMode.bypassPermissions.description":
    "მუშავებს კითხვის გარეშე, გარდა დაცული ბილიკებისა, კრიტიკული წაშლისა და თქვენი მოთხოვნის წესებისა",
  "prompt.permissionMode.dontAsk": "არ კითხო",
  "prompt.permissionMode.dontAsk.description": "ყველაფერი, რაც კითხვას მოითხოვს, უარყოფილია",
  ...
  "prompt.slash.badge.builtin": "ჩაშენებული",
  "prompt.slash.hint.arguments": "[არგუმენტები]",
  "prompt.slash.hint.positional": "<არგ{{n}}>",
  "prompt.slash.unknown.title": "უცნობი ბრძანება: /{{name}}",
  "prompt.slash.unknown.description": "ტექსტის სახით გასაგზავნად შეტყობინება დაიწყეთ ჰარით.",
  "prompt.slash.unavailable.title": "/{{name}} აქ მიუწვდომელია",
  "prompt.slash.noArguments.title": "/{{name}} არგუმენტებს არ იღებს",
  ...
  "dialog.bypassPermissions.title": "ნებართვების უგულებელყოფა?",
  "dialog.bypassPermissions.body":
    "აგენტი კითხვის გარეშე გაუშვებს ბრძანებებს, შეცვლის ფაილებს და მიიღებს წვდომას ვებზე. დაცული ბილიკებისთვის (.git, აგენტის კონფიგურაცია, shell-ის გაშვების ფაილები), კრიტიკული წაშლისთვის და თქვენი საკუთარი მოთხოვნის წესებისთვის კვლავ კითხულობს; უარყოფის წესები კვლავ მოქმედებს. გამოიყენეთ ეს მხოლოდ იმ პროექტში, რომელსაც ენდობით.",
  "dialog.bypassPermissions.confirm": "ნებართვების უგულებელყოფა",
  "dialog.bypassPermissions.cancel": "გაუქმება",
  "ui.permission.always.project": "ყოველთვის დაშვება ამ პროექტში",
  "ui.permission.always.session": "დაშვება ამ სესიისთვის",
  "ui.permission.always.acceptEdits": "ყველა რედაქტირების დაშვება (რედაქტირების მიღება)",
  "ui.permission.always.everything": "ყველაფერი ამ ხელსაწყოსთვის",
  "ui.permission.guard.floor.title": "დაცული მოქმედება",
  "ui.permission.guard.guard.title": "საჭიროებს მიმოხილვას",
  "ui.permission.guard.noAlways": "ამის დამტკიცება შესაძლებელია მხოლოდ ერთხელ",
  "ui.permission.writes": "ჩაწერა",
  "ui.question.planFeedback.placeholder": "უთხარით აგენტს, რა უნდა შეცვალოს გეგმაში",
  ...
  "dialog.server.description": "გადართეთ რომელ AgentCode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია AgentCode-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება AgentCode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "AgentCode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ AgentCode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ AgentCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "ავტომატური მიღება ახლა „რედაქტირების მიღება“ რეჟიმია",
  "toast.permissions.modeMigrated.description":
    "ამ საქაღალდეში რედაქტირება ავტომატურად დამტკიცდება; ბრძანებებისთვის კვლავ კითხულობს. სრული ავტონომიისთვის აირჩიეთ „ნებართვების უგულებელყოფა“ მოთხოვნის ველში.",
  "toast.permissions.autoAcceptRemoved.title": "ავტომატური მიღება გამოირთულია",
  "toast.permissions.autoAcceptRemoved.modes":
    "ნებართვის მოთხოვნები ისევ გამოჩნდება. რედაქტირების ავტომატურად დასამტკიცებლად აირჩიეთ „რედაქტირების მიღება“ მოთხოვნის გვერდით რეჟიმების მენიუში ან დააჭირეთ Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "ნებართვის მოთხოვნები ისევ გამოჩნდება. მათ გვერდის ასსასვლელად დაუშვით ეს ხელსაწყოები ამ სერვერის ნებართვების კონფიგურაციაში.",
  "toast.permissions.mode.error.title": "ნებართვების რეჟიმის შეცვლა ვერ მოხერხდა",
  "toast.model.none.title": "მოდელი არ არის არჩეული",
  "toast.model.none.description": "დააკავშირეთ პროვაიდერი ამ სესიის შესაჯამებლად",
  "toast.model.selected.title": "მოდელი: {{name}}",
  "toast.model.selected.others": "სხვა დამთხვევები: {{count}}. ერთის ასარჩევად გაუშვით /model.",
  "toast.model.noMatch.title": "„{{query}}“-ს შესაბამისი მოდელი არ არის",
  "toast.agent.noMatch.title": "„{{query}}“ სახელის აგენტი არ არის",
  ...
  "toast.update.description": "AgentCode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა AgentCode გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, AgentCode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "AgentCode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით AgentCode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა AgentCode",
  "settings.general.permissionMode.title": "ნაგულისხმევი ნებართვების რეჟიმი",
  "settings.general.permissionMode.description": "გამოიყენება ამ საქაღალდის ახალი სესიებისთვის",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება AgentCode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა AgentCode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის AgentCode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც AgentCode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ AgentCode-ის უახლეს ვერსიას.",
