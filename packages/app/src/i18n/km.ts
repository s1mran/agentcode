export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច AgentCode ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "AgentCode មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpencode": "ការដំឡើង AgentCode បានបរាជ័យ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateVersion":
    "ការធ្វើបច្ចុប្បន្នភាព AgentCode បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "command.model.choose.hint": "[ម៉ូដែល]",
  ...
  "command.agent.cycle.hint": "[ភ្នាក់ងារ]",
  ...
  "command.permissionMode.cycle": "ប្ដូររបៀបការអនុញ្ញាត",
  "command.permissionMode.set": "របៀបការអនុញ្ញាត៖ {{mode}}",
  "command.permissionMode.bypass": "រំលងការអនុញ្ញាត…",
  "command.plan": "របៀបផែនការ",
  ...
  "command.session.compact.hint": "[ការណែនាំផ្តោត]",
  ...
  "command.session.export.hint": "[ឈ្មោះឯកសារ]",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ AgentCode",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង AgentCode។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង AgentCode ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង AgentCode។",
  ...
  "prompt.permissionMode.label": "របៀបការអនុញ្ញាត",
  "prompt.permissionMode.default": "សួររកការអនុញ្ញាត",
  "prompt.permissionMode.default.description": "សួរមុនពេលដំណើរការពាក្យបញ្ជា កែសម្រួល និងចូលប្រើបណ្ដាញ",
  "prompt.permissionMode.acceptEdits": "ទទួលយកការកែសម្រួល",
  "prompt.permissionMode.acceptEdits.description": "ការកែសម្រួលក្នុងគម្រោងនេះត្រូវបានអនុម័ត ពាក្យបញ្ជានៅតែសួរ",
  "prompt.permissionMode.plan": "របៀបផែនការ",
  "prompt.permissionMode.plan.description": "ការស្រាវជ្រាវបានតែអាន មានតែឯកសារផែនការប៉ុណ្ណោះដែលអាចកែសម្រួលបាន",
  "prompt.permissionMode.bypassPermissions": "រំលងការអនុញ្ញាត",
  "prompt.permissionMode.bypassPermissions.description":
    "ដំណើរការដោយមិនសួរ លើកលែងតែផ្លូវដែលបានការពារ ការលុបសំខាន់ៗ និងច្បាប់សួររបស់អ្នក",
  "prompt.permissionMode.dontAsk": "កុំសួរ",
  "prompt.permissionMode.dontAsk.description": "អ្វីៗដែលត្រូវសួរនឹងត្រូវបានបដិសេធ",
  ...
  "prompt.slash.badge.builtin": "មានស្រាប់",
  "prompt.slash.hint.arguments": "[អាគុយម៉ង់]",
  "prompt.slash.hint.positional": "<អាគុយម៉ង់{{n}}>",
  "prompt.slash.unknown.title": "ពាក្យបញ្ជាមិនស្គាល់៖ /{{name}}",
  "prompt.slash.unknown.description": "ចាប់ផ្តើមសារដោយដកឃ្លា ដើម្បីផ្ញើវាជាអត្ថបទ។",
  "prompt.slash.unavailable.title": "/{{name}} មិនមាននៅទីនេះទេ",
  "prompt.slash.noArguments.title": "/{{name}} មិនទទួលអាគុយម៉ង់ទេ",
  ...
  "dialog.bypassPermissions.title": "រំលងការអនុញ្ញាតឬ?",
  "dialog.bypassPermissions.body":
    "ភ្នាក់ងារនឹងដំណើរការពាក្យបញ្ជា កែសម្រួលឯកសារ និងចូលប្រើបណ្ដាញដោយមិនសួរ។ ផ្លូវដែលបានការពារ (.git ការកំណត់ភ្នាក់ងារ ឯកសារចាប់ផ្ដើមសែល) ការលុបសំខាន់ៗ និងច្បាប់សួររបស់អ្នកផ្ទាល់ នៅតែសួរ ហើយច្បាប់បដិសេធនៅតែអនុវត្ត។ ប្រើវាតែក្នុងគម្រោងដែលអ្នកទុកចិត្តប៉ុណ្ណោះ។",
  "dialog.bypassPermissions.confirm": "រំលងការអនុញ្ញាត",
  "dialog.bypassPermissions.cancel": "បោះបង់",
  "ui.permission.always.project": "អនុញ្ញាតជានិច្ចក្នុងគម្រោងនេះ",
  "ui.permission.always.session": "អនុញ្ញាតសម្រាប់សម័យនេះ",
  "ui.permission.always.acceptEdits": "អនុញ្ញាតការកែសម្រួលទាំងអស់ (ទទួលយកការកែសម្រួល)",
  "ui.permission.always.everything": "អ្វីៗទាំងអស់សម្រាប់ឧបករណ៍នេះ",
  "ui.permission.guard.floor.title": "សកម្មភាពដែលបានការពារ",
  "ui.permission.guard.guard.title": "ត្រូវការពិនិត្យ",
  "ui.permission.guard.noAlways": "វាអាចអនុម័តបានតែម្ដងប៉ុណ្ណោះ",
  "ui.permission.writes": "សរសេរទៅ",
  "ui.question.planFeedback.placeholder": "ប្រាប់ភ្នាក់ងារពីអ្វីដែលត្រូវផ្លាស់ប្ដូរក្នុងផែនការ",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ AgentCode ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpencode": "កំពុងពិនិត្យមើលកូដ AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "កំពុងពិនិត្យកូដ AgentCode ក្នុង {{distro}}...",
  "wsl.onboarding.updatingOpencode": "កំពុងអាប់ដេត AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "កំពុងអាប់ដេត AgentCode ក្នុង {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ធ្វើបច្ចុប្បន្នភាព AgentCode ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpencode": "ធ្វើបច្ចុប្បន្នភាព AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.opencodeReady": "AgentCode គឺរួចរាល់។",
  "wsl.onboarding.installOpencodeIn": "ដំឡើង AgentCode ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល AgentCode អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "AgentCode មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក AgentCode ឡើងវិញ។",
  ...
  "help.tabs.introduction": "AgentCode Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "ការទទួលយកស្វ័យប្រវត្តិឥឡូវជា «ទទួលយកការកែសម្រួល»",
  "toast.permissions.modeMigrated.description":
    "ការកែសម្រួលក្នុងថតនេះត្រូវបានអនុម័តដោយស្វ័យប្រវត្តិ ពាក្យបញ្ជានៅតែសួរ។ ជ្រើសរើស «រំលងការអនុញ្ញាត» នៅក្នុងប្រអប់បញ្ចូល ដើម្បីស្វ័យភាពពេញលេញ។",
  "toast.permissions.autoAcceptRemoved.title": "ការទទួលយកស្វ័យប្រវត្តិត្រូវបានបិទ",
  "toast.permissions.autoAcceptRemoved.modes":
    "សំណើការអនុញ្ញាតនឹងសួរម្ដងទៀត។ ដើម្បីអនុម័តការកែសម្រួលដោយស្វ័យប្រវត្តិ សូមជ្រើសរើស «ទទួលយកការកែសម្រួល» នៅក្នុងម៉ឺនុយរបៀបនៅជាប់ប្រអប់បញ្ចូល ឬចុច Shift+Tab។",
  "toast.permissions.autoAcceptRemoved.rules":
    "សំណើការអនុញ្ញាតនឹងសួរម្ដងទៀត។ ដើម្បីរំលងវា សូមអនុញ្ញាតឧបករណ៍ទាំងនោះនៅក្នុងការកំណត់រចនាសម្ព័ន្ធការអនុញ្ញាតរបស់ម៉ាស៊ីនមេនេះ។",
  "toast.permissions.mode.error.title": "មិនអាចប្ដូររបៀបការអនុញ្ញាតបានទេ",
  "toast.model.none.title": "មិនបានជ្រើសរើសម៉ូដែលទេ។",
  "toast.model.none.description": "ភ្ជាប់អ្នកផ្តល់សេវាដើម្បីសង្ខេបសម័យនេះ។",
  "toast.model.selected.title": "ម៉ូដែល៖ {{name}}",
  "toast.model.selected.others": "ការផ្គូផ្គងផ្សេងទៀត៖ {{count}}។ ដំណើរការ /model ដើម្បីជ្រើសរើសមួយ។",
  "toast.model.noMatch.title": "គ្មានម៉ូដែលណាត្រូវនឹង “{{query}}” ទេ",
  "toast.agent.noMatch.title": "គ្មានភ្នាក់ងារឈ្មោះ “{{query}}” ទេ",
  ...
  "toast.update.description": "កំណែថ្មីនៃ AgentCode ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម AgentCode",
  "error.page.report.discord": "នៅលើ GitHub",
  ...
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ AgentCode មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "AgentCode រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ AgentCode នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ AgentCode",
  "settings.general.permissionMode.title": "របៀបការអនុញ្ញាតលំនាំដើម",
  "settings.general.permissionMode.description": "ប្រើសម្រាប់សម័យថ្មីក្នុងថតនេះ",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល AgentCode មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ AgentCode ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល AgentCode មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល AgentCode ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ AgentCode ។",
