export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu",
  ...
  "desktop.recovery.loadFailed": "Không tải được AgentCode",
  "desktop.recovery.terminated": "Cửa sổ AgentCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "AgentCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật AgentCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "command.model.choose.hint": "[mô hình]",
  ...
  "command.agent.cycle.hint": "[tác nhân]",
  ...
  "command.permissionMode.cycle": "Chuyển chế độ quyền",
  "command.permissionMode.set": "Chế độ quyền: {{mode}}",
  "command.permissionMode.bypass": "Bỏ qua quyền…",
  "command.plan": "Chế độ lập kế hoạch",
  ...
  "command.session.compact.hint": "[hướng dẫn trọng tâm]",
  ...
  "command.session.export.hint": "[tên tệp]",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do AgentCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong AgentCode.",
  ...
  "prompt.permissionMode.label": "Chế độ quyền",
  "prompt.permissionMode.default": "Hỏi quyền",
  "prompt.permissionMode.default.description": "Hỏi trước khi chạy lệnh, chỉnh sửa và truy cập web",
  "prompt.permissionMode.acceptEdits": "Chấp nhận chỉnh sửa",
  "prompt.permissionMode.acceptEdits.description": "Các chỉnh sửa trong dự án này được phê duyệt; lệnh vẫn cần hỏi",
  "prompt.permissionMode.plan": "Chế độ lập kế hoạch",
  "prompt.permissionMode.plan.description": "Nghiên cứu chỉ đọc; chỉ có thể chỉnh sửa tệp kế hoạch",
  "prompt.permissionMode.bypassPermissions": "Bỏ qua quyền",
  "prompt.permissionMode.bypassPermissions.description":
    "Chạy mà không hỏi, trừ các đường dẫn được bảo vệ, thao tác xóa quan trọng và quy tắc hỏi của bạn",
  "prompt.permissionMode.dontAsk": "Không hỏi",
  "prompt.permissionMode.dontAsk.description": "Mọi thao tác cần hỏi đều bị từ chối",
  ...
  "prompt.slash.badge.builtin": "tích hợp",
  "prompt.slash.hint.arguments": "[đối số]",
  "prompt.slash.hint.positional": "<đối số {{n}}>",
  "prompt.slash.unknown.title": "Lệnh không xác định: /{{name}}",
  "prompt.slash.unknown.description": "Bắt đầu tin nhắn bằng dấu cách để gửi dưới dạng văn bản.",
  "prompt.slash.unavailable.title": "/{{name}} không khả dụng ở đây",
  "prompt.slash.noArguments.title": "/{{name}} không nhận đối số",
  ...
  "dialog.bypassPermissions.title": "Bỏ qua quyền?",
  "dialog.bypassPermissions.body":
    "Tác nhân sẽ chạy lệnh, chỉnh sửa tệp và truy cập web mà không hỏi. Các đường dẫn được bảo vệ (.git, cấu hình tác nhân, tệp khởi động shell), thao tác xóa quan trọng và quy tắc hỏi của riêng bạn vẫn sẽ hỏi; quy tắc từ chối vẫn được áp dụng. Chỉ sử dụng tùy chọn này trong dự án bạn tin tưởng.",
  "dialog.bypassPermissions.confirm": "Bỏ qua quyền",
  "dialog.bypassPermissions.cancel": "Hủy",
  "ui.permission.always.project": "Luôn cho phép trong dự án này",
  "ui.permission.always.session": "Cho phép trong phiên này",
  "ui.permission.always.acceptEdits": "Cho phép mọi chỉnh sửa (Chấp nhận chỉnh sửa)",
  "ui.permission.always.everything": "mọi thứ cho công cụ này",
  "ui.permission.guard.floor.title": "Thao tác được bảo vệ",
  "ui.permission.guard.guard.title": "Cần xem xét",
  "ui.permission.guard.noAlways": "Chỉ có thể phê duyệt một lần",
  "ui.permission.writes": "Ghi vào",
  "ui.question.planFeedback.placeholder": "Cho tác nhân biết cần thay đổi gì trong kế hoạch",
  ...
  "dialog.server.description": "Chuyển máy chủ AgentCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra AgentCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật AgentCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật AgentCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt AgentCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi AgentCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "AgentCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Tự động chấp nhận giờ là Chấp nhận chỉnh sửa",
  "toast.permissions.modeMigrated.description":
    "Các chỉnh sửa trong thư mục này được tự động phê duyệt; lệnh vẫn cần hỏi. Chọn Bỏ qua quyền trong trình soạn thảo để có toàn quyền tự chủ.",
  "toast.permissions.autoAcceptRemoved.title": "Đã tắt tự động chấp nhận",
  "toast.permissions.autoAcceptRemoved.modes":
    "Yêu cầu quyền sẽ được hỏi lại. Để tự động phê duyệt chỉnh sửa, hãy chọn Chấp nhận chỉnh sửa trong menu chế độ bên cạnh lời nhắc hoặc nhấn Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Yêu cầu quyền sẽ được hỏi lại. Để bỏ qua, hãy cho phép các công cụ đó trong cấu hình quyền của máy chủ này.",
  "toast.permissions.mode.error.title": "Không thể thay đổi chế độ quyền",
  ...
  "toast.model.selected.title": "Mô hình: {{name}}",
  "toast.model.selected.others": "Kết quả khớp khác: {{count}}. Chạy /model để chọn một.",
  "toast.model.noMatch.title": "Không có mô hình nào khớp với “{{query}}”",
  "toast.agent.noMatch.title": "Không có tác nhân nào tên “{{query}}”",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của AgentCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm AgentCode",
  "error.page.report.discord": "trên GitHub",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: AgentCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ AgentCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho AgentCode",
  "settings.general.permissionMode.title": "Chế độ quyền mặc định",
  "settings.general.permissionMode.description": "Dùng cho các phiên mới trong thư mục này",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của AgentCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem AgentCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của AgentCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi AgentCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của AgentCode.",
