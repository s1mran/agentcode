export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap AgentCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "AgentCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan AgentCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini AgentCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "command.permissionMode.cycle": "Pusing mod kebenaran",
  "command.permissionMode.set": "Mod kebenaran: {{mode}}",
  "command.permissionMode.bypass": "Pintas kebenaran…",
  "command.plan": "Mod perancangan",
  ...
  "command.session.compact.hint": "[arahan fokus]",
  ...
  "command.session.export.hint": "[nama fail]",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AgentCode.",
  ...
  "prompt.permissionMode.label": "Mod kebenaran",
  "prompt.permissionMode.default": "Minta kebenaran",
  "prompt.permissionMode.default.description": "Bertanya sebelum arahan, suntingan dan akses web",
  "prompt.permissionMode.acceptEdits": "Terima suntingan",
  "prompt.permissionMode.acceptEdits.description": "Suntingan dalam projek ini diluluskan; arahan masih ditanya",
  "prompt.permissionMode.plan": "Mod perancangan",
  "prompt.permissionMode.plan.description": "Penyelidikan baca sahaja; hanya fail rancangan boleh disunting",
  "prompt.permissionMode.bypassPermissions": "Pintas kebenaran",
  "prompt.permissionMode.bypassPermissions.description":
    "Berjalan tanpa bertanya, kecuali laluan dilindungi, pemadaman kritikal dan peraturan tanya anda",
  "prompt.permissionMode.dontAsk": "Jangan tanya",
  "prompt.permissionMode.dontAsk.description": "Apa-apa yang perlu ditanya akan ditolak",
  ...
  "prompt.slash.badge.builtin": "terbina dalam",
  "prompt.slash.hint.arguments": "[argumen]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Arahan tidak diketahui: /{{name}}",
  "prompt.slash.unknown.description": "Mulakan mesej dengan ruang untuk menghantarnya sebagai teks.",
  "prompt.slash.unavailable.title": "/{{name}} tidak tersedia di sini",
  "prompt.slash.noArguments.title": "/{{name}} tidak menerima argumen",
  ...
  "dialog.bypassPermissions.title": "Pintas kebenaran?",
  "dialog.bypassPermissions.body":
    "Ejen akan menjalankan arahan, menyunting fail dan mengakses web tanpa bertanya. Laluan dilindungi (.git, konfigurasi ejen, fail permulaan shell), pemadaman kritikal dan peraturan tanya anda sendiri masih ditanya; peraturan tolak masih terpakai. Gunakan ini hanya dalam projek yang anda percayai.",
  "dialog.bypassPermissions.confirm": "Pintas kebenaran",
  "dialog.bypassPermissions.cancel": "Batal",
  "ui.permission.always.project": "Sentiasa benarkan dalam projek ini",
  "ui.permission.always.session": "Benarkan untuk sesi ini",
  "ui.permission.always.acceptEdits": "Benarkan semua suntingan (Terima suntingan)",
  "ui.permission.always.everything": "semua untuk alat ini",
  "ui.permission.guard.floor.title": "Tindakan dilindungi",
  "ui.permission.guard.guard.title": "Perlu disemak",
  "ui.permission.guard.noAlways": "Ini hanya boleh diluluskan sekali",
  "ui.permission.writes": "Menulis ke",
  "ui.question.planFeedback.placeholder": "Beritahu ejen perkara yang perlu diubah dalam rancangan",
  ...
  "dialog.server.description": "Tukar pelayan AgentCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak AgentCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini AgentCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini AgentCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang AgentCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AgentCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AgentCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Terima automatik kini ialah Terima suntingan",
  "toast.permissions.modeMigrated.description":
    "Suntingan dalam folder ini diluluskan secara automatik; arahan masih ditanya. Pilih Pintas kebenaran dalam kotak input untuk autonomi penuh.",
  "toast.permissions.autoAcceptRemoved.title": "Terima automatik telah dimatikan",
  "toast.permissions.autoAcceptRemoved.modes":
    "Permintaan kebenaran akan ditanya semula. Untuk meluluskan suntingan secara automatik, pilih Terima suntingan dalam menu mod di sebelah kotak input atau tekan Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Permintaan kebenaran akan ditanya semula. Untuk melangkaunya, benarkan alat tersebut dalam konfigurasi kebenaran pelayan ini.",
  "toast.permissions.mode.error.title": "Tidak dapat menukar mod kebenaran",
  ...
  "toast.model.selected.others": "Padanan lain: {{count}}. Jalankan /model untuk memilih satu.",
  "toast.model.noMatch.title": "Tiada model sepadan dengan “{{query}}”",
  "toast.agent.noMatch.title": "Tiada ejen bernama “{{query}}”",
  ...
  "toast.update.description": "Versi baharu AgentCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan AgentCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, AgentCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan AgentCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk AgentCode",
  "settings.general.permissionMode.title": "Mod kebenaran lalai",
  "settings.general.permissionMode.description": "Digunakan untuk sesi baharu dalam folder ini",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa AgentCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada AgentCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema AgentCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila AgentCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini AgentCode.",
