export const dict = {
  ...
  "desktop.menu.documentation": "Документација",
  ...
  "desktop.menu.ariaLabel": "AgentCode мени",
  ...
  "desktop.recovery.loadFailed": "AgentCode не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот AgentCode неочекувано заврши",
  "desktop.recovery.unresponsive": "AgentCode не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата AgentCode не успеа",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "command.permissionMode.cycle": "Промени режим на дозволи",
  "command.permissionMode.set": "Режим на дозволи: {{mode}}",
  "command.permissionMode.bypass": "Заобиколи ги дозволите…",
  "command.plan": "Режим на планирање",
  ...
  "command.session.compact.hint": "[упатства за фокус]",
  ...
  "command.session.export.hint": "[име на датотека]",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во AgentCode.",
  ...
  "prompt.permissionMode.label": "Режим на дозволи",
  "prompt.permissionMode.default": "Прашувај за дозволи",
  "prompt.permissionMode.default.description": "Прашува пред команди, уредувања и пристап до интернет",
  "prompt.permissionMode.acceptEdits": "Прифаќај уредувања",
  "prompt.permissionMode.acceptEdits.description":
    "Уредувањата во овој проект се одобрени; за командите сè уште прашува",
  "prompt.permissionMode.plan": "Режим на планирање",
  "prompt.permissionMode.plan.description": "Истражување само за читање; може да се уредува само датотеката со планот",
  "prompt.permissionMode.bypassPermissions": "Заобиколи ги дозволите",
  "prompt.permissionMode.bypassPermissions.description":
    "Работи без прашување, освен за заштитени патеки, критични бришења и вашите правила за прашување",
  "prompt.permissionMode.dontAsk": "Не прашувај",
  "prompt.permissionMode.dontAsk.description": "Сè што би барало прашување се одбива",
  ...
  "prompt.slash.badge.builtin": "вградена",
  "prompt.slash.hint.arguments": "[аргументи]",
  "prompt.slash.hint.positional": "<арг{{n}}>",
  "prompt.slash.unknown.title": "Непозната команда: /{{name}}",
  "prompt.slash.unknown.description": "Започнете ја пораката со празно место за да ја испратите како текст.",
  "prompt.slash.unavailable.title": "/{{name}} не е достапна тука",
  "prompt.slash.noArguments.title": "/{{name}} не прима аргументи",
  ...
  "dialog.bypassPermissions.title": "Да се заобиколат дозволите?",
  "dialog.bypassPermissions.body":
    "Агентот ќе извршува команди, ќе уредува датотеки и ќе пристапува до интернет без прашување. За заштитени патеки (.git, конфигурација на агентот, датотеки за стартување на школката), критични бришења и вашите сопствени правила за прашување сè уште прашува; правилата за одбивање и понатаму важат. Користете го ова само во проект на кој му верувате.",
  "dialog.bypassPermissions.confirm": "Заобиколи ги дозволите",
  "dialog.bypassPermissions.cancel": "Откажи",
  "ui.permission.always.project": "Секогаш дозволи во овој проект",
  "ui.permission.always.session": "Дозволи за оваа сесија",
  "ui.permission.always.acceptEdits": "Дозволи ги сите уредувања (Прифаќај уредувања)",
  "ui.permission.always.everything": "сè за оваа алатка",
  "ui.permission.guard.floor.title": "Заштитено дејство",
  "ui.permission.guard.guard.title": "Потребен е преглед",
  "ui.permission.guard.noAlways": "Ова може да се одобри само еднаш",
  "ui.permission.writes": "Запишува во",
  "ui.question.planFeedback.placeholder": "Кажете му на агентот што да смени во планот",
  ...
  "dialog.server.description": "Променете на кој AgentCode сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува AgentCode во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира AgentCode во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте AgentCode во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте AgentCode во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред AgentCode да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "AgentCode не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Автоматското прифаќање сега е „Прифаќај уредувања“",
  "toast.permissions.modeMigrated.description":
    "Уредувањата во оваа папка се одобруваат автоматски; за командите сè уште прашува. За целосна автономија, изберете „Заобиколи ги дозволите“ во полето за внес.",
  "toast.permissions.autoAcceptRemoved.title": "Автоматското прифаќање е исклучено",
  "toast.permissions.autoAcceptRemoved.modes":
    "Барањата за дозвола повторно ќе се прикажуваат. За автоматско одобрување на уредувањата, изберете „Прифаќај уредувања“ во менито за режими до полето за внес или притиснете Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Барањата за дозвола повторно ќе се прикажуваат. За да ги прескокнете, дозволете ги тие алатки во конфигурацијата за дозволи на овој сервер.",
  "toast.permissions.mode.error.title": "Не може да се промени режимот на дозволи",
  ...
  "toast.model.selected.others": "Други совпаѓања: {{count}}. Извршете /model за да изберете.",
  "toast.model.noMatch.title": "Ниеден модел не одговара на „{{query}}“",
  "toast.agent.noMatch.title": "Нема агент со име „{{query}}“",
  ...
  "toast.update.description": "Новата верзија на AgentCode ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот AgentCode",
  ...
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, AgentCode сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "AgentCode вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот AgentCode во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за AgentCode",
  "settings.general.permissionMode.title": "Стандарден режим на дозволи",
  "settings.general.permissionMode.description": "Се користи за нови сесии во оваа папка",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа AgentCode на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали AgentCode ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како AgentCode е тематизирана.",
  ...
  "settings.updates.row.startup.description":
    "Автоматски проверувајте дали има ажурирања кога ќе се стартува AgentCode",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на AgentCode.",
