export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCode մենյու",
  ...
  "desktop.recovery.loadFailed": "AgentCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "AgentCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "AgentCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "command.model.choose.hint": "[մոդել]",
  ...
  "command.agent.cycle.hint": "[գործակալ]",
  ...
  "command.permissionMode.cycle": "Փոխել թույլտվությունների ռեժիմը",
  "command.permissionMode.set": "Թույլտվությունների ռեժիմ՝ {{mode}}",
  "command.permissionMode.bypass": "Շրջանցել թույլտվությունները…",
  "command.plan": "Պլանավորման ռեժիմ",
  ...
  "command.session.compact.hint": "[կենտրոնացման հրահանգներ]",
  ...
  "command.session.export.hint": "[ֆայլի անուն]",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և AgentCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և AgentCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և AgentCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "prompt.permissionMode.label": "Թույլտվությունների ռեժիմ",
  "prompt.permissionMode.default": "Հարցնել թույլտվություն",
  "prompt.permissionMode.default.description": "Հարցնում է հրամաններից, խմբագրումներից և համացանցից օգտվելուց առաջ",
  "prompt.permissionMode.acceptEdits": "Ընդունել խմբագրումները",
  "prompt.permissionMode.acceptEdits.description":
    "Այս նախագծի խմբագրումները հաստատվում են, հրամանների համար դեռ հարցնում է",
  "prompt.permissionMode.plan": "Պլանավորման ռեժիմ",
  "prompt.permissionMode.plan.description": "Միայն կարդալու հետազոտություն, կարելի է խմբագրել միայն պլանի ֆայլը",
  "prompt.permissionMode.bypassPermissions": "Շրջանցել թույլտվությունները",
  "prompt.permissionMode.bypassPermissions.description":
    "Աշխատում է առանց հարցնելու, բացի պաշտպանված ուղիներից, կրիտիկական ջնջումներից և ձեր հարցման կանոններից",
  "prompt.permissionMode.dontAsk": "Չհարցնել",
  "prompt.permissionMode.dontAsk.description": "Այն ամենը, ինչի համար կհարցներ, մերժվում է",
  ...
  "prompt.slash.badge.builtin": "ներկառուցված",
  "prompt.slash.hint.arguments": "[արգումենտներ]",
  "prompt.slash.hint.positional": "<արգ{{n}}>",
  "prompt.slash.unknown.title": "Անհայտ հրաման՝ /{{name}}",
  "prompt.slash.unknown.description": "Որպես տեքստ ուղարկելու համար հաղորդագրությունը սկսեք բացատով։",
  "prompt.slash.unavailable.title": "/{{name}}-ն այստեղ հասանելի չէ",
  "prompt.slash.noArguments.title": "/{{name}}-ն արգումենտներ չի ընդունում",
  ...
  "dialog.bypassPermissions.title": "Շրջանցե՞լ թույլտվությունները",
  "dialog.bypassPermissions.body":
    "Գործակալը առանց հարցնելու կգործարկի հրամաններ, կխմբագրի ֆայլեր և կօգտվի համացանցից։ Պաշտպանված ուղիների (.git, գործակալի կարգավորումներ, shell-ի մեկնարկային ֆայլեր), կրիտիկական ջնջումների և ձեր սեփական հարցման կանոնների դեպքում դեռ հարցնում է, իսկ մերժման կանոնները շարունակում են գործել։ Օգտագործեք սա միայն այն նախագծում, որին վստահում եք։",
  "dialog.bypassPermissions.confirm": "Շրջանցել թույլտվությունները",
  "dialog.bypassPermissions.cancel": "Չեղարկել",
  "ui.permission.always.project": "Միշտ թույլատրել այս նախագծում",
  "ui.permission.always.session": "Թույլատրել այս նիստի համար",
  "ui.permission.always.acceptEdits": "Թույլատրել բոլոր խմբագրումները (Ընդունել խմբագրումները)",
  "ui.permission.always.everything": "ամեն ինչ այս գործիքի համար",
  "ui.permission.guard.floor.title": "Պաշտպանված գործողություն",
  "ui.permission.guard.guard.title": "Պահանջում է վերանայում",
  "ui.permission.guard.noAlways": "Սա կարելի է հաստատել միայն մեկ անգամ",
  "ui.permission.writes": "Գրում է",
  "ui.question.planFeedback.placeholder": "Ասեք գործակալին, թե ինչ փոխել պլանում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ AgentCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է AgentCode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է AgentCode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել AgentCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "AgentCode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք AgentCode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի AgentCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "AgentCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք AgentCode։",
  ...
  "help.tabs.introduction": "AgentCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Ավտոմատ ընդունումը փոխարինվել է «Ընդունել խմբագրումները» ռեժիմով",
  "toast.permissions.modeMigrated.description":
    "Այս թղթապանակում խմբագրումները հաստատվում են ավտոմատ կերպով, հրամանների համար դեռ հարցնում է։ Լիարժեք ինքնավարության համար հուշման դաշտում ընտրեք «Շրջանցել թույլտվությունները»։",
  "toast.permissions.autoAcceptRemoved.title": "Ավտոմատ ընդունումն անջատվել է",
  "toast.permissions.autoAcceptRemoved.modes":
    "Թույլտվության հարցումները կրկին կցուցադրվեն։ Խմբագրումներն ավտոմատ հաստատելու համար հուշման կողքի ռեժիմների ընտրացանկում ընտրեք «Ընդունել խմբագրումները» կամ սեղմեք Shift+Tab։",
  "toast.permissions.autoAcceptRemoved.rules":
    "Թույլտվության հարցումները կրկին կցուցադրվեն։ Դրանք բաց թողնելու համար թույլատրեք այդ գործիքները այս սերվերի թույլտվությունների կարգավորումներում։",
  "toast.permissions.mode.error.title": "Չհաջողվեց փոխել թույլտվությունների ռեժիմը",
  "toast.model.none.title": "Ընտրված չէ մոդել",
  "toast.model.none.description": "Միացրեք մատակարարին՝ այս նիստն ամփոփելու համար",
  "toast.model.selected.title": "Մոդել՝ {{name}}",
  "toast.model.selected.others": "Այլ համընկնումներ՝ {{count}}։ Ընտրելու համար գործարկեք /model։",
  "toast.model.noMatch.title": "«{{query}}»-ին համապատասխանող մոդել չկա",
  "toast.agent.noMatch.title": "«{{query}}» անունով գործակալ չկա",
  ...
  "toast.update.description": "AgentCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին AgentCode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ AgentCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "AgentCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք AgentCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն AgentCode",
  "settings.general.permissionMode.title": "Լռելյայն թույլտվությունների ռեժիմ",
  "settings.general.permissionMode.description": "Օգտագործվում է այս թղթապանակի նոր նիստերի համար",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է AgentCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ AgentCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է AgentCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ AgentCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք AgentCode-ի վերջին տարբերակը։",
