export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor AgentCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "AgentCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija AgentCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje AgentCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AgentCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AgentCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AgentCode-u.",
  ...
  "prompt.slash.unknown.title": "Nepoznata komanda: /{{name}}",
  "prompt.slash.unknown.description": "Započnite poruku razmakom da je pošaljete kao tekst.",
  ...
  "dialog.server.description": "Promijeni na koji se AgentCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera AgentCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AgentCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj AgentCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj AgentCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj AgentCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi AgentCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.agent.noMatch.title": "Nema agenta s imenom „{{query}}“",
  ...
  "toast.update.description": "Nova verzija AgentCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AgentCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AgentCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AgentCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako AgentCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AgentCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AgentCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AgentCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AgentCode-a.",
