export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด AgentCode ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง AgentCode หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "AgentCode ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง AgentCode ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง AgentCode ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต AgentCode เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "command.model.choose.hint": "[โมเดล]",
  ...
  "command.agent.cycle.hint": "[เอเจนต์]",
  ...
  "command.session.compact.hint": "[คำแนะนำประเด็นที่เน้น]",
  ...
  "command.session.export.hint": "[ชื่อไฟล์]",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย AgentCode",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน AgentCode",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน AgentCode",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน AgentCode",
  ...
  "prompt.slash.badge.builtin": "ในตัว",
  "prompt.slash.hint.arguments": "[อาร์กิวเมนต์]",
  "prompt.slash.hint.positional": "<อาร์ก{{n}}>",
  "prompt.slash.unknown.title": "ไม่รู้จักคำสั่ง: /{{name}}",
  "prompt.slash.unknown.description": "เริ่มข้อความด้วยช่องว่างเพื่อส่งเป็นข้อความธรรมดา",
  "prompt.slash.unavailable.title": "/{{name}} ใช้ที่นี่ไม่ได้",
  "prompt.slash.noArguments.title": "/{{name}} ไม่รับอาร์กิวเมนต์",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ AgentCode ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ AgentCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต AgentCode ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต AgentCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "AgentCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง AgentCode ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง AgentCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ AgentCode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด AgentCode อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ AgentCode Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.model.selected.title": "โมเดล: {{name}}",
  "toast.model.selected.others": "รายการที่ตรงกันอื่น: {{count}} เรียกใช้ /model เพื่อเลือก",
  "toast.model.noMatch.title": "ไม่มีโมเดลที่ตรงกับ “{{query}}”",
  "toast.agent.noMatch.title": "ไม่มีเอเจนต์ชื่อ “{{query}}”",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ AgentCode ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม AgentCode",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า AgentCode ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "AgentCode รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ AgentCode ภายใน WSL บน Windows",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ AgentCode บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ AgentCode ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ AgentCode",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ AgentCode เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน AgentCode เวอร์ชันล่าสุด",
