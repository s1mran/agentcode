...
export const dict = {
  ...
  "command.session.compact.hint": "[focus instructions]",
  ...
  "command.session.export.hint": "[filename]",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AgentCode.",
  ...
  "prompt.slash.badge.builtin": "built-in",
  "prompt.slash.hint.arguments": "[arguments]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Unknown command: /{{name}}",
  "prompt.slash.unknown.description": "Start the message with a space to send it as text.",
  "prompt.slash.unavailable.title": "/{{name}} isn't available here",
  "prompt.slash.noArguments.title": "/{{name}} doesn't take arguments",
  ...
  "dialog.server.description": "Switch which AgentCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AgentCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AgentCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AgentCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AgentCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AgentCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AgentCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Other matches: {{count}}. Run /model to pick one.",
  "toast.model.noMatch.title": 'No model matches "{{query}}"',
  "toast.agent.noMatch.title": 'No agent named "{{query}}"',
  ...
  "toast.update.description": "A new version of AgentCode ({{version}}) is now available to install.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AgentCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AgentCode server inside WSL on Windows.",
  ...
  "settings.general.row.appearance.description": "Customise how AgentCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AgentCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AgentCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AgentCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AgentCode.",
