export const dict = {
  ...
  "command.model.choose.hint": "[modello]",
  ...
  "command.agent.cycle.hint": "[agente]",
  ...
  "command.permissionMode.cycle": "Cambia modalità autorizzazioni",
  "command.permissionMode.set": "Modalità autorizzazioni: {{mode}}",
  "command.permissionMode.bypass": "Ignora autorizzazioni…",
  "command.plan": "Modalità pianificazione",
  ...
  "command.session.compact.hint": "[istruzioni di focus]",
  ...
  "command.session.export.hint": "[nome file]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in AgentCode.",
  ...
  "prompt.permissionMode.label": "Modalità autorizzazioni",
  "prompt.permissionMode.default": "Chiedi autorizzazioni",
  "prompt.permissionMode.default.description": "Chiede prima di comandi, modifiche e accesso al web",
  "prompt.permissionMode.acceptEdits": "Accetta modifiche",
  "prompt.permissionMode.acceptEdits.description":
    "Le modifiche in questo progetto sono approvate; per i comandi chiede comunque",
  "prompt.permissionMode.plan": "Modalità pianificazione",
  "prompt.permissionMode.plan.description": "Ricerca in sola lettura; è modificabile solo il file del piano",
  "prompt.permissionMode.bypassPermissions": "Ignora autorizzazioni",
  "prompt.permissionMode.bypassPermissions.description":
    "Esegue senza chiedere, tranne per percorsi protetti, eliminazioni critiche e le tue regole di richiesta",
  "prompt.permissionMode.dontAsk": "Non chiedere",
  "prompt.permissionMode.dontAsk.description": "Tutto ciò che richiederebbe una conferma viene negato",
  ...
  "prompt.slash.badge.builtin": "integrato",
  "prompt.slash.hint.arguments": "[argomenti]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Comando sconosciuto: /{{name}}",
  "prompt.slash.unknown.description": "Inizia il messaggio con uno spazio per inviarlo come testo.",
  "prompt.slash.unavailable.title": "/{{name}} non è disponibile qui",
  "prompt.slash.noArguments.title": "/{{name}} non accetta argomenti",
  ...
  "dialog.bypassPermissions.title": "Ignorare le autorizzazioni?",
  "dialog.bypassPermissions.body":
    "L'agente eseguirà comandi, modificherà file e accederà al web senza chiedere. Per percorsi protetti (.git, configurazione dell'agente, file di avvio della shell), eliminazioni critiche e le tue regole di richiesta chiede comunque; le regole di negazione restano valide. Usalo solo in un progetto di cui ti fidi.",
  "dialog.bypassPermissions.confirm": "Ignora autorizzazioni",
  "dialog.bypassPermissions.cancel": "Annulla",
  "ui.permission.always.project": "Consenti sempre in questo progetto",
  "ui.permission.always.session": "Consenti per questa sessione",
  "ui.permission.always.acceptEdits": "Consenti tutte le modifiche (Accetta modifiche)",
  "ui.permission.always.everything": "tutto per questo strumento",
  "ui.permission.guard.floor.title": "Azione protetta",
  "ui.permission.guard.guard.title": "Richiede revisione",
  "ui.permission.guard.noAlways": "Può essere approvato solo una volta",
  "ui.permission.writes": "Scrive in",
  "ui.question.planFeedback.placeholder": "Di' all'agente cosa cambiare nel piano",
  ...
  "dialog.server.description": "Cambia il server AgentCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo AgentCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento AgentCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna AgentCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa AgentCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che AgentCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "AgentCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "L'accettazione automatica ora è Accetta modifiche",
  "toast.permissions.modeMigrated.description":
    "Le modifiche in questa cartella vengono approvate automaticamente; per i comandi chiede comunque. Scegli Ignora autorizzazioni nel campo del prompt per la piena autonomia.",
  "toast.permissions.autoAcceptRemoved.title": "L'accettazione automatica è stata disattivata",
  "toast.permissions.autoAcceptRemoved.modes":
    "Le richieste di autorizzazione verranno mostrate di nuovo. Per approvare automaticamente le modifiche, scegli Accetta modifiche nel menu delle modalità accanto al prompt o premi Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Le richieste di autorizzazione verranno mostrate di nuovo. Per evitarle, consenti quegli strumenti nella configurazione delle autorizzazioni di questo server.",
  "toast.permissions.mode.error.title": "Impossibile cambiare la modalità autorizzazioni",
  ...
  "toast.model.selected.title": "Modello: {{name}}",
  "toast.model.selected.others": "Altre corrispondenze: {{count}}. Esegui /model per sceglierne uno.",
  "toast.model.noMatch.title": "Nessun modello corrisponde a «{{query}}»",
  "toast.agent.noMatch.title": "Nessun agente chiamato «{{query}}»",
  ...
  "toast.update.description": "Una nuova versione di AgentCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team AgentCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: AgentCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server AgentCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per AgentCode",
  "settings.general.permissionMode.title": "Modalità autorizzazioni predefinita",
  "settings.general.permissionMode.description": "Usata per le nuove sessioni in questa cartella",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di AgentCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se AgentCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di AgentCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di AgentCode",
  ...
  "settings.updates.toast.latest.title": "AgentCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di AgentCode.",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare AgentCode",
  "desktop.recovery.terminated": "La finestra di AgentCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "AgentCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di AgentCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di AgentCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
