export const dict = {
  ...
  "desktop.menu.documentation": "Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "AgentCode μενού",
  ...
  "desktop.recovery.loadFailed": "AgentCode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "AgentCode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "AgentCode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.opencodeMissing": "Το opencode δεν είναι εγκατεστημένο σε αυτήν τη διανομή",
  "desktop.wsl.error.opencodeCannotRun": "Το opencode είναι εγκατεστημένο αλλά δεν ήταν δυνατή η εκτέλεσή του",
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "command.model.choose.hint": "[μοντέλο]",
  ...
  "command.agent.cycle.hint": "[πράκτορας]",
  ...
  "command.permissionMode.cycle": "Εναλλαγή λειτουργίας δικαιωμάτων",
  "command.permissionMode.set": "Λειτουργία δικαιωμάτων: {{mode}}",
  "command.permissionMode.bypass": "Παράκαμψη δικαιωμάτων…",
  "command.plan": "Λειτουργία σχεδιασμού",
  ...
  "command.session.compact.hint": "[οδηγίες εστίασης]",
  ...
  "command.session.export.hint": "[όνομα αρχείου]",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο AgentCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "Το OpenCode Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο AgentCode.",
  ...
  "prompt.permissionMode.label": "Λειτουργία δικαιωμάτων",
  "prompt.permissionMode.default": "Ερώτηση για δικαιώματα",
  "prompt.permissionMode.default.description": "Ρωτά πριν από εντολές, επεξεργασίες και πρόσβαση στον ιστό",
  "prompt.permissionMode.acceptEdits": "Αποδοχή επεξεργασιών",
  "prompt.permissionMode.acceptEdits.description":
    "Οι επεξεργασίες σε αυτό το έργο εγκρίνονται· για τις εντολές εξακολουθεί να ρωτά",
  "prompt.permissionMode.plan": "Λειτουργία σχεδιασμού",
  "prompt.permissionMode.plan.description": "Έρευνα μόνο για ανάγνωση· μόνο το αρχείο σχεδίου μπορεί να τροποποιηθεί",
  "prompt.permissionMode.bypassPermissions": "Παράκαμψη δικαιωμάτων",
  "prompt.permissionMode.bypassPermissions.description":
    "Εκτελείται χωρίς ερώτηση, εκτός από προστατευμένες διαδρομές, κρίσιμες διαγραφές και τους κανόνες ερώτησής σας",
  "prompt.permissionMode.dontAsk": "Χωρίς ερώτηση",
  "prompt.permissionMode.dontAsk.description": "Ό,τι θα απαιτούσε ερώτηση απορρίπτεται",
  ...
  "prompt.slash.badge.builtin": "ενσωματωμένη",
  "prompt.slash.hint.arguments": "[ορίσματα]",
  "prompt.slash.hint.positional": "<όρισμα{{n}}>",
  "prompt.slash.unknown.title": "Άγνωστη εντολή: /{{name}}",
  "prompt.slash.unknown.description": "Ξεκινήστε το μήνυμα με κενό για να σταλεί ως κείμενο.",
  "prompt.slash.unavailable.title": "Η /{{name}} δεν είναι διαθέσιμη εδώ",
  "prompt.slash.noArguments.title": "Η /{{name}} δεν δέχεται ορίσματα",
  ...
  "dialog.bypassPermissions.title": "Παράκαμψη δικαιωμάτων;",
  "dialog.bypassPermissions.body":
    "Ο πράκτορας θα εκτελεί εντολές, θα επεξεργάζεται αρχεία και θα έχει πρόσβαση στον ιστό χωρίς να ρωτά. Για προστατευμένες διαδρομές (.git, ρυθμίσεις πράκτορα, αρχεία εκκίνησης κελύφους), κρίσιμες διαγραφές και τους δικούς σας κανόνες ερώτησης θα εξακολουθεί να ρωτά· οι κανόνες απόρριψης εξακολουθούν να ισχύουν. Χρησιμοποιήστε το μόνο σε έργο που εμπιστεύεστε.",
  "dialog.bypassPermissions.confirm": "Παράκαμψη δικαιωμάτων",
  "dialog.bypassPermissions.cancel": "Ακύρωση",
  "ui.permission.always.project": "Να επιτρέπεται πάντα σε αυτό το έργο",
  "ui.permission.always.session": "Να επιτρέπεται για αυτήν τη συνεδρία",
  "ui.permission.always.acceptEdits": "Να επιτρέπονται όλες οι επεξεργασίες (Αποδοχή επεξεργασιών)",
  "ui.permission.always.everything": "όλα για αυτό το εργαλείο",
  "ui.permission.guard.floor.title": "Προστατευμένη ενέργεια",
  "ui.permission.guard.guard.title": "Απαιτεί έλεγχο",
  "ui.permission.guard.noAlways": "Αυτό μπορεί να εγκριθεί μόνο μία φορά",
  "ui.permission.writes": "Γράφει σε",
  "ui.question.planFeedback.placeholder": "Πείτε στον πράκτορα τι να αλλάξει στο σχέδιο",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή AgentCode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.step.opencode": "AgentCode",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος AgentCode σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση AgentCode σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση AgentCode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του AgentCode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο AgentCode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "AgentCode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Η αυτόματη αποδοχή είναι πλέον «Αποδοχή επεξεργασιών»",
  "toast.permissions.modeMigrated.description":
    "Οι επεξεργασίες σε αυτόν τον φάκελο εγκρίνονται αυτόματα· για τις εντολές εξακολουθεί να ρωτά. Επιλέξτε «Παράκαμψη δικαιωμάτων» στον συνθέτη για πλήρη αυτονομία.",
  "toast.permissions.autoAcceptRemoved.title": "Η αυτόματη αποδοχή απενεργοποιήθηκε",
  "toast.permissions.autoAcceptRemoved.modes":
    "Τα αιτήματα άδειας εμφανίζονται ξανά. Για αυτόματη έγκριση επεξεργασιών, επιλέξτε «Αποδοχή επεξεργασιών» στο μενού λειτουργιών δίπλα στην προτροπή ή πατήστε Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Τα αιτήματα άδειας εμφανίζονται ξανά. Για να τα παραλείψετε, επιτρέψτε αυτά τα εργαλεία στη διαμόρφωση δικαιωμάτων αυτού του διακομιστή.",
  "toast.permissions.mode.error.title": "Δεν ήταν δυνατή η αλλαγή της λειτουργίας δικαιωμάτων",
  ...
  "toast.model.selected.title": "Μοντέλο: {{name}}",
  "toast.model.selected.others": "Άλλες αντιστοιχίες: {{count}}. Εκτελέστε /model για να επιλέξετε.",
  "toast.model.noMatch.title": "Κανένα μοντέλο δεν ταιριάζει με «{{query}}»",
  "toast.agent.noMatch.title": "Κανένας πράκτορας με όνομα «{{query}}»",
  ...
  "toast.update.description": "Μια νέα έκδοση του AgentCode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα AgentCode",
  "error.page.report.discord": "στο GitHub",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το AgentCode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "AgentCode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή AgentCode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το AgentCode",
  "settings.general.permissionMode.title": "Προεπιλεγμένη λειτουργία δικαιωμάτων",
  "settings.general.permissionMode.description": "Χρησιμοποιείται για νέες συνεδρίες σε αυτόν τον φάκελο",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του AgentCode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το AgentCode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το AgentCode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του AgentCode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του AgentCode.",
  ...
  "dialog.workspaceTrust.title": "Trust this folder?",
  "dialog.workspaceTrust.body":
    "AgentCode can read, edit and run code here. Trusting lets this folder's own configuration run on your machine:",
  "dialog.workspaceTrust.nothingHeld": "This folder's configuration supplies nothing that waits for trust.",
  "dialog.workspaceTrust.group.code": "Plugins and custom tools",
  "dialog.workspaceTrust.group.mcp": "MCP servers",
  "dialog.workspaceTrust.group.permission": "Allow rules",
  "dialog.workspaceTrust.group.command": "Shell commands",
  "dialog.workspaceTrust.group.setting": "Other settings",
  "dialog.workspaceTrust.warning": "Only trust folders from people you trust.",
  "dialog.workspaceTrust.trust": "Trust folder",
  "dialog.workspaceTrust.trustSession": "Trust for this session",
  "dialog.workspaceTrust.restricted": "Restricted mode",
  "dialog.workspaceTrust.failed": "Could not save the trust decision",
  "banner.restrictedMode.title": "Restricted mode",
  "banner.restrictedMode.body": "This folder's plugins, MCP servers and allow rules are off.",
  "banner.restrictedMode.action": "Trust folder",
  "settings.trust.title": "Workspace trust",
  "settings.trust.current": "This folder",
  "settings.trust.noFolder": "Open a folder to see its trust state.",
  "settings.trust.unsupported": "This server does not support workspace trust.",
  "settings.trust.status.trusted": "Trusted",
  "settings.trust.status.untrusted": "Restricted",
  "settings.trust.status.unknown": "Not decided",
  "settings.trust.sessionOnly": "Trusted for this session only",
  "settings.trust.reloadWarning": "Changing trust reloads this project; running sessions stop.",
  "settings.trust.action.trust": "Trust",
  "settings.trust.action.restrict": "Restrict",
  "settings.trust.action.forget": "Forget",
  "settings.trust.action.resetMcp": "Reset MCP choices",
  "settings.trust.resetMcp.description": "Project MCP servers ask for approval again.",
  "settings.trust.list.title": "Trust decisions",
  "settings.trust.list.empty": "No trust decisions yet.",
  "mcp.status.pendingApproval": "pending approval",
  "mcp.status.changedSinceApproval": "changed since approval",
  "mcp.status.rejected": "rejected",
  "dialog.mcp.approve.title": "Approve MCP server?",
  "dialog.mcp.approve.body": "This server comes from the folder's configuration and runs:",
  "dialog.mcp.approve.approve": "Approve",
  "dialog.mcp.approve.reject": "Reject",
}
