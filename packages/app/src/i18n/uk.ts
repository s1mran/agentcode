export const dict = {
  ...
  "desktop.menu.ariaLabel": "Меню AgentCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити AgentCode",
  "desktop.recovery.terminated": "Роботу вікна AgentCode несподівано завершено",
  "desktop.recovery.unresponsive": "AgentCode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення AgentCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "command.model.choose.hint": "[модель]",
  ...
  "command.session.compact.hint": "[на чому зосередитися]",
  ...
  "command.session.export.hint": "[ім'я файлу]",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у AgentCode.",
  ...
  "prompt.slash.badge.builtin": "вбудована",
  "prompt.slash.hint.arguments": "[аргументи]",
  "prompt.slash.hint.positional": "<арг{{n}}>",
  "prompt.slash.unknown.title": "Невідома команда: /{{name}}",
  "prompt.slash.unknown.description": "Почніть повідомлення з пробілу, щоб надіслати його як текст.",
  "prompt.slash.unavailable.title": "/{{name}} тут недоступна",
  "prompt.slash.noArguments.title": "/{{name}} не приймає аргументів",
  ...
  "dialog.server.description": "Перемкніть сервер AgentCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка AgentCode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення AgentCode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть AgentCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть AgentCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в AgentCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AgentCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.title": "Модель: {{name}}",
  "toast.model.selected.others": "Інші збіги: {{count}}. Виконайте /model, щоб вибрати.",
  "toast.model.noMatch.title": "Немає моделі, що відповідає «{{query}}»",
  "toast.agent.noMatch.title": "Немає агента з назвою «{{query}}»",
  ...
  "toast.update.description": "Нова версія AgentCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді AgentCode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, AgentCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер AgentCode всередині WSL на Windows.",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд AgentCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи AgentCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему AgentCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску AgentCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію AgentCode.",
