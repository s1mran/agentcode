export const dict = {
  ...
  "desktop.menu.ariaLabel": "Nabídka AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode se nepodařilo načíst",
  "desktop.recovery.terminated": "AgentCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "AgentCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "command.permissionMode.cycle": "Přepnout režim oprávnění",
  "command.permissionMode.set": "Režim oprávnění: {{mode}}",
  "command.permissionMode.bypass": "Obejít oprávnění…",
  "command.plan": "Režim plánování",
  ...
  "command.session.compact.hint": "[pokyny k zaměření]",
  ...
  "command.session.export.hint": "[název souboru]",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v AgentCode.",
  ...
  "prompt.permissionMode.label": "Režim oprávnění",
  "prompt.permissionMode.default": "Ptát se na oprávnění",
  "prompt.permissionMode.default.description": "Ptá se před příkazy, úpravami a přístupem na web",
  "prompt.permissionMode.acceptEdits": "Přijímat úpravy",
  "prompt.permissionMode.acceptEdits.description": "Úpravy v tomto projektu jsou schvalovány; u příkazů se stále ptá",
  "prompt.permissionMode.plan": "Režim plánování",
  "prompt.permissionMode.plan.description": "Průzkum jen pro čtení; upravovat lze pouze soubor plánu",
  "prompt.permissionMode.bypassPermissions": "Obejít oprávnění",
  "prompt.permissionMode.bypassPermissions.description":
    "Běží bez ptaní, kromě chráněných cest, kritických mazání a vašich pravidel pro dotaz",
  "prompt.permissionMode.dontAsk": "Neptat se",
  "prompt.permissionMode.dontAsk.description": "Vše, co by vyžadovalo dotaz, je odmítnuto",
  ...
  "prompt.slash.badge.builtin": "vestavěný",
  "prompt.slash.hint.arguments": "[argumenty]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Neznámý příkaz: /{{name}}",
  "prompt.slash.unknown.description": "Chcete-li zprávu odeslat jako text, začněte ji mezerou.",
  "prompt.slash.unavailable.title": "/{{name}} zde není k dispozici",
  "prompt.slash.noArguments.title": "/{{name}} nepřijímá argumenty",
  ...
  "dialog.bypassPermissions.title": "Obejít oprávnění?",
  "dialog.bypassPermissions.body":
    "Agent bude spouštět příkazy, upravovat soubory a přistupovat na web bez ptaní. U chráněných cest (.git, konfigurace agenta, spouštěcí soubory shellu), kritických mazání a vašich vlastních pravidel pro dotaz se bude stále ptát; pravidla pro odmítnutí stále platí. Používejte to jen v projektu, kterému důvěřujete.",
  "dialog.bypassPermissions.confirm": "Obejít oprávnění",
  "dialog.bypassPermissions.cancel": "Zrušit",
  "ui.permission.always.project": "V tomto projektu vždy povolit",
  "ui.permission.always.session": "Povolit pro tuto relaci",
  "ui.permission.always.acceptEdits": "Povolit všechny úpravy (Přijímat úpravy)",
  "ui.permission.always.everything": "vše pro tento nástroj",
  "ui.permission.guard.floor.title": "Chráněná akce",
  "ui.permission.guard.guard.title": "Vyžaduje kontrolu",
  "ui.permission.guard.noAlways": "Toto lze schválit pouze jednou",
  "ui.permission.writes": "Zapisuje do",
  "ui.question.planFeedback.placeholder": "Řekněte agentovi, co v plánu změnit",
  ...
  "dialog.server.description": "Přepněte, ke kterému AgentCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola AgentCode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace AgentCode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace AgentCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte AgentCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než AgentCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automatické přijímání je nyní „Přijímat úpravy“",
  "toast.permissions.modeMigrated.description":
    "Úpravy v této složce se schvalují automaticky; u příkazů se stále ptá. Pro plnou autonomii zvolte v poli pro zadání „Obejít oprávnění“.",
  "toast.permissions.autoAcceptRemoved.title": "Automatické přijímání bylo vypnuto",
  "toast.permissions.autoAcceptRemoved.modes":
    "Žádosti o oprávnění se opět zobrazují. Chcete-li úpravy schvalovat automaticky, zvolte „Přijímat úpravy“ v nabídce režimů vedle promptu nebo stiskněte Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Žádosti o oprávnění se opět zobrazují. Chcete-li je přeskočit, povolte tyto nástroje v konfiguraci oprávnění tohoto serveru.",
  "toast.permissions.mode.error.title": "Režim oprávnění se nepodařilo změnit",
  ...
  "toast.model.selected.others": "Další shody: {{count}}. Spusťte /model a vyberte jeden.",
  "toast.model.noMatch.title": "Žádný model neodpovídá „{{query}}“",
  "toast.agent.noMatch.title": "Žádný agent s názvem „{{query}}“",
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze AgentCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu AgentCode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: AgentCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server AgentCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro AgentCode",
  "settings.general.permissionMode.title": "Výchozí režim oprávnění",
  "settings.general.permissionMode.description": "Používá se pro nové relace v této složce",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled AgentCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude AgentCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma AgentCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění AgentCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi AgentCode.",
