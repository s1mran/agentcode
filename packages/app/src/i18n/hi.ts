export const dict = {
  ...
  "desktop.menu.documentation": "दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "AgentCode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "AgentCode लोड नहीं हो सका",
  "desktop.recovery.terminated": "AgentCode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "AgentCode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में AgentCode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "AgentCode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "command.model.choose.hint": "[मॉडल]",
  ...
  "command.agent.cycle.hint": "[एजेंट]",
  ...
  "command.permissionMode.cycle": "अनुमति मोड बदलें",
  "command.permissionMode.set": "अनुमति मोड: {{mode}}",
  "command.permissionMode.bypass": "अनुमतियाँ बायपास करें…",
  "command.plan": "प्लान मोड",
  ...
  "command.session.compact.hint": "[फ़ोकस निर्देश]",
  ...
  "command.session.export.hint": "[फ़ाइल नाम]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और AgentCode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और AgentCode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा AgentCode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "prompt.permissionMode.default": "अनुमति पूछें",
  "prompt.permissionMode.default.description": "कमांड, संपादन और वेब एक्सेस से पहले पूछता है",
  "prompt.permissionMode.acceptEdits": "संपादन स्वीकार करें",
  "prompt.permissionMode.acceptEdits.description":
    "इस प्रोजेक्ट में संपादन स्वीकृत होते हैं; कमांड के लिए अब भी पूछता है",
  "prompt.permissionMode.plan": "प्लान मोड",
  "prompt.permissionMode.plan.description": "केवल-पढ़ने वाली रिसर्च; केवल प्लान फ़ाइल संपादित की जा सकती है",
  "prompt.permissionMode.bypassPermissions": "अनुमतियाँ बायपास करें",
  "prompt.permissionMode.bypassPermissions.description":
    "बिना पूछे चलता है, सिवाय सुरक्षित पाथ, महत्वपूर्ण डिलीट और आपके पूछने वाले नियमों के",
  "prompt.permissionMode.dontAsk": "न पूछें",
  "prompt.permissionMode.dontAsk.description": "जिस भी चीज़ पर पूछा जाता, उसे अस्वीकार किया जाता है",
  ...
  "prompt.slash.hint.arguments": "[आर्गुमेंट]",
  "prompt.slash.hint.positional": "<आर्ग{{n}}>",
  "prompt.slash.unknown.title": "अज्ञात कमांड: /{{name}}",
  "prompt.slash.unknown.description": "इसे टेक्स्ट के रूप में भेजने के लिए संदेश को स्पेस से शुरू करें।",
  "prompt.slash.unavailable.title": "/{{name}} यहां उपलब्ध नहीं है",
  "prompt.slash.noArguments.title": "/{{name}} आर्गुमेंट नहीं लेता",
  ...
  "dialog.bypassPermissions.title": "अनुमतियाँ बायपास करें?",
  "dialog.bypassPermissions.body":
    "एजेंट बिना पूछे कमांड चलाएगा, फ़ाइलें संपादित करेगा और वेब एक्सेस करेगा। सुरक्षित पाथ (.git, एजेंट कॉन्फ़िगरेशन, शेल स्टार्टअप फ़ाइलें), महत्वपूर्ण डिलीट और आपके अपने पूछने वाले नियमों पर अब भी पूछा जाएगा; अस्वीकार नियम भी लागू रहते हैं। इसका उपयोग केवल उसी प्रोजेक्ट में करें जिस पर आप भरोसा करते हैं।",
  "dialog.bypassPermissions.confirm": "अनुमतियाँ बायपास करें",
  "dialog.bypassPermissions.cancel": "रद्द करें",
  "ui.permission.always.project": "इस प्रोजेक्ट में हमेशा अनुमति दें",
  "ui.permission.always.session": "इस सेशन के लिए अनुमति दें",
  "ui.permission.always.acceptEdits": "सभी संपादनों की अनुमति दें (संपादन स्वीकार करें)",
  "ui.permission.always.everything": "इस टूल के लिए सब कुछ",
  "ui.permission.guard.floor.title": "सुरक्षित कार्रवाई",
  "ui.permission.guard.guard.title": "समीक्षा आवश्यक",
  "ui.permission.guard.noAlways": "इसे केवल एक बार स्वीकृत किया जा सकता है",
  "ui.permission.writes": "इनमें लिखता है",
  "ui.question.planFeedback.placeholder": "एजेंट को बताएँ कि प्लान में क्या बदलना है",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस AgentCode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में AgentCode की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "AgentCode अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में AgentCode अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में AgentCode को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "AgentCode को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "AgentCode तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में AgentCode स्थापित करें।",
  "wsl.onboarding.installOpencode": "AgentCode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "AgentCode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर AgentCode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "AgentCode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "स्वतः स्वीकार अब “संपादन स्वीकार करें” है",
  "toast.permissions.modeMigrated.description":
    "इस फ़ोल्डर में संपादन स्वचालित रूप से स्वीकृत होते हैं; कमांड के लिए अब भी पूछा जाता है। पूर्ण स्वायत्तता के लिए कंपोज़र में “अनुमतियाँ बायपास करें” चुनें।",
  "toast.permissions.autoAcceptRemoved.title": "स्वतः स्वीकार बंद कर दिया गया",
  "toast.permissions.autoAcceptRemoved.modes":
    "अनुमति अनुरोध फिर से दिखाए जाएंगे। संपादनों को स्वचालित रूप से स्वीकृत करने के लिए, प्रॉम्प्ट के पास मोड मेनू में “संपादन स्वीकार करें” चुनें या Shift+Tab दबाएँ।",
  "toast.permissions.autoAcceptRemoved.rules":
    "अनुमति अनुरोध फिर से दिखाए जाएंगे। इन्हें छोड़ने के लिए, इस सर्वर के अनुमति कॉन्फ़िगरेशन में उन टूल को अनुमति दें।",
  "toast.permissions.mode.error.title": "अनुमति मोड नहीं बदला जा सका",
  ...
  "toast.model.selected.title": "मॉडल: {{name}}",
  "toast.model.selected.others": "अन्य मिलान: {{count}}। एक चुनने के लिए /model चलाएं।",
  "toast.model.noMatch.title": "“{{query}}” से मेल खाता कोई मॉडल नहीं",
  "toast.agent.noMatch.title": "“{{query}}” नाम का कोई एजेंट नहीं",
  ...
  "toast.update.description": "AgentCode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट AgentCode टीम को करें",
  "error.page.report.discord": "GitHub पर",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, AgentCode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "AgentCode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर AgentCode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "AgentCode के लिए प्रदर्शन भाषा बदलें",
  "settings.general.permissionMode.title": "डिफ़ॉल्ट अनुमति मोड",
  "settings.general.permissionMode.description": "इस फ़ोल्डर में नए सेशन के लिए उपयोग किया जाता है",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि AgentCode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि AgentCode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि AgentCode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "AgentCode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप AgentCode का नवीनतम संस्करण चला रहे हैं।",
