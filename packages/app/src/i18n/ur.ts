export const dict = {
  ...
  "desktop.menu.documentation": "دستاویزات",
  ...
  "desktop.menu.ariaLabel": "AgentCode مینو",
  ...
  "desktop.recovery.loadFailed": "AgentCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "AgentCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "AgentCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں AgentCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "AgentCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "command.model.choose.hint": "[ماڈل]",
  ...
  "command.agent.cycle.hint": "[ایجنٹ]",
  ...
  "command.permissionMode.cycle": "اجازت کا موڈ تبدیل کریں",
  "command.permissionMode.set": "اجازت کا موڈ: {{mode}}",
  "command.permissionMode.bypass": "اجازتیں بائی پاس کریں…",
  "command.plan": "پلان موڈ",
  ...
  "command.session.compact.hint": "[توجہ کی ہدایات]",
  ...
  "command.session.export.hint": "[فائل کا نام]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور AgentCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور AgentCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور AgentCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "prompt.permissionMode.label": "اجازت کا موڈ",
  "prompt.permissionMode.default": "اجازت طلب کریں",
  "prompt.permissionMode.default.description": "کمانڈز، ترامیم اور ویب رسائی سے پہلے پوچھتا ہے",
  "prompt.permissionMode.acceptEdits": "ترامیم قبول کریں",
  "prompt.permissionMode.acceptEdits.description": "اس پروجیکٹ میں ترامیم منظور ہیں؛ کمانڈز کے لیے اب بھی پوچھتا ہے",
  "prompt.permissionMode.plan": "پلان موڈ",
  "prompt.permissionMode.plan.description": "صرف پڑھنے والی تحقیق؛ صرف پلان فائل میں ترمیم کی جا سکتی ہے",
  "prompt.permissionMode.bypassPermissions": "اجازتیں بائی پاس کریں",
  "prompt.permissionMode.bypassPermissions.description":
    "محفوظ پاتھس، اہم حذف کاریوں اور آپ کے پوچھنے والے اصولوں کے علاوہ بغیر پوچھے چلتا ہے",
  "prompt.permissionMode.dontAsk": "نہ پوچھیں",
  "prompt.permissionMode.dontAsk.description": "جس چیز کے لیے پوچھنا پڑتا، وہ مسترد کر دی جاتی ہے",
  ...
  "prompt.slash.badge.builtin": "بلٹ اِن",
  "prompt.slash.hint.arguments": "[آرگیومنٹس]",
  "prompt.slash.hint.positional": "<آرگ{{n}}>",
  "prompt.slash.unknown.title": "نامعلوم کمانڈ: /{{name}}",
  "prompt.slash.unknown.description": "اسے متن کے طور پر بھیجنے کے لیے پیغام کو خالی جگہ سے شروع کریں۔",
  "prompt.slash.unavailable.title": "/{{name}} یہاں دستیاب نہیں ہے",
  "prompt.slash.noArguments.title": "/{{name}} آرگیومنٹس نہیں لیتی",
  ...
  "dialog.bypassPermissions.title": "اجازتیں بائی پاس کریں؟",
  "dialog.bypassPermissions.body":
    "ایجنٹ بغیر پوچھے کمانڈز چلائے گا، فائلوں میں ترمیم کرے گا اور ویب تک رسائی حاصل کرے گا۔ محفوظ پاتھس (.git، ایجنٹ کنفیگ، شیل اسٹارٹ اپ فائلیں)، اہم حذف کاریوں اور آپ کے اپنے پوچھنے والے اصولوں کے لیے اب بھی پوچھا جائے گا؛ انکار کے اصول بدستور لاگو رہیں گے۔ اسے صرف اسی پروجیکٹ میں استعمال کریں جس پر آپ کو بھروسہ ہو۔",
  "dialog.bypassPermissions.confirm": "اجازتیں بائی پاس کریں",
  "dialog.bypassPermissions.cancel": "منسوخ کریں",
  "ui.permission.always.project": "اس پروجیکٹ میں ہمیشہ اجازت دیں",
  "ui.permission.always.session": "اس سیشن کے لیے اجازت دیں",
  "ui.permission.always.acceptEdits": "تمام ترامیم کی اجازت دیں (ترامیم قبول کریں)",
  "ui.permission.always.everything": "اس ٹول کے لیے سب کچھ",
  "ui.permission.guard.floor.title": "محفوظ کارروائی",
  "ui.permission.guard.guard.title": "جائزہ درکار ہے",
  "ui.permission.guard.noAlways": "اسے صرف ایک بار منظور کیا جا سکتا ہے",
  "ui.permission.writes": "یہاں لکھتا ہے",
  "ui.question.planFeedback.placeholder": "ایجنٹ کو بتائیں کہ پلان میں کیا تبدیل کرنا ہے",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس AgentCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں AgentCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "AgentCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں AgentCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں AgentCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "AgentCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "AgentCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں AgentCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "AgentCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ AgentCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "AgentCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر AgentCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "AgentCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "خودکار قبولیت اب ترامیم قبول کریں ہے",
  "toast.permissions.modeMigrated.description":
    "اس فولڈر میں ترامیم خودکار طور پر منظور ہوتی ہیں؛ کمانڈز کے لیے اب بھی پوچھتا ہے۔ مکمل خود مختاری کے لیے کمپوزر میں اجازتیں بائی پاس کریں منتخب کریں۔",
  "toast.permissions.autoAcceptRemoved.title": "خودکار قبولیت بند کر دی گئی",
  "toast.permissions.autoAcceptRemoved.modes":
    "اجازت کی درخواستیں دوبارہ پوچھی جا رہی ہیں۔ ترامیم کو خودکار طور پر منظور کرنے کے لیے، پرامپٹ کے ساتھ موجود موڈ مینو میں ترامیم قبول کریں منتخب کریں یا Shift+Tab دبائیں۔",
  "toast.permissions.autoAcceptRemoved.rules":
    "اجازت کی درخواستیں دوبارہ پوچھی جا رہی ہیں۔ انہیں چھوڑنے کے لیے، اس سرور کی اجازت کنفیگ میں ان ٹولز کی اجازت دیں۔",
  "toast.permissions.mode.error.title": "اجازت کا موڈ تبدیل نہیں ہو سکا",
  ...
  "toast.model.selected.title": "ماڈل: {{name}}",
  "toast.model.selected.others": "دیگر مماثلتیں: {{count}}۔ ایک منتخب کرنے کے لیے /model چلائیں۔",
  "toast.model.noMatch.title": "«{{query}}» سے مماثل کوئی ماڈل نہیں",
  "toast.agent.noMatch.title": "«{{query}}» نام کا کوئی ایجنٹ نہیں",
  ...
  "toast.update.description": "AgentCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم AgentCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  "error.page.report.discord": "GitHub پر",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AgentCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "AgentCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "AgentCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر AgentCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "AgentCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  "settings.general.permissionMode.title": "طے شدہ اجازت کا موڈ",
  "settings.general.permissionMode.description": "اس فولڈر میں نئے سیشنز کے لیے استعمال ہوتا ہے",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر AgentCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا AgentCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AgentCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "AgentCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ AgentCode کا تازہ ترین ورژن چلا رہے ہیں۔",
