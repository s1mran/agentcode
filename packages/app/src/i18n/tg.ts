export const dict = {
  ...
  "desktop.menu.documentation": "Ҳуҷҷатҳо",
  ...
  "desktop.menu.ariaLabel": "AgentCode меню",
  ...
  "desktop.recovery.loadFailed": "AgentCode бор карда натавонист",
  "desktop.recovery.terminated": "AgentCode тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "AgentCode ҷавоб намедиҳад",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode насб карда нашуд",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode дар {{distro}} насб нашудааст",
  "desktop.wsl.error.updateVersion":
    "AgentCode навсозӣ анҷом ёфт, аммо {{distro}} то ҳол гузориш медиҳад {{installed}}; интизорӣ {{expected}}",
  ...
  "command.model.choose.hint": "[модел]",
  ...
  "command.agent.cycle.hint": "[агент]",
  ...
  "command.permissionMode.cycle": "Иваз кардани реҷаи иҷозатҳо",
  "command.permissionMode.set": "Реҷаи иҷозатҳо: {{mode}}",
  "command.permissionMode.bypass": "Нодида гирифтани иҷозатҳо…",
  "command.plan": "Реҷаи банақшагирӣ",
  ...
  "command.session.compact.hint": "[дастурҳои диққат]",
  ...
  "command.session.export.hint": "[номи файл]",
  ...
  "dialog.model.unpaid.freeModels.title": "Моделҳои ройгон аз ҷониби AgentCode пешниҳодшуда",
  ...
  "provider.connect.apiKey.description":
    "Барои пайваст кардани ҳисоби худ калиди {{provider}} API-ро ворид кунед ва моделҳои {{provider}}-ро дар AgentCode истифода баред.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "Барои ҷамъ овардани рамзи иҷозати шумо барои пайваст кардани ҳисоби шумо ва истифода бурдани моделҳои {{provider}} дар AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ва рамзи зерро ворид кунед, то ҳисоби худро пайваст кунед ва моделҳои {{provider}}-ро дар AgentCode истифода баред.",
  ...
  "prompt.permissionMode.label": "Реҷаи иҷозатҳо",
  "prompt.permissionMode.default": "Пурсидани иҷозат",
  "prompt.permissionMode.default.description": "Пеш аз фармонҳо, таҳрирҳо ва дастрасӣ ба веб мепурсад",
  "prompt.permissionMode.acceptEdits": "Қабули таҳрирҳо",
  "prompt.permissionMode.acceptEdits.description":
    "Таҳрирҳо дар ин лоиҳа тасдиқ мешаванд; барои фармонҳо ҳанӯз мепурсад",
  "prompt.permissionMode.plan": "Реҷаи банақшагирӣ",
  "prompt.permissionMode.plan.description": "Омӯзиш танҳо барои хондан; танҳо файли нақшаро таҳрир кардан мумкин аст",
  "prompt.permissionMode.bypassPermissions": "Нодида гирифтани иҷозатҳо",
  "prompt.permissionMode.bypassPermissions.description":
    "Бе пурсиш кор мекунад, ба истиснои роҳҳои ҳифзшуда, несткуниҳои муҳим ва қоидаҳои пурсиши шумо",
  "prompt.permissionMode.dontAsk": "Напурсед",
  "prompt.permissionMode.dontAsk.description": "Ҳар чизе, ки пурсишро талаб мекард, рад карда мешавад",
  ...
  "prompt.slash.badge.builtin": "дарунсохт",
  "prompt.slash.hint.arguments": "[аргументҳо]",
  "prompt.slash.hint.positional": "<арг{{n}}>",
  "prompt.slash.unknown.title": "Фармони номаълум: /{{name}}",
  "prompt.slash.unknown.description": "Барои фиристан ҳамчун матн, паёмро бо фосила оғоз кунед.",
  "prompt.slash.unavailable.title": "/{{name}} дар ин ҷо дастрас нест",
  "prompt.slash.noArguments.title": "/{{name}} аргумент қабул намекунад",
  ...
  "dialog.bypassPermissions.title": "Иҷозатҳо нодида гирифта шаванд?",
  "dialog.bypassPermissions.body":
    "Агент бе пурсиш фармонҳоро иҷро мекунад, файлҳоро таҳрир мекунад ва ба веб дастрасӣ пайдо мекунад. Барои роҳҳои ҳифзшуда (.git, конфигуратсияи агент, файлҳои оғозии shell), несткуниҳои муҳим ва қоидаҳои пурсиши худи шумо ҳанӯз мепурсад; қоидаҳои манъ ҳанӯз амал мекунанд. Инро танҳо дар лоиҳае истифода баред, ки ба он эътимод доред.",
  "dialog.bypassPermissions.confirm": "Нодида гирифтани иҷозатҳо",
  "dialog.bypassPermissions.cancel": "Бекор кардан",
  "ui.permission.always.project": "Дар ин лоиҳа ҳамеша иҷозат диҳед",
  "ui.permission.always.session": "Барои ин иҷлосия иҷозат диҳед",
  "ui.permission.always.acceptEdits": "Ба ҳамаи таҳрирҳо иҷозат диҳед (Қабули таҳрирҳо)",
  "ui.permission.always.everything": "ҳама чиз барои ин асбоб",
  "ui.permission.guard.floor.title": "Амали ҳифзшуда",
  "ui.permission.guard.guard.title": "Баррасӣ лозим аст",
  "ui.permission.guard.noAlways": "Инро танҳо як бор тасдиқ кардан мумкин аст",
  "ui.permission.writes": "Навиштан ба",
  "ui.question.planFeedback.placeholder": "Ба агент бигӯед, ки дар нақша чиро тағйир диҳад",
  ...
  "dialog.server.description": "Гузариш кунед, ки ин барнома ба кадом сервери AgentCode пайваст мешавад.",
  ...
  "wsl.onboarding.checkingOpencode": "Санҷиш AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Санҷиш AgentCode дар {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Навсозӣ AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Навсозии AgentCode дар {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Навсозии AgentCode дар {{distro}}.",
  "wsl.onboarding.updateOpencode": "Навсозӣ AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode дар {{distro}} тайёр аст.",
  "wsl.onboarding.opencodeReady": "AgentCode тайёр аст.",
  "wsl.onboarding.installOpencodeIn": "AgentCode дар {{distro}} насб кунед.",
  "wsl.onboarding.installOpencode": "Насб кунед AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode насб нашудааст",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) лозим аст, то AgentCode сервери WSL илова карда шавад",
  "wsl.onboarding.wslUnavailable.title": "WSL дастрас нест",
  "wsl.onboarding.wslUnavailable.description": "AgentCode WSL-ро дар ин мошин тафтиш карда натавонист.",
  "wsl.onboarding.installWsl": "Насб кунед WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Барои анҷом додани насби WSL Windows-ро аз нав оғоз кунед, сипас AgentCode-ро боз кунед.",
  ...
  "help.tabs.introduction": "AgentCode Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Қабули худкор акнун Қабули таҳрирҳо аст",
  "toast.permissions.modeMigrated.description":
    "Таҳрирҳо дар ин папка худкор тасдиқ мешаванд; барои фармонҳо ҳанӯз мепурсад. Барои мустақилияти пурра дар майдони воридкунӣ Нодида гирифтани иҷозатҳоро интихоб кунед.",
  "toast.permissions.autoAcceptRemoved.title": "Қабули худкор хомӯш карда шуд",
  "toast.permissions.autoAcceptRemoved.modes":
    "Дархостҳои иҷозат боз пайдо мешаванд. Барои худкор тасдиқ кардани таҳрирҳо, дар менюи реҷа дар назди майдони дархост Қабули таҳрирҳоро интихоб кунед ё Shift+Tab-ро пахш кунед.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Дархостҳои иҷозат боз пайдо мешаванд. Барои гузаронидани онҳо, ба он асбобҳо дар конфигуратсияи иҷозатҳои ин сервер иҷозат диҳед.",
  "toast.permissions.mode.error.title": "Реҷаи иҷозатҳоро иваз кардан ғайриимкон шуд",
  ...
  "toast.model.selected.title": "Модел: {{name}}",
  "toast.model.selected.others": "Мувофиқатҳои дигар: {{count}}. Барои интихоб /model-ро иҷро кунед.",
  "toast.model.noMatch.title": "Ягон модел ба «{{query}}» мувофиқ нест",
  "toast.agent.noMatch.title": "Агент бо номи «{{query}}» нест",
  ...
  "toast.update.description": "Версияи нави AgentCode ({{version}}) ҳоло барои насб дастрас аст.",
  ...
  "error.page.report.prefix": "Лутфан дар бораи ин хато ба дастаи AgentCode хабар диҳед",
  "error.page.report.discord": "дар GitHub",
  ...
  "error.chain.mcpFailed":
    'MCP сервери "{{name}}" ноком шуд. Дар хотир доред, ки AgentCode тасдиқи MCP-ро ҳанӯз дастгирӣ намекунад.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode моделҳои ройгонро дар бар мегирад, то шумо метавонед фавран оғоз кунед.",
  ...
  "settings.desktop.wsl.description": "Сервери AgentCode-ро дар WSL дар Windows иҷро кунед.",
  ...
  "settings.general.row.language.description": "Забони намоишро барои AgentCode иваз кунед",
  "settings.general.permissionMode.title": "Реҷаи пешфарзи иҷозатҳо",
  "settings.general.permissionMode.description": "Барои иҷлосияҳои нав дар ин папка истифода мешавад",
  ...
  "settings.general.row.appearance.description":
    "Фармоиш диҳед, ки чӣ гуна AgentCode дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки AgentCode аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр AgentCode мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани AgentCode навсозиҳо ба таври худкор санҷед",
  ...
  "settings.updates.toast.latest.description": "Шумо версияи охирини AgentCode-ро иҷро карда истодаед.",
