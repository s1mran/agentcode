export const dict = {
  ...
  "desktop.menu.ariaLabel": "منوی AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode بارگیری نشد",
  "desktop.recovery.terminated": "پنجره AgentCode به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "AgentCode پاسخ نمی دهد",
  ...
  "desktop.wsl.error.installOpencode": "نصب AgentCode انجام نشد",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode در {{distro}} نصب نشده است",
  "desktop.wsl.error.updateVersion":
    "به‌روزرسانی AgentCode به پایان رسید، اما {{distro}} همچنان {{installed}} را گزارش می‌کند. مورد انتظار {{expected}}",
  ...
  "command.permissionMode.cycle": "تغییر حالت مجوز",
  "command.permissionMode.set": "حالت مجوز: {{mode}}",
  "command.permissionMode.bypass": "نادیده گرفتن مجوزها…",
  "command.plan": "حالت برنامه‌ریزی",
  ...
  "command.session.compact.hint": "[دستورالعمل‌های تمرکز]",
  ...
  "command.session.export.hint": "[نام فایل]",
  ...
  "dialog.model.unpaid.freeModels.title": "مدل های رایگان ارائه شده توسط AgentCode",
  ...
  "provider.connect.apiKey.description":
    "کلید API سرویس {{provider}} را وارد کنید تا حساب شما متصل شود و بتوانید از مدل‌های {{provider}} در AgentCode استفاده کنید.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " برای جمع آوری کد مجوز برای اتصال حساب خود و استفاده از مدل های {{provider}} در AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " و کد زیر را برای اتصال اکانت خود وارد کنید و از مدل های {{provider}} در AgentCode استفاده کنید.",
  ...
  "prompt.permissionMode.label": "حالت مجوز",
  "prompt.permissionMode.default": "درخواست مجوز",
  "prompt.permissionMode.default.description": "پیش از اجرای دستورات، ویرایش‌ها و دسترسی به وب می‌پرسد",
  "prompt.permissionMode.acceptEdits": "پذیرش ویرایش‌ها",
  "prompt.permissionMode.acceptEdits.description":
    "ویرایش‌ها در این پروژه تأیید می‌شوند؛ برای دستورات همچنان پرسیده می‌شود",
  "prompt.permissionMode.plan": "حالت برنامه‌ریزی",
  "prompt.permissionMode.plan.description": "بررسی فقط‌خواندنی؛ فقط فایل برنامه قابل ویرایش است",
  "prompt.permissionMode.bypassPermissions": "نادیده گرفتن مجوزها",
  "prompt.permissionMode.bypassPermissions.description":
    "بدون پرسش اجرا می‌شود، به‌جز مسیرهای محافظت‌شده، حذف‌های حساس و قواعد پرسش شما",
  "prompt.permissionMode.dontAsk": "نپرس",
  "prompt.permissionMode.dontAsk.description": "هر چیزی که نیاز به پرسش داشته باشد رد می‌شود",
  ...
  "prompt.slash.badge.builtin": "داخلی",
  "prompt.slash.hint.arguments": "[آرگومان‌ها]",
  "prompt.slash.hint.positional": "<آرگومان{{n}}>",
  "prompt.slash.unknown.title": "دستور ناشناخته: /{{name}}",
  "prompt.slash.unknown.description": "برای ارسال به‌صورت متن، پیام را با یک فاصله شروع کنید.",
  "prompt.slash.unavailable.title": "‏/{{name}} اینجا در دسترس نیست",
  "prompt.slash.noArguments.title": "‏/{{name}} آرگومان نمی‌پذیرد",
  ...
  "dialog.bypassPermissions.title": "مجوزها نادیده گرفته شوند؟",
  "dialog.bypassPermissions.body":
    "عامل بدون پرسش دستورات را اجرا می‌کند، فایل‌ها را ویرایش می‌کند و به وب دسترسی پیدا می‌کند. برای مسیرهای محافظت‌شده (.git، پیکربندی عامل، فایل‌های راه‌اندازی پوسته)، حذف‌های حساس و قواعد پرسش خودتان همچنان پرسیده می‌شود؛ قواعد رد نیز همچنان اعمال می‌شوند. فقط در پروژه‌ای که به آن اعتماد دارید از این حالت استفاده کنید.",
  "dialog.bypassPermissions.confirm": "نادیده گرفتن مجوزها",
  "dialog.bypassPermissions.cancel": "لغو کنید",
  "ui.permission.always.project": "همیشه در این پروژه اجازه بده",
  "ui.permission.always.session": "برای این جلسه اجازه بده",
  "ui.permission.always.acceptEdits": "اجازه به همه ویرایش‌ها (پذیرش ویرایش‌ها)",
  "ui.permission.always.everything": "همه‌چیز برای این ابزار",
  "ui.permission.guard.floor.title": "عمل محافظت‌شده",
  "ui.permission.guard.guard.title": "نیاز به بررسی",
  "ui.permission.guard.noAlways": "این فقط یک بار قابل تأیید است",
  "ui.permission.writes": "نوشتن در",
  "ui.question.planFeedback.placeholder": "به عامل بگویید چه چیزی در برنامه تغییر کند",
  ...
  "dialog.server.description": "این برنامه به کدام سرور AgentCode متصل است، تغییر دهید.",
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "بررسی AgentCode در {{distro}}...",
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی AgentCode در {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "AgentCode را در {{distro}} به روز کنید.",
  "wsl.onboarding.updateOpencode": "AgentCode را به روز کنید",
  "wsl.onboarding.opencodeReadyIn": "AgentCode در {{distro}} آماده است.",
  "wsl.onboarding.opencodeReady": "AgentCode آماده است.",
  "wsl.onboarding.installOpencodeIn": "AgentCode را در {{distro}} نصب کنید.",
  "wsl.onboarding.installOpencode": "AgentCode را نصب کنید",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode نصب نشده است",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه AgentCode بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "AgentCode نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس AgentCode را دوباره باز کنید.",
  ...
  "help.tabs.introduction": "AgentCode Desktop اکنون در اطراف زبانه ها ساخته شده است.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "پذیرش خودکار اکنون «پذیرش ویرایش‌ها» است",
  "toast.permissions.modeMigrated.description":
    "ویرایش‌ها در این پوشه به‌طور خودکار تأیید می‌شوند؛ برای دستورات همچنان پرسیده می‌شود. برای خودمختاری کامل، «نادیده گرفتن مجوزها» را در کادر نوشتن انتخاب کنید.",
  "toast.permissions.autoAcceptRemoved.title": "پذیرش خودکار خاموش شد",
  "toast.permissions.autoAcceptRemoved.modes":
    "درخواست‌های مجوز دوباره نمایش داده می‌شوند. برای تأیید خودکار ویرایش‌ها، «پذیرش ویرایش‌ها» را در منوی حالت کنار پرامپت انتخاب کنید یا Shift+Tab را فشار دهید.",
  "toast.permissions.autoAcceptRemoved.rules":
    "درخواست‌های مجوز دوباره نمایش داده می‌شوند. برای رد شدن از آن‌ها، آن ابزارها را در پیکربندی مجوز این سرور مجاز کنید.",
  "toast.permissions.mode.error.title": "تغییر حالت مجوز ممکن نشد",
  ...
  "toast.model.selected.title": "مدل: {{name}}",
  "toast.model.selected.others": "موارد منطبق دیگر: {{count}}. برای انتخاب، /model را اجرا کنید.",
  "toast.model.noMatch.title": "هیچ مدلی با «{{query}}» منطبق نیست",
  "toast.agent.noMatch.title": "هیچ عاملی با نام «{{query}}» وجود ندارد",
  ...
  "toast.update.description": "نسخه جدیدی از AgentCode ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم AgentCode گزارش دهید",
  "error.page.report.discord": "در GitHub",
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، AgentCode هنوز از احراز هویت MCP پشتیبانی نمی کند.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.",
  ...
  "settings.desktop.wsl.description": "سرور AgentCode را در داخل WSL روی Windows اجرا کنید.",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای AgentCode تغییر دهید",
  "settings.general.permissionMode.title": "حالت مجوز پیش‌فرض",
  "settings.general.permissionMode.description": "برای جلسه‌های جدید در این پوشه استفاده می‌شود",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر AgentCode را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description":
    "انتخاب کنید که آیا AgentCode از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی AgentCode را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی AgentCode، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه AgentCode را اجرا می کنید.",
