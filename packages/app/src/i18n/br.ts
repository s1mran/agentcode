export const dict = {
  ...
  "desktop.menu.ariaLabel": "Menu do AgentCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o AgentCode",
  "desktop.recovery.terminated": "A janela do AgentCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O AgentCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O AgentCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do AgentCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "command.model.choose.hint": "[modelo]",
  ...
  "command.permissionMode.cycle": "Alternar modo de permissão",
  "command.permissionMode.set": "Modo de permissão: {{mode}}",
  "command.permissionMode.bypass": "Ignorar permissões…",
  "command.plan": "Modo de planejamento",
  ...
  "command.session.compact.hint": "[instruções de foco]",
  ...
  "command.session.export.hint": "[nome do arquivo]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AgentCode.",
  ...
  "prompt.permissionMode.label": "Modo de permissão",
  "prompt.permissionMode.default": "Pedir permissões",
  "prompt.permissionMode.default.description": "Pergunta antes de comandos, edições e acesso à web",
  "prompt.permissionMode.acceptEdits": "Aceitar edições",
  "prompt.permissionMode.acceptEdits.description":
    "Edições neste projeto são aprovadas; comandos ainda pedem permissão",
  "prompt.permissionMode.plan": "Modo de planejamento",
  "prompt.permissionMode.plan.description": "Pesquisa somente leitura; apenas o arquivo do plano pode ser editado",
  "prompt.permissionMode.bypassPermissions": "Ignorar permissões",
  "prompt.permissionMode.bypassPermissions.description":
    "Executa sem perguntar, exceto caminhos protegidos, exclusões críticas e suas regras de perguntar",
  "prompt.permissionMode.dontAsk": "Não perguntar",
  "prompt.permissionMode.dontAsk.description": "Tudo o que exigiria uma pergunta é negado",
  ...
  "prompt.slash.badge.builtin": "integrado",
  "prompt.slash.hint.arguments": "[argumentos]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Comando desconhecido: /{{name}}",
  "prompt.slash.unknown.description": "Comece a mensagem com um espaço para enviá-la como texto.",
  "prompt.slash.unavailable.title": "/{{name}} não está disponível aqui",
  "prompt.slash.noArguments.title": "/{{name}} não aceita argumentos",
  ...
  "dialog.bypassPermissions.title": "Ignorar permissões?",
  "dialog.bypassPermissions.body":
    "O agente executará comandos, editará arquivos e acessará a web sem perguntar. Caminhos protegidos (.git, configuração do agente, arquivos de inicialização do shell), exclusões críticas e suas próprias regras de perguntar ainda pedem permissão; as regras de negar continuam valendo. Use isso apenas em um projeto em que você confia.",
  "dialog.bypassPermissions.confirm": "Ignorar permissões",
  "dialog.bypassPermissions.cancel": "Cancelar",
  "ui.permission.always.project": "Sempre permitir neste projeto",
  "ui.permission.always.session": "Permitir nesta sessão",
  "ui.permission.always.acceptEdits": "Permitir todas as edições (Aceitar edições)",
  "ui.permission.always.everything": "tudo para esta ferramenta",
  "ui.permission.guard.floor.title": "Ação protegida",
  "ui.permission.guard.guard.title": "Requer revisão",
  "ui.permission.guard.noAlways": "Isto só pode ser aprovado uma vez",
  "ui.permission.writes": "Grava em",
  "ui.question.planFeedback.placeholder": "Diga ao agente o que mudar no plano",
  ...
  "dialog.server.description": "Trocar para qual servidor AgentCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o AgentCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o AgentCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o AgentCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o AgentCode",
  "wsl.onboarding.opencodeReadyIn": "O AgentCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O AgentCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o AgentCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o AgentCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O AgentCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o AgentCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o AgentCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "A aceitação automática agora é “Aceitar edições”",
  "toast.permissions.modeMigrated.description":
    "Edições nesta pasta são aprovadas automaticamente; comandos ainda pedem permissão. Escolha “Ignorar permissões” na área de composição para ter autonomia total.",
  "toast.permissions.autoAcceptRemoved.title": "A aceitação automática foi desativada",
  "toast.permissions.autoAcceptRemoved.modes":
    "As solicitações de permissão voltam a aparecer. Para aprovar edições automaticamente, escolha “Aceitar edições” no menu de modos ao lado do prompt ou pressione Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "As solicitações de permissão voltam a aparecer. Para ignorá-las, permita essas ferramentas na configuração de permissões deste servidor.",
  "toast.permissions.mode.error.title": "Não foi possível alterar o modo de permissão",
  ...
  "toast.model.selected.title": "Modelo: {{name}}",
  "toast.model.selected.others": "Outras correspondências: {{count}}. Execute /model para escolher uma.",
  "toast.model.noMatch.title": "Nenhum modelo corresponde a “{{query}}”",
  "toast.agent.noMatch.title": "Nenhum agente chamado “{{query}}”",
  ...
  "toast.update.description": "Uma nova versão do AgentCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AgentCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AgentCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AgentCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AgentCode",
  "settings.general.permissionMode.title": "Modo de permissão padrão",
  "settings.general.permissionMode.description": "Usado para novas sessões nesta pasta",
  ...
  "settings.general.row.appearance.description": "Personalize como o AgentCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AgentCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AgentCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AgentCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AgentCode.",
