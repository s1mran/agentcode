export const dict = {
  ...
  "desktop.menu.documentation": "دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "AgentCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "AgentCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "AgentCode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ AgentCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "AgentCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "command.permissionMode.cycle": "اجازت موڈ بدلو",
  "command.permissionMode.set": "اجازت موڈ: {{mode}}",
  "command.permissionMode.bypass": "اجازتاں نظرانداز کرو…",
  ...
  "command.session.compact.hint": "[توجہ دیاں ہدایتاں]",
  ...
  "command.session.export.hint": "[فائل دا ناں]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے AgentCode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen تہانوں کوڈنگ ایجنٹاں لئی قابل اعتماد مرضی دے ماڈلاں دے اک کیوریٹڈ سیٹ تک رسائی فراہم کردا اے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے AgentCode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے AgentCode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "prompt.permissionMode.label": "اجازت موڈ",
  "prompt.permissionMode.default": "اجازت پُچھو",
  "prompt.permissionMode.default.description": "کمانڈاں، ترمیماں تے ویب رسائی توں پہلاں پُچھدا اے",
  "prompt.permissionMode.acceptEdits": "ترمیماں قبول کرو",
  "prompt.permissionMode.acceptEdits.description": "اس پروجیکٹ وچ ترمیماں منظور نیں؛ کمانڈاں لئی ہُن وی پُچھدا اے",
  "prompt.permissionMode.plan": "پلان موڈ",
  "prompt.permissionMode.plan.description": "صرف پڑھن والی تحقیق؛ صرف پلان فائل وچ ترمیم ہو سکدی اے",
  "prompt.permissionMode.bypassPermissions": "اجازتاں نظرانداز کرو",
  "prompt.permissionMode.bypassPermissions.description":
    "بنا پُچھے چلدا اے، سوائے محفوظ راہاں، اہم مٹاؤ تے تہاڈے پُچھن والے اصولاں دے",
  "prompt.permissionMode.dontAsk": "نہ پُچھو",
  "prompt.permissionMode.dontAsk.description": "جس لئی پُچھنا پوے، اوہ منع کر دتا جاندا اے",
  ...
  "prompt.slash.badge.builtin": "بلٹ ان",
  "prompt.slash.hint.arguments": "[آرگیومنٹ]",
  "prompt.slash.hint.positional": "<آرگ{{n}}>",
  "prompt.slash.unknown.title": "انجان کمانڈ: /{{name}}",
  "prompt.slash.unknown.description": "ایہنوں ٹیکسٹ وانگ بھیجن لئی سنیہا خالی تھاں نال شروع کرو۔",
  "prompt.slash.unavailable.title": "/{{name}} ایتھے دستیاب نئیں",
  "prompt.slash.noArguments.title": "/{{name}} آرگیومنٹ نئیں لیندی",
  ...
  "dialog.bypassPermissions.title": "کیہ اجازتاں نظرانداز کرنیاں نیں؟",
  "dialog.bypassPermissions.body":
    "ایجنٹ بنا پُچھے کمانڈاں چلائے گا، فائلاں وچ ترمیم کرے گا تے ویب تک رسائی کرے گا۔ محفوظ راہاں (.git، ایجنٹ کنفگ، شیل سٹارٹ اپ فائلاں)، اہم مٹاؤ تے تہاڈے اپنے پُچھن والے اصولاں لئی ہُن وی پُچھیا جاندا اے؛ منع والے اصول ہُن وی لاگو نیں۔ ایہنوں صرف اوس پروجیکٹ وچ ورتو جس تے تہانوں بھروسا اے۔",
  "dialog.bypassPermissions.confirm": "اجازتاں نظرانداز کرو",
  "dialog.bypassPermissions.cancel": "منسوخ کرو",
  "ui.permission.always.project": "اس پروجیکٹ وچ ہمیشہ اجازت دیو",
  "ui.permission.always.session": "اس سیشن لئی اجازت دیو",
  "ui.permission.always.acceptEdits": "ساریاں ترمیماں دی اجازت دیو (ترمیماں قبول کرو)",
  "ui.permission.always.everything": "اس ٹول لئی سب کجھ",
  "ui.permission.guard.floor.title": "محفوظ عمل",
  "ui.permission.guard.guard.title": "جائزے دی لوڑ اے",
  "ui.permission.guard.noAlways": "ایہنوں صرف اک واری منظور کیتا جا سکدا اے",
  "ui.permission.writes": "لکھن دی تھاں",
  "ui.question.planFeedback.placeholder": "ایجنٹ نوں دسو کہ پلان وچ کیہ بدلنا اے",
  ...
  "dialog.server.description": "ایہہ ایپ کس AgentCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ AgentCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "AgentCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ AgentCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ AgentCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "AgentCode اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "AgentCode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ AgentCode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "AgentCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر AgentCode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "AgentCode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "خودکار قبول کرنا ہُن ”ترمیماں قبول کرو“ موڈ اے",
  "toast.permissions.modeMigrated.description":
    "اس فولڈر وچ ترمیماں خود بخود منظور ہوندیاں نیں؛ کمانڈاں لئی ہُن وی پُچھیا جاندا اے۔ پوری خودمختاری لئی پرامپٹ خانے وچ ”اجازتاں نظرانداز کرو“ چنو۔",
  "toast.permissions.autoAcceptRemoved.title": "خودکار قبول کرنا بند کر دتا گیا",
  "toast.permissions.autoAcceptRemoved.modes":
    "اجازت دیاں درخواستاں فیر پُچھیاں جان گیاں۔ ترمیماں نوں خود بخود منظور کرن لئی، پرامپٹ دے کول موڈ مینو وچ ”ترمیماں قبول کرو“ چنو یا Shift+Tab دباؤ۔",
  "toast.permissions.autoAcceptRemoved.rules":
    "اجازت دیاں درخواستاں فیر پُچھیاں جان گیاں۔ اوہناں نوں چھڈن لئی، اس سرور دی اجازت کنفگ وچ اوہناں ٹولز نوں اجازت دیو۔",
  "toast.permissions.mode.error.title": "اجازت موڈ نہیں بدلیا جا سکیا",
  ...
  "toast.model.selected.others": "ہور ملدے: {{count}}۔ اک چنن لئی /model چلاؤ۔",
  "toast.model.noMatch.title": "«{{query}}» نال ملدا کوئی ماڈل نئیں",
  "toast.agent.noMatch.title": "«{{query}}» ناں دا کوئی ایجنٹ نئیں",
  ...
  "toast.update.description": "AgentCode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع AgentCode ٹیم نوں دیو",
  "error.page.report.discord": "GitHub تے",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AgentCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "AgentCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر AgentCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "AgentCode لئی ڈسپلے دی بولی بدلو",
  "settings.general.permissionMode.title": "طے شدہ اجازت موڈ",
  "settings.general.permissionMode.description": "اس فولڈر دے نویں سیشناں لئی ورتیا جاندا اے",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے AgentCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا AgentCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AgentCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں AgentCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی AgentCode دا تازہ ترین ورژن چلا رئے او۔",
