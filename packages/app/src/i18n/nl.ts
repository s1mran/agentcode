export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het AgentCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "AgentCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van AgentCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De AgentCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "command.permissionMode.cycle": "Volgende machtigingsmodus",
  "command.permissionMode.set": "Machtigingsmodus: {{mode}}",
  "command.permissionMode.bypass": "Machtigingen omzeilen…",
  ...
  "command.session.compact.hint": "[focusinstructies]",
  ...
  "command.session.export.hint": "[bestandsnaam]",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in AgentCode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in AgentCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in AgentCode te gebruiken.",
  ...
  "prompt.permissionMode.label": "Machtigingsmodus",
  "prompt.permissionMode.default": "Om toestemming vragen",
  "prompt.permissionMode.default.description": "Vraagt vóór opdrachten, bewerkingen en webtoegang",
  "prompt.permissionMode.acceptEdits": "Bewerkingen accepteren",
  "prompt.permissionMode.acceptEdits.description":
    "Bewerkingen in dit project worden goedgekeurd; voor opdrachten wordt nog steeds gevraagd",
  "prompt.permissionMode.plan": "Planmodus",
  "prompt.permissionMode.plan.description": "Alleen-lezen onderzoek; alleen het planbestand kan worden bewerkt",
  "prompt.permissionMode.bypassPermissions": "Machtigingen omzeilen",
  "prompt.permissionMode.bypassPermissions.description":
    "Werkt zonder te vragen, behalve voor beschermde paden, kritieke verwijderingen en je vraagregels",
  "prompt.permissionMode.dontAsk": "Niet vragen",
  "prompt.permissionMode.dontAsk.description": "Alles waarvoor gevraagd zou worden, wordt geweigerd",
  ...
  "prompt.slash.badge.builtin": "ingebouwd",
  "prompt.slash.hint.arguments": "[argumenten]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Onbekende opdracht: /{{name}}",
  "prompt.slash.unknown.description": "Begin het bericht met een spatie om het als tekst te versturen.",
  "prompt.slash.unavailable.title": "/{{name}} is hier niet beschikbaar",
  "prompt.slash.noArguments.title": "/{{name}} accepteert geen argumenten",
  ...
  "dialog.bypassPermissions.title": "Machtigingen omzeilen?",
  "dialog.bypassPermissions.body":
    "De agent voert opdrachten uit, bewerkt bestanden en gebruikt het web zonder te vragen. Voor beschermde paden (.git, agentconfiguratie, opstartbestanden van de shell), kritieke verwijderingen en je eigen vraagregels wordt nog steeds gevraagd; weigerregels blijven van kracht. Gebruik dit alleen in een project dat je vertrouwt.",
  "dialog.bypassPermissions.confirm": "Machtigingen omzeilen",
  "dialog.bypassPermissions.cancel": "Annuleer",
  "ui.permission.always.project": "Altijd toestaan in dit project",
  "ui.permission.always.session": "Toestaan voor deze sessie",
  "ui.permission.always.acceptEdits": "Alle bewerkingen toestaan (Bewerkingen accepteren)",
  "ui.permission.always.everything": "alles voor deze tool",
  "ui.permission.guard.floor.title": "Beschermde actie",
  "ui.permission.guard.guard.title": "Beoordeling nodig",
  "ui.permission.guard.noAlways": "Dit kan maar één keer worden goedgekeurd",
  "ui.permission.writes": "Schrijft naar",
  "ui.question.planFeedback.placeholder": "Vertel de agent wat er in het plan moet veranderen",
  ...
  "dialog.server.description": "Wijzig met welke AgentCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "AgentCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AgentCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk AgentCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AgentCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "AgentCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer AgentCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat AgentCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "AgentCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens AgentCode opnieuw.",
  ...
  "help.tabs.introduction": "AgentCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automatisch accepteren is nu Bewerkingen accepteren",
  "toast.permissions.modeMigrated.description":
    "Bewerkingen in deze map worden automatisch goedgekeurd; voor opdrachten wordt nog steeds gevraagd. Kies Machtigingen omzeilen in het invoerveld voor volledige autonomie.",
  "toast.permissions.autoAcceptRemoved.title": "Automatisch accepteren is uitgeschakeld",
  "toast.permissions.autoAcceptRemoved.modes":
    "Er wordt weer om toestemming gevraagd. Kies Bewerkingen accepteren in het modusmenu naast de prompt of druk op Shift+Tab om bewerkingen automatisch goed te keuren.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Er wordt weer om toestemming gevraagd. Sta die tools toe in de machtigingsconfiguratie van deze server om dit over te slaan.",
  "toast.permissions.mode.error.title": "Kan machtigingsmodus niet wijzigen",
  ...
  "toast.model.selected.others": "Andere overeenkomsten: {{count}}. Voer /model uit om er een te kiezen.",
  "toast.model.noMatch.title": "Geen model komt overeen met ‘{{query}}’",
  "toast.agent.noMatch.title": "Geen agent met de naam ‘{{query}}’",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van AgentCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het AgentCode-team",
  "error.page.report.discord": "op GitHub",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" is mislukt. Let op: AgentCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de AgentCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor AgentCode",
  "settings.general.permissionMode.title": "Standaard machtigingsmodus",
  "settings.general.permissionMode.description": "Gebruikt voor nieuwe sessies in deze map",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe AgentCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of AgentCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van AgentCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer AgentCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "AgentCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van AgentCode.",
