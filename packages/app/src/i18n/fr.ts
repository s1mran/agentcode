export const dict = {
  ...
  "desktop.menu.ariaLabel": "Menu AgentCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'AgentCode",
  "desktop.recovery.terminated": "La fenêtre AgentCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "AgentCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'AgentCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "command.model.choose.hint": "[modèle]",
  ...
  "command.permissionMode.cycle": "Changer de mode de permission",
  "command.permissionMode.set": "Mode de permission : {{mode}}",
  "command.permissionMode.bypass": "Contourner les permissions…",
  "command.plan": "Mode plan",
  ...
  "command.session.compact.hint": "[instructions de focus]",
  ...
  "command.session.export.hint": "[nom de fichier]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AgentCode.",
  ...
  "prompt.permissionMode.label": "Mode de permission",
  "prompt.permissionMode.default": "Demander les permissions",
  "prompt.permissionMode.default.description": "Demande avant les commandes, les modifications et l'accès au Web",
  "prompt.permissionMode.acceptEdits": "Accepter les modifications",
  "prompt.permissionMode.acceptEdits.description":
    "Les modifications dans ce projet sont approuvées ; les commandes demandent toujours",
  "prompt.permissionMode.plan": "Mode plan",
  "prompt.permissionMode.plan.description": "Recherche en lecture seule ; seul le fichier de plan peut être modifié",
  "prompt.permissionMode.bypassPermissions": "Contourner les permissions",
  "prompt.permissionMode.bypassPermissions.description":
    "S'exécute sans demander, sauf pour les chemins protégés, les suppressions critiques et vos règles « Demander »",
  "prompt.permissionMode.dontAsk": "Ne pas demander",
  "prompt.permissionMode.dontAsk.description": "Tout ce qui nécessiterait une demande est refusé",
  ...
  "prompt.slash.badge.builtin": "intégrée",
  "prompt.slash.hint.arguments": "[arguments]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Commande inconnue : /{{name}}",
  "prompt.slash.unknown.description": "Commencez le message par une espace pour l'envoyer comme texte.",
  "prompt.slash.unavailable.title": "/{{name}} n'est pas disponible ici",
  "prompt.slash.noArguments.title": "/{{name}} n'accepte pas d'arguments",
  ...
  "dialog.bypassPermissions.title": "Contourner les permissions ?",
  "dialog.bypassPermissions.body":
    "L'agent exécutera des commandes, modifiera des fichiers et accédera au Web sans demander. Les chemins protégés (.git, configuration de l'agent, fichiers de démarrage du shell), les suppressions critiques et vos propres règles « Demander » demandent toujours ; les règles « Refuser » s'appliquent toujours. N'utilisez ce mode que dans un projet de confiance.",
  "dialog.bypassPermissions.confirm": "Contourner les permissions",
  "dialog.bypassPermissions.cancel": "Annuler",
  "ui.permission.always.project": "Toujours autoriser dans ce projet",
  "ui.permission.always.session": "Autoriser pour cette session",
  "ui.permission.always.acceptEdits": "Autoriser toutes les modifications (Accepter les modifications)",
  "ui.permission.always.everything": "tout pour cet outil",
  "ui.permission.guard.floor.title": "Action protégée",
  "ui.permission.guard.guard.title": "Vérification requise",
  "ui.permission.guard.noAlways": "Ceci ne peut être approuvé qu'une seule fois",
  "ui.permission.writes": "Écrit dans",
  "ui.question.planFeedback.placeholder": "Indiquez à l'agent ce qu'il faut changer dans le plan",
  ...
  "dialog.server.description": "Changez le serveur AgentCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'AgentCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'AgentCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour AgentCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez AgentCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'AgentCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "AgentCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "L'acceptation automatique devient « Accepter les modifications »",
  "toast.permissions.modeMigrated.description":
    "Les modifications dans ce dossier sont approuvées automatiquement ; les commandes demandent toujours. Choisissez « Contourner les permissions » dans la zone de saisie pour une autonomie complète.",
  "toast.permissions.autoAcceptRemoved.title": "L'acceptation automatique a été désactivée",
  "toast.permissions.autoAcceptRemoved.modes":
    "Les demandes de permission s'affichent à nouveau. Pour approuver automatiquement les modifications, choisissez « Accepter les modifications » dans le menu des modes à côté de l'invite ou appuyez sur Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Les demandes de permission s'affichent à nouveau. Pour les ignorer, autorisez ces outils dans la configuration des permissions de ce serveur.",
  "toast.permissions.mode.error.title": "Impossible de changer le mode de permission",
  ...
  "toast.model.selected.title": "Modèle : {{name}}",
  "toast.model.selected.others": "Autres correspondances : {{count}}. Lancez /model pour en choisir un.",
  "toast.model.noMatch.title": "Aucun modèle ne correspond à « {{query}} »",
  "toast.agent.noMatch.title": "Aucun agent nommé « {{query}} »",
  ...
  "toast.update.description":
    "Une nouvelle version d'AgentCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AgentCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AgentCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AgentCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AgentCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AgentCode",
  "settings.general.permissionMode.title": "Mode de permission par défaut",
  "settings.general.permissionMode.description": "Utilisé pour les nouvelles sessions dans ce dossier",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AgentCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AgentCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AgentCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AgentCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AgentCode.",
