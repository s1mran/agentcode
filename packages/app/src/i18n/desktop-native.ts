...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.menu.ariaLabel": "AgentCode menu",
  ...
  "desktop.recovery.loadFailed": "AgentCode failed to load",
  "desktop.recovery.terminated": "AgentCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "AgentCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
