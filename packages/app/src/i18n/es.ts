export const dict = {
  ...
  "desktop.menu.ariaLabel": "Menú de AgentCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar AgentCode",
  "desktop.recovery.terminated": "La ventana de AgentCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "AgentCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de AgentCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "command.session.compact.hint": "[instrucciones de enfoque]",
  ...
  "command.session.export.hint": "[nombre de archivo]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AgentCode.",
  ...
  "prompt.slash.unknown.title": "Comando desconocido: /{{name}}",
  "prompt.slash.unknown.description": "Empieza el mensaje con un espacio para enviarlo como texto.",
  "prompt.slash.unavailable.title": "/{{name}} no está disponible aquí",
  "prompt.slash.noArguments.title": "/{{name}} no acepta argumentos",
  ...
  "dialog.server.description": "Cambiar el servidor de AgentCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando AgentCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando AgentCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza AgentCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala AgentCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que AgentCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AgentCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Otras coincidencias: {{count}}. Ejecuta /model para elegir uno.",
  "toast.model.noMatch.title": "Ningún modelo coincide con «{{query}}»",
  "toast.agent.noMatch.title": "No hay ningún agente llamado «{{query}}»",
  ...
  "toast.update.description": "Una nueva versión de AgentCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de AgentCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: AgentCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AgentCode dentro de WSL en Windows.",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve AgentCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AgentCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AgentCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AgentCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AgentCode.",
