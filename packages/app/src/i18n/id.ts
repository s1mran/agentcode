export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela AgentCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "AgentCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi AgentCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan AgentCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "command.session.compact.hint": "[instruksi fokus]",
  ...
  "command.session.export.hint": "[nama file]",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di AgentCode.",
  ...
  "prompt.slash.badge.builtin": "bawaan",
  "prompt.slash.hint.arguments": "[argumen]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Perintah tidak dikenal: /{{name}}",
  "prompt.slash.unknown.description": "Awali pesan dengan spasi untuk mengirimnya sebagai teks.",
  ...
  "dialog.server.description": "Ganti server AgentCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa AgentCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui AgentCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui AgentCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal AgentCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AgentCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AgentCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Kecocokan lain: {{count}}. Jalankan /model untuk memilih.",
  "toast.model.noMatch.title": "Tidak ada model yang cocok dengan “{{query}}”",
  "toast.agent.noMatch.title": "Tidak ada agen bernama “{{query}}”",
  ...
  "toast.update.description": "Versi baru AgentCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim AgentCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: AgentCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server AgentCode di dalam WSL di Windows.",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan AgentCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah AgentCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat AgentCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru AgentCode.",
