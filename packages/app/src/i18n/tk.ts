export const dict = {
  ...
  "desktop.menu.documentation": "Resminamalar",
  ...
  "desktop.menu.ariaLabel": "AgentCode menýusy",
  ...
  "desktop.recovery.loadFailed": "AgentCode ýükläp bilmedi",
  "desktop.recovery.terminated": "AgentCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "AgentCode jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.opencodeMissing": "opencode bu distroda gurlanok",
  "desktop.wsl.error.opencodeCannotRun": "opencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "AgentCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "command.permissionMode.cycle": "Rugsat režimini çalyş",
  "command.permissionMode.set": "Rugsat režimi: {{mode}}",
  "command.permissionMode.bypass": "Rugsatlary aýlanyp geç…",
  "command.plan": "Meýilnama režimi",
  ...
  "command.session.compact.hint": "[ünsi jemleme görkezmeleri]",
  ...
  "command.session.export.hint": "[faýl ady]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we AgentCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AgentCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AgentCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "prompt.permissionMode.label": "Rugsat režimi",
  "prompt.permissionMode.default": "Rugsat sora",
  "prompt.permissionMode.default.description": "Buýruklardan, üýtgetmelerden we internete girmekden öň soraýar",
  "prompt.permissionMode.acceptEdits": "Üýtgetmeleri kabul et",
  "prompt.permissionMode.acceptEdits.description":
    "Bu taslamadaky üýtgetmeler tassyklanýar; buýruklar üçin henizem soraýar",
  "prompt.permissionMode.plan": "Meýilnama režimi",
  "prompt.permissionMode.plan.description": "Diňe okamak üçin öwreniş; diňe meýilnama faýlyny redaktirläp bolýar",
  "prompt.permissionMode.bypassPermissions": "Rugsatlary aýlanyp geç",
  "prompt.permissionMode.bypassPermissions.description":
    "Goralýan ýollardan, möhüm pozmalardan we siziň «Soraň» düzgünleriňizden başga ýagdaýlarda soramazdan işleýär",
  "prompt.permissionMode.dontAsk": "Soramaň",
  "prompt.permissionMode.dontAsk.description": "Soramagy talap edýän islendik zat ret edilýär",
  ...
  "prompt.slash.badge.builtin": "içki",
  "prompt.slash.hint.arguments": "[argumentler]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Näbelli buýruk: /{{name}}",
  "prompt.slash.unknown.description": "Tekst hökmünde ibermek üçin habary boşluk bilen başlaň.",
  "prompt.slash.unavailable.title": "/{{name}} bu ýerde elýeterli däl",
  "prompt.slash.noArguments.title": "/{{name}} argument kabul etmeýär",
  ...
  "dialog.bypassPermissions.title": "Rugsatlary aýlanyp geçmelimi?",
  "dialog.bypassPermissions.body":
    "Agent soramazdan buýruklary işleder, faýllary redaktirlär we internete girer. Goralýan ýollar (.git, agent konfigurasiýasy, shell başlangyç faýllary), möhüm pozmalar we öz «Soraň» düzgünleriňiz üçin henizem soraýar; «Inkär et» düzgünleri güýjünde galýar. Muny diňe ynanýan taslamaňyzda ulanyň.",
  "dialog.bypassPermissions.confirm": "Rugsatlary aýlanyp geç",
  "dialog.bypassPermissions.cancel": "Elatyr",
  "ui.permission.always.project": "Bu taslamada elmydama rugsat beriň",
  "ui.permission.always.session": "Bu sessiýa üçin rugsat beriň",
  "ui.permission.always.acceptEdits": "Ähli üýtgetmelere rugsat beriň (Üýtgetmeleri kabul et)",
  "ui.permission.always.everything": "bu gural üçin hemme zat",
  "ui.permission.guard.floor.title": "Goralýan hereket",
  "ui.permission.guard.guard.title": "Gözden geçirmek gerek",
  "ui.permission.guard.noAlways": "Muny diňe bir gezek tassyklap bolýar",
  "ui.permission.writes": "Ýazýan ýeri",
  "ui.question.planFeedback.placeholder": "Agente meýilnamada näme üýtgetmelidigini aýdyň",
  ...
  "dialog.server.description": "Bu programmanyň haýsy AgentCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AgentCode barlanýar...",
  "wsl.onboarding.updatingOpencode": "AgentCode täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de AgentCode täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "AgentCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "AgentCode täzeläň",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "AgentCode taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de AgentCode guruň.",
  "wsl.onboarding.installOpencode": "AgentCode guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) AgentCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "AgentCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra AgentCode açyň.",
  ...
  "help.tabs.introduction": "AgentCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Awto-kabul ediş indi Üýtgetmeleri kabul et boldy",
  "toast.permissions.modeMigrated.description":
    "Bu papkadaky üýtgetmeler awtomatiki tassyklanýar; buýruklar üçin henizem soraýar. Doly awtonomiýa üçin kompozitorda Rugsatlary aýlanyp geç saýlaň.",
  "toast.permissions.autoAcceptRemoved.title": "Awto-kabul ediş öçürildi",
  "toast.permissions.autoAcceptRemoved.modes":
    "Rugsat haýyşlary ýene soralýar. Üýtgetmeleri awtomatiki tassyklamak üçin prompt ýanyndaky režim menýusynda Üýtgetmeleri kabul et saýlaň ýa-da Shift+Tab basyň.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Rugsat haýyşlary ýene soralýar. Olary geçirmek üçin bu serweriň rugsat konfigurasiýasynda şol gurallara rugsat beriň.",
  "toast.permissions.mode.error.title": "Rugsat režimini üýtgedip bolmady",
  ...
  "toast.model.selected.others": "Beýleki gabat gelmeler: {{count}}. Birini saýlamak üçin /model işlediň.",
  "toast.model.noMatch.title": "“{{query}}” bilen gabat gelýän model ýok",
  "toast.agent.noMatch.title": "“{{query}}” atly agent ýok",
  ...
  "toast.update.description": "Indi gurmak üçin AgentCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy AgentCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, AgentCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "AgentCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "AgentCode üçin displeý dilini üýtgediň",
  "settings.general.permissionMode.title": "Deslapky rugsat režimi",
  "settings.general.permissionMode.description": "Bu papkadaky täze sessiýalar üçin ulanylýar",
  ...
  "settings.general.row.appearance.description": "AgentCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "AgentCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "AgentCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "AgentCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "AgentCode-iň iň soňky wersiýasyny işleýärsiňiz.",
