export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i AgentCode.",
  ...
  "prompt.slash.badge.builtin": "indbygget",
  "prompt.slash.hint.arguments": "[argumenter]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Ukendt kommando: /{{name}}",
  "prompt.slash.unknown.description": "Start beskeden med et mellemrum for at sende den som tekst.",
  "prompt.slash.unavailable.title": "/{{name}} er ikke tilgængelig her",
  "prompt.slash.noArguments.title": "/{{name}} tager ikke argumenter",
  ...
  "dialog.server.description": "Skift hvilken AgentCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker AgentCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer AgentCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater AgentCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før AgentCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "AgentCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter AgentCode igen.",
  ...
  "toast.model.selected.others": "Andre match: {{count}}. Kør /model for at vælge en.",
  "toast.model.noMatch.title": "Ingen model matcher ”{{query}}”",
  ...
  "toast.update.description": "En ny version af AgentCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AgentCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AgentCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AgentCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan AgentCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om AgentCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas AgentCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AgentCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AgentCode.",
  ...
  "desktop.recovery.loadFailed": "AgentCode kunne ikke indlæses",
  "desktop.recovery.terminated": "AgentCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af AgentCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af AgentCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "AgentCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
