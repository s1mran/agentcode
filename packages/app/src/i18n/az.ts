export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode yüklənə bilmədi",
  "desktop.recovery.terminated": "AgentCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "AgentCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "AgentCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "command.permissionMode.cycle": "İcazə rejimini dəyiş",
  "command.permissionMode.set": "İcazə rejimi: {{mode}}",
  "command.permissionMode.bypass": "İcazələri yan keç…",
  "command.plan": "Plan rejimi",
  ...
  "command.session.compact.hint": "[fokus təlimatları]",
  ...
  "command.session.export.hint": "[fayl adı]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və AgentCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və AgentCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və AgentCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "prompt.permissionMode.label": "İcazə rejimi",
  "prompt.permissionMode.default": "İcazə soruş",
  "prompt.permissionMode.default.description": "Əmrlərdən, redaktələrdən və veb girişindən əvvəl soruşur",
  "prompt.permissionMode.acceptEdits": "Redaktələri qəbul et",
  "prompt.permissionMode.acceptEdits.description":
    "Bu layihədəki redaktələr təsdiqlənir; əmrlər üçün hələ də soruşulur",
  "prompt.permissionMode.plan": "Plan rejimi",
  "prompt.permissionMode.plan.description": "Yalnız oxumaq üçün araşdırma; yalnız plan faylı redaktə edilə bilər",
  "prompt.permissionMode.bypassPermissions": "İcazələri yan keç",
  "prompt.permissionMode.bypassPermissions.description":
    "Qorunan yollar, kritik silmələr və soruşma qaydalarınız istisna olmaqla, soruşmadan işləyir",
  "prompt.permissionMode.dontAsk": "Soruşma",
  "prompt.permissionMode.dontAsk.description": "Soruşma tələb edən hər şey rədd edilir",
  ...
  "prompt.slash.badge.builtin": "daxili",
  "prompt.slash.hint.arguments": "[arqumentlər]",
  "prompt.slash.hint.positional": "<arq{{n}}>",
  "prompt.slash.unknown.title": "Naməlum əmr: /{{name}}",
  "prompt.slash.unknown.description": "Mətn kimi göndərmək üçün mesajı boşluqla başladın.",
  "prompt.slash.unavailable.title": "/{{name}} burada mövcud deyil",
  "prompt.slash.noArguments.title": "/{{name}} arqument qəbul etmir",
  ...
  "dialog.bypassPermissions.title": "İcazələr yan keçilsin?",
  "dialog.bypassPermissions.body":
    "Agent soruşmadan əmrləri işlədəcək, faylları redaktə edəcək və vebə daxil olacaq. Qorunan yollar (.git, agent konfiqurasiyası, shell başlanğıc faylları), kritik silmələr və öz soruşma qaydalarınız üçün yenə soruşulur; rədd qaydaları da qüvvədə qalır. Bunu yalnız etibar etdiyiniz layihədə istifadə edin.",
  "dialog.bypassPermissions.confirm": "İcazələri yan keç",
  "dialog.bypassPermissions.cancel": "Ləğv et",
  "ui.permission.always.project": "Bu layihədə həmişə icazə ver",
  "ui.permission.always.session": "Bu sessiya üçün icazə ver",
  "ui.permission.always.acceptEdits": "Bütün redaktələrə icazə ver (Redaktələri qəbul et)",
  "ui.permission.always.everything": "bu alət üçün hər şey",
  "ui.permission.guard.floor.title": "Qorunan əməliyyat",
  "ui.permission.guard.guard.title": "Yoxlama tələb olunur",
  "ui.permission.guard.noAlways": "Bu yalnız bir dəfə təsdiqlənə bilər",
  "ui.permission.writes": "Yazma hədəfləri",
  "ui.question.planFeedback.placeholder": "Agentə planda nəyin dəyişməli olduğunu deyin",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu AgentCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də AgentCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "AgentCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də AgentCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də AgentCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "AgentCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "AgentCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "AgentCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "AgentCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "AgentCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra AgentCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "AgentCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Avtomatik qəbul artıq “Redaktələri qəbul et” rejimidir",
  "toast.permissions.modeMigrated.description":
    "Bu qovluqdakı redaktələr avtomatik təsdiqlənir; əmrlər üçün hələ də soruşulur. Tam muxtariyyət üçün mesaj sahəsində “İcazələri yan keç” seçin.",
  "toast.permissions.autoAcceptRemoved.title": "Avtomatik qəbul söndürüldü",
  "toast.permissions.autoAcceptRemoved.modes":
    "İcazə sorğuları yenidən göstərilir. Redaktələri avtomatik təsdiqləmək üçün promptun yanındakı rejim menyusunda “Redaktələri qəbul et” seçin və ya Shift+Tab basın.",
  "toast.permissions.autoAcceptRemoved.rules":
    "İcazə sorğuları yenidən göstərilir. Onları ötürmək üçün həmin alətlərə bu serverin icazə konfiqurasiyasında icazə verin.",
  "toast.permissions.mode.error.title": "İcazə rejimini dəyişmək mümkün olmadı",
  ...
  "toast.model.selected.others": "Digər uyğunluqlar: {{count}}. Birini seçmək üçün /model işlədin.",
  "toast.model.noMatch.title": "“{{query}}” ilə uyğun model yoxdur",
  "toast.agent.noMatch.title": "“{{query}}” adlı agent yoxdur",
  ...
  "toast.update.description": "AgentCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı AgentCode komandasına",
  "error.page.report.discord": "GitHub-da bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: AgentCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində AgentCode serverini işlət.",
  ...
  "settings.general.row.language.description": "AgentCode üçün ekran dilini dəyişdirin",
  "settings.general.permissionMode.title": "Standart icazə rejimi",
  "settings.general.permissionMode.description": "Bu qovluqdakı yeni sessiyalar üçün istifadə olunur",
  ...
  "settings.general.row.appearance.description": "AgentCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "AgentCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "AgentCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "AgentCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "AgentCode-un ən son versiyasından istifadə edirsiniz.",
