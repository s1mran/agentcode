export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni",
  ...
  "desktop.menu.ariaLabel": "Menuja AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja AgentCode u mbyll papritur",
  "desktop.recovery.unresponsive": "AgentCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i AgentCode dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i AgentCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "command.agent.cycle.hint": "[agjent]",
  ...
  "command.permissionMode.cycle": "Ndrysho mënyrën e lejeve",
  "command.permissionMode.set": "Mënyra e lejeve: {{mode}}",
  "command.permissionMode.bypass": "Anashkalo lejet…",
  "command.plan": "Mënyra e planifikimit",
  ...
  "command.session.compact.hint": "[udhëzime fokusi]",
  ...
  "command.session.export.hint": "[emri i skedarit]",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AgentCode.",
  ...
  "prompt.permissionMode.label": "Mënyra e lejeve",
  "prompt.permissionMode.default": "Kërko leje",
  "prompt.permissionMode.default.description": "Pyet përpara komandave, redaktimeve dhe qasjes në ueb",
  "prompt.permissionMode.acceptEdits": "Prano redaktimet",
  "prompt.permissionMode.acceptEdits.description": "Redaktimet në këtë projekt miratohen; për komandat ende pyet",
  "prompt.permissionMode.plan": "Mënyra e planifikimit",
  "prompt.permissionMode.plan.description": "Kërkim vetëm për lexim; mund të redaktohet vetëm skedari i planit",
  "prompt.permissionMode.bypassPermissions": "Anashkalo lejet",
  "prompt.permissionMode.bypassPermissions.description":
    "Ekzekutohet pa pyetur, përveç shtigjeve të mbrojtura, fshirjeve kritike dhe rregullave tuaja “Pyetni”",
  "prompt.permissionMode.dontAsk": "Mos pyet",
  "prompt.permissionMode.dontAsk.description": "Gjithçka që do të kërkonte pyetje refuzohet",
  ...
  "prompt.slash.badge.builtin": "e integruar",
  "prompt.slash.hint.arguments": "[argumente]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Komandë e panjohur: /{{name}}",
  "prompt.slash.unknown.description": "Filloni mesazhin me një hapësirë për ta dërguar si tekst.",
  "prompt.slash.unavailable.title": "/{{name}} nuk është e disponueshme këtu",
  "prompt.slash.noArguments.title": "/{{name}} nuk pranon argumente",
  ...
  "dialog.bypassPermissions.title": "Të anashkalohen lejet?",
  "dialog.bypassPermissions.body":
    "Agjenti do të ekzekutojë komanda, do të redaktojë skedarë dhe do të hyjë në ueb pa pyetur. Për shtigjet e mbrojtura (.git, konfigurimi i agjentit, skedarët e nisjes së guaskës), fshirjet kritike dhe rregullat tuaja “Pyetni” ende pyet; rregullat “Moho” vazhdojnë të zbatohen. Përdoreni këtë vetëm në një projekt që i besoni.",
  "dialog.bypassPermissions.confirm": "Anashkalo lejet",
  "dialog.bypassPermissions.cancel": "Anulo",
  "ui.permission.always.project": "Lejo gjithmonë në këtë projekt",
  "ui.permission.always.session": "Lejo për këtë seancë",
  "ui.permission.always.acceptEdits": "Lejo të gjitha redaktimet (Prano redaktimet)",
  "ui.permission.always.everything": "gjithçka për këtë mjet",
  "ui.permission.guard.floor.title": "Veprim i mbrojtur",
  "ui.permission.guard.guard.title": "Kërkon rishikim",
  "ui.permission.guard.noAlways": "Kjo mund të miratohet vetëm një herë",
  "ui.permission.writes": "Shkruan në",
  "ui.question.planFeedback.placeholder": "Tregojini agjentit çfarë të ndryshojë në plan",
  ...
  "dialog.server.description": "Ndrysho me cilin server AgentCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon AgentCode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AgentCode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson AgentCode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso AgentCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni AgentCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se AgentCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Pranimi automatik tani është Prano redaktimet",
  "toast.permissions.modeMigrated.description":
    "Redaktimet në këtë dosje miratohen automatikisht; për komandat ende pyet. Zgjidhni Anashkalo lejet në kompozitor për autonomi të plotë.",
  "toast.permissions.autoAcceptRemoved.title": "Pranimi automatik u çaktivizua",
  "toast.permissions.autoAcceptRemoved.modes":
    "Kërkesat për leje shfaqen përsëri. Për të miratuar automatikisht redaktimet, zgjidhni Prano redaktimet te menyja e mënyrës pranë fushës së kërkesës ose shtypni Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Kërkesat për leje shfaqen përsëri. Për t'i anashkaluar, lejoni ato mjete në konfigurimin e lejeve të këtij serveri.",
  "toast.permissions.mode.error.title": "Mënyra e lejeve nuk mund të ndryshohej",
  ...
  "toast.model.selected.title": "Modeli: {{name}}",
  "toast.model.selected.others": "Përputhje të tjera: {{count}}. Ekzekutoni /model për të zgjedhur një.",
  "toast.model.noMatch.title": "Asnjë model nuk përputhet me “{{query}}”",
  "toast.agent.noMatch.title": "Asnjë agjent me emrin “{{query}}”",
  ...
  "toast.update.description": "Një version i ri i AgentCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i AgentCode",
  "error.page.report.discord": "në GitHub",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, AgentCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin AgentCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për AgentCode",
  "settings.general.permissionMode.title": "Mënyra e parazgjedhur e lejeve",
  "settings.general.permissionMode.description": "Përdoret për seancat e reja në këtë dosje",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket AgentCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse AgentCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e AgentCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset AgentCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të AgentCode.",
