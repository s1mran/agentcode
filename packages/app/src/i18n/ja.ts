export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCodeメニュー",
  ...
  "desktop.recovery.loadFailed": "AgentCodeを読み込めませんでした",
  "desktop.recovery.terminated": "AgentCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "AgentCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "AgentCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはAgentCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "AgentCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "command.agent.cycle.hint": "[エージェント]",
  ...
  "command.permissionMode.cycle": "権限モードの切り替え",
  "command.permissionMode.set": "権限モード: {{mode}}",
  "command.permissionMode.bypass": "権限をバイパス…",
  "command.plan": "プランモード",
  ...
  "command.session.compact.hint": "[要約の焦点]",
  ...
  "command.session.export.hint": "[ファイル名]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、AgentCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAgentCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、AgentCodeで{{provider}}モデルを使用してください。",
  ...
  "prompt.permissionMode.label": "権限モード",
  "prompt.permissionMode.default": "権限を確認",
  "prompt.permissionMode.default.description": "コマンド、編集、ウェブアクセスの前に確認します",
  "prompt.permissionMode.acceptEdits": "編集を承認",
  "prompt.permissionMode.acceptEdits.description":
    "このプロジェクト内の編集は承認されます。コマンドは引き続き確認します",
  "prompt.permissionMode.plan": "プランモード",
  "prompt.permissionMode.plan.description": "読み取り専用の調査。編集できるのはプランファイルのみです",
  "prompt.permissionMode.bypassPermissions": "権限をバイパス",
  "prompt.permissionMode.bypassPermissions.description":
    "確認なしで実行します（保護されたパス、重大な削除、独自の確認ルールを除く）",
  "prompt.permissionMode.dontAsk": "確認しない",
  "prompt.permissionMode.dontAsk.description": "確認が必要な操作はすべて拒否されます",
  ...
  "prompt.slash.badge.builtin": "組み込み",
  "prompt.slash.hint.arguments": "[引数]",
  "prompt.slash.hint.positional": "<引数{{n}}>",
  "prompt.slash.unknown.title": "不明なコマンド: /{{name}}",
  "prompt.slash.unknown.description": "テキストとして送信するには、メッセージの先頭にスペースを入れてください。",
  "prompt.slash.unavailable.title": "/{{name}} はここでは使用できません",
  "prompt.slash.noArguments.title": "/{{name}} は引数を受け付けません",
  ...
  "dialog.bypassPermissions.title": "権限をバイパスしますか？",
  "dialog.bypassPermissions.body":
    "エージェントは確認なしでコマンドを実行し、ファイルを編集し、ウェブにアクセスします。保護されたパス（.git、エージェント設定、シェルの起動ファイル）、重大な削除、独自の確認ルールでは引き続き確認し、拒否ルールも引き続き適用されます。信頼できるプロジェクトでのみ使用してください。",
  "dialog.bypassPermissions.confirm": "権限をバイパス",
  "dialog.bypassPermissions.cancel": "キャンセル",
  "ui.permission.always.project": "このプロジェクトで常に許可",
  "ui.permission.always.session": "このセッションで許可",
  "ui.permission.always.acceptEdits": "すべての編集を許可（編集を承認）",
  "ui.permission.always.everything": "このツールのすべて",
  "ui.permission.guard.floor.title": "保護された操作",
  "ui.permission.guard.guard.title": "レビューが必要",
  "ui.permission.guard.noAlways": "この操作は一度だけ承認できます",
  "ui.permission.writes": "書き込み先",
  "ui.question.planFeedback.placeholder": "プランで変更する内容をエージェントに伝えてください",
  ...
  "dialog.server.description": "このアプリが接続するAgentCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAgentCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "AgentCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAgentCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAgentCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "AgentCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のAgentCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "AgentCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にAgentCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "AgentCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、AgentCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "AgentCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "自動承認は「編集を承認」になりました",
  "toast.permissions.modeMigrated.description":
    "このフォルダ内の編集は自動的に承認されます。コマンドは引き続き確認します。完全に自律して動作させるには、入力欄で「権限をバイパス」を選択してください。",
  "toast.permissions.autoAcceptRemoved.title": "自動承認はオフになりました",
  "toast.permissions.autoAcceptRemoved.modes":
    "権限の要求が再び表示されます。編集を自動的に承認するには、プロンプト横のモードメニューで「編集を承認」を選択するか、Shift+Tab を押してください。",
  "toast.permissions.autoAcceptRemoved.rules":
    "権限の要求が再び表示されます。スキップするには、このサーバーの権限設定でそれらのツールを許可してください。",
  "toast.permissions.mode.error.title": "権限モードを変更できませんでした",
  "toast.model.none.title": "モデルが選択されていません",
  "toast.model.none.description": "このセッションを要約するにはプロバイダーを接続してください",
  "toast.model.selected.title": "モデル: {{name}}",
  "toast.model.selected.others": "他の一致: {{count}} 件。/model を実行して選択してください。",
  "toast.model.noMatch.title": "「{{query}}」に一致するモデルはありません",
  "toast.agent.noMatch.title": "「{{query}}」という名前のエージェントはありません",
  ...
  "toast.update.description": "AgentCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAgentCodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: AgentCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "AgentCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAgentCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "AgentCodeの表示言語を変更します",
  "settings.general.permissionMode.title": "デフォルトの権限モード",
  "settings.general.permissionMode.description": "このフォルダの新しいセッションで使用されます",
  ...
  "settings.general.row.appearance.description": "デバイスでのAgentCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "AgentCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "AgentCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "AgentCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "AgentCode は最新バージョンです。",
