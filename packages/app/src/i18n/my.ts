export const dict = {
  ...
  "desktop.menu.documentation": "စာရွက်စာတမ်း",
  ...
  "desktop.menu.ariaLabel": "AgentCode မီနူး",
  ...
  "desktop.recovery.loadFailed": "AgentCode ကို ဖွင့်၍မရပါ။",
  "desktop.recovery.terminated": "AgentCode ဝင်းဒိုးသည် မမျှော်လင့်ဘဲ ပိတ်သွားသည်။",
  "desktop.recovery.unresponsive": "AgentCode သည် တုံ့ပြန်ခြင်းမရှိပါ။",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode ထည့်သွင်းခြင်း မအောင်မြင်ပါ။",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode ကို {{distro}} တွင် ထည့်သွင်းမထားပါ။",
  "desktop.wsl.error.updateVersion":
    "AgentCode အပ်ဒိတ် ပြီးဆုံးသွားသော်လည်း {{distro}} သည် {{installed}} မှ ဆက်လက်တင်ပြနေပါသည်။ {{expected}} မျှော်လင့်ထားသည်။",
  ...
  "command.model.choose.hint": "[မော်ဒယ်]",
  ...
  "command.agent.cycle.hint": "[အေးဂျင့်]",
  ...
  "command.permissionMode.cycle": "ခွင့်ပြုချက်မုဒ်ကို ပြောင်းရန်",
  "command.permissionMode.set": "ခွင့်ပြုချက်မုဒ်: {{mode}}",
  "command.permissionMode.bypass": "ခွင့်ပြုချက်များကို ကျော်ရန်…",
  "command.plan": "အစီအစဉ်မုဒ်",
  ...
  "command.session.compact.hint": "[အာရုံစိုက်ညွှန်ကြားချက်]",
  ...
  "command.session.export.hint": "[ဖိုင်အမည်]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode မှ ပံ့ပိုးပေးသော အခမဲ့မော်ဒယ်များ",
  ...
  "provider.connect.apiKey.description":
    "သင့်အကောင့်ကို ချိတ်ဆက်ရန်နှင့် AgentCode တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် သင်၏ {{provider}} API သော့ကို ထည့်သွင်းပါ။",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " သို့သွားပြီး သင့်အကောင့်ကို ချိတ်ဆက်ကာ AgentCode တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် ခွင့်ပြုချက်ကုဒ်ကို ရယူပါ။",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "နှင့် သင့်အကောင့်ကို ချိတ်ဆက်ပြီး AgentCode တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် အောက်ပါကုဒ်ကို ရိုက်ထည့်ပါ။",
  ...
  "prompt.permissionMode.label": "ခွင့်ပြုချက်မုဒ်",
  "prompt.permissionMode.default": "ခွင့်ပြုချက် မေးရန်",
  "prompt.permissionMode.default.description": "command များ၊ တည်းဖြတ်မှုများနှင့် ဝဘ်အသုံးပြုမှု မတိုင်မီ မေးသည်",
  "prompt.permissionMode.acceptEdits": "တည်းဖြတ်မှုများကို လက်ခံရန်",
  "prompt.permissionMode.acceptEdits.description":
    "ဤပရောဂျက်ရှိ တည်းဖြတ်မှုများကို အတည်ပြုထားသည်။ command များအတွက် ဆက်မေးသည်",
  "prompt.permissionMode.plan": "အစီအစဉ်မုဒ်",
  "prompt.permissionMode.plan.description": "ဖတ်ရန်သာ သုတေသန။ အစီအစဉ်ဖိုင်ကိုသာ တည်းဖြတ်နိုင်သည်",
  "prompt.permissionMode.bypassPermissions": "ခွင့်ပြုချက်များကို ကျော်ရန်",
  "prompt.permissionMode.bypassPermissions.description":
    "ကာကွယ်ထားသော လမ်းကြောင်းများ၊ အရေးကြီးသော ဖျက်ခြင်းများနှင့် သင့်မေးရန် စည်းမျဉ်းများမှလွဲ၍ မမေးဘဲ လုပ်ဆောင်သည်",
  "prompt.permissionMode.dontAsk": "မမေးပါနှင့်",
  "prompt.permissionMode.dontAsk.description": "မေးရမည့်အရာမှန်သမျှကို ငြင်းဆိုသည်",
  ...
  "prompt.slash.badge.builtin": "ပါဝင်ပြီး",
  "prompt.slash.hint.arguments": "[အာဂျူမင့်များ]",
  "prompt.slash.hint.positional": "<အာဂျူ{{n}}>",
  "prompt.slash.unknown.title": "မသိသော ညွှန်ကြားချက်- /{{name}}",
  "prompt.slash.unknown.description": "စာသားအဖြစ် ပို့ရန် မက်ဆေ့ချ်ကို နေရာလွတ်ဖြင့် စပါ။",
  "prompt.slash.unavailable.title": "/{{name}} ကို ဤနေရာတွင် မရနိုင်ပါ",
  "prompt.slash.noArguments.title": "/{{name}} သည် အာဂျူမင့်များကို လက်မခံပါ",
  ...
  "dialog.bypassPermissions.title": "ခွင့်ပြုချက်များကို ကျော်မလား။",
  "dialog.bypassPermissions.body":
    "အေးဂျင့်သည် မမေးဘဲ command များကို လုပ်ဆောင်မည်၊ ဖိုင်များကို တည်းဖြတ်မည်နှင့် ဝဘ်ကို အသုံးပြုမည်။ ကာကွယ်ထားသော လမ်းကြောင်းများ (.git၊ အေးဂျင့် config၊ shell စတင်ဖိုင်များ)၊ အရေးကြီးသော ဖျက်ခြင်းများနှင့် သင့်ကိုယ်ပိုင် မေးရန် စည်းမျဉ်းများအတွက် ဆက်မေးမည်ဖြစ်ပြီး ငြင်းဆိုရန် စည်းမျဉ်းများလည်း ဆက်လက်သက်ရောက်မည်။ သင်ယုံကြည်သော ပရောဂျက်တွင်သာ ၎င်းကို အသုံးပြုပါ။",
  "dialog.bypassPermissions.confirm": "ခွင့်ပြုချက်များကို ကျော်ရန်",
  "dialog.bypassPermissions.cancel": "မလုပ်တော့",
  "ui.permission.always.project": "ဤပရောဂျက်တွင် အမြဲခွင့်ပြုပါ",
  "ui.permission.always.session": "ဤစက်ရှင်အတွက် ခွင့်ပြုပါ",
  "ui.permission.always.acceptEdits": "တည်းဖြတ်မှုအားလုံးကို ခွင့်ပြုပါ (တည်းဖြတ်မှုများကို လက်ခံရန်)",
  "ui.permission.always.everything": "ဤကိရိယာအတွက် အားလုံး",
  "ui.permission.guard.floor.title": "ကာကွယ်ထားသော လုပ်ဆောင်ချက်",
  "ui.permission.guard.guard.title": "သုံးသပ်ရန် လိုအပ်သည်",
  "ui.permission.guard.noAlways": "၎င်းကို တစ်ကြိမ်သာ အတည်ပြုနိုင်သည်",
  "ui.permission.writes": "ရေးမည့်နေရာ",
  "ui.question.planFeedback.placeholder": "အစီအစဉ်တွင် ဘာပြောင်းရမည်ကို အေးဂျင့်ကို ပြောပါ",
  ...
  "dialog.server.description": "ဤအက်ပ်နှင့်ချိတ်ဆက်သည့် AgentCode ဆာဗာကို ပြောင်းပါ။",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode စစ်ဆေးနေသည်...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} တွင် AgentCode ကိုစစ်ဆေးနေသည်...",
  "wsl.onboarding.updatingOpencode": "AgentCode ကို အပ်ဒိတ်လုပ်နေသည်...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} တွင် AgentCode ကို အပ်ဒိတ်လုပ်နေသည်...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} တွင် AgentCode ကို အပ်ဒိတ်လုပ်ပါ။",
  "wsl.onboarding.updateOpencode": "AgentCode ကို အပ်ဒိတ်လုပ်ပါ။",
  "wsl.onboarding.opencodeReadyIn": "AgentCode သည် {{distro}} တွင် အဆင်သင့်ဖြစ်နေပါပြီ။",
  "wsl.onboarding.opencodeReady": "AgentCode အဆင်သင့်ဖြစ်ပါပြီ။",
  "wsl.onboarding.installOpencodeIn": "AgentCode ကို {{distro}} တွင် ထည့်သွင်းပါ။",
  "wsl.onboarding.installOpencode": "AgentCode ကို ထည့်သွင်းပါ။",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ကို ထည့်သွင်းမထားပါ။",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux အတွက် Windows Subsystem) ကို AgentCode မှ WSL ဆာဗာ မထည့်မီတွင် လိုအပ်ပါသည်။",
  "wsl.onboarding.wslUnavailable.title": "WSL မရနိုင်ပါ။",
  "wsl.onboarding.wslUnavailable.description": "AgentCode သည် ဤစက်ပေါ်ရှိ WSL ကို အတည်မပြုနိုင်ပါ။",
  "wsl.onboarding.installWsl": "WSL ကို ထည့်သွင်းပါ။",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ထည့်သွင်းခြင်း အပြီးသတ်ရန် Windows ကို ပြန်လည်စတင်ပါ၊ ထို့နောက် AgentCode ကို ပြန်လည်ဖွင့်ပါ။",
  ...
  "help.tabs.introduction": "AgentCode Desktop သည် ယခုအခါ တက်ဘ်များအနီးတွင် တည်ဆောက်ထားသည်။",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "အလိုအလျောက်လက်ခံခြင်းသည် ယခု “တည်းဖြတ်မှုများကို လက်ခံရန်” ဖြစ်သွားပြီ",
  "toast.permissions.modeMigrated.description":
    "ဤဖိုင်တွဲရှိ တည်းဖြတ်မှုများကို အလိုအလျောက် အတည်ပြုသည်။ command များအတွက် ဆက်မေးသည်။ အပြည့်အဝ ကိုယ်တိုင်လုပ်ဆောင်စေရန် prompt အကွက်တွင် “ခွင့်ပြုချက်များကို ကျော်ရန်” ကို ရွေးပါ။",
  "toast.permissions.autoAcceptRemoved.title": "အလိုအလျောက်လက်ခံခြင်းကို ပိတ်လိုက်ပြီ",
  "toast.permissions.autoAcceptRemoved.modes":
    "ခွင့်ပြုချက်တောင်းဆိုမှုများ ထပ်မံပေါ်လာမည်။ တည်းဖြတ်မှုများကို အလိုအလျောက် အတည်ပြုရန် prompt ဘေးရှိ မုဒ်မီနူးတွင် “တည်းဖြတ်မှုများကို လက်ခံရန်” ကို ရွေးပါ သို့မဟုတ် Shift+Tab ကို နှိပ်ပါ။",
  "toast.permissions.autoAcceptRemoved.rules":
    "ခွင့်ပြုချက်တောင်းဆိုမှုများ ထပ်မံပေါ်လာမည်။ ၎င်းတို့ကို ကျော်ရန် ဤဆာဗာ၏ ခွင့်ပြုချက် config တွင် ထိုကိရိယာများကို ခွင့်ပြုပါ။",
  "toast.permissions.mode.error.title": "ခွင့်ပြုချက်မုဒ်ကို ပြောင်း၍မရပါ",
  ...
  "toast.model.selected.title": "မော်ဒယ်- {{name}}",
  "toast.model.selected.others": "အခြားကိုက်ညီမှုများ- {{count}}။ တစ်ခုရွေးရန် /model ကို run ပါ။",
  "toast.model.noMatch.title": "“{{query}}” နှင့် ကိုက်ညီသော မော်ဒယ် မရှိပါ",
  "toast.agent.noMatch.title": "“{{query}}” အမည်ရှိ အေးဂျင့် မရှိပါ",
  ...
  "toast.update.description": "AgentCode ({{version}}) ၏ ဗားရှင်းအသစ်ကို ယခု ထည့်သွင်းနိုင်ပါပြီ။",
  ...
  "error.page.report.prefix": "ဤအမှားအယွင်းကို AgentCode အဖွဲ့ထံ တိုင်ကြားပါ။",
  "error.page.report.discord": "GitHub တွင်",
  ...
  "error.chain.mcpFailed":
    'MCP ဆာဗာ "{{name}}" မအောင်မြင်ပါ။ မှတ်ချက်၊ AgentCode သည် MCP စစ်မှန်ကြောင်းအထောက်အထားမခိုင်လုံသေးပါ။',
  ...
  "sidebar.gettingStarted.line1": "AgentCode တွင် အခမဲ့မော်ဒယ်များ ပါဝင်သောကြောင့် သင်ချက်ချင်းစတင်နိုင်သည်။",
  ...
  "settings.desktop.wsl.description": "Windows တွင် WSL အတွင်းရှိ AgentCode ဆာဗာကို ဖွင့်ပါ။",
  ...
  "settings.general.row.language.description": "AgentCode အတွက် ဖော်ပြသည့် ဘာသာစကားကို ပြောင်းပါ။",
  "settings.general.permissionMode.title": "မူရင်း ခွင့်ပြုချက်မုဒ်",
  "settings.general.permissionMode.description": "ဤဖိုင်တွဲရှိ စက်ရှင်အသစ်များအတွက် အသုံးပြုသည်",
  ...
  "settings.general.row.appearance.description": "သင့်စက်ပေါ်တွင် AgentCode ကို မည်သို့မြင်သည်ကို စိတ်ကြိုက်ပြင်ဆင်ပါ။",
  "settings.general.row.colorScheme.title": "အရောင်အစီအစဉ်",
  "settings.general.row.colorScheme.description":
    "AgentCode သည် စနစ်၊ အလင်း သို့မဟုတ် အမှောင် အပြင်အဆင်ကို လိုက်နာခြင်း ရှိ၊ မရှိကို ရွေးပါ။",
  "settings.general.row.theme.title": "အပြင်အဆင်",
  "settings.general.row.theme.description": "AgentCode ကို ဘယ်လိုပုံစံနဲ့ စိတ်ကြိုက်လုပ်မလဲ။",
  ...
  "settings.updates.row.startup.description": "AgentCode စတင်သည့်အခါ အပ်ဒိတ်များအတွက် အလိုအလျောက်စစ်ဆေးပါ။",
  ...
  "settings.updates.toast.latest.description": "သင်သည် AgentCode ၏ နောက်ဆုံးဗားရှင်းကို အသုံးပြုနေပါသည်။",
