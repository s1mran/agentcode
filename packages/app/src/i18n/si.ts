export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "ලේඛනගත කිරීම",
  ...
  "desktop.menu.ariaLabel": "AgentCode මෙනුව",
  ...
  "desktop.recovery.loadFailed": "AgentCode පූරණය කිරීමට අසමත් විය",
  "desktop.recovery.terminated": "AgentCode කවුළුව අනපේක්ෂිත ලෙස අවසන් විය",
  "desktop.recovery.unresponsive": "AgentCode ප්‍රතිචාර නොදක්වයි",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode ස්ථාපනය අසාර්ථක විය",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode {{distro}} හි ස්ථාපනය කර නැත",
  "desktop.wsl.error.updateVersion":
    "AgentCode යාවත්කාලීන කිරීම අවසන් නමුත් {{distro}} තවමත් වාර්තා කරන්නේ {{installed}}; අපේක්ෂිත {{expected}}",
  ...
  "command.model.choose.hint": "[ආකෘතිය]",
  ...
  "command.agent.cycle.hint": "[නියෝජිතයා]",
  ...
  "command.permissionMode.cycle": "අවසර ප්‍රකාරය මාරු කරන්න",
  "command.permissionMode.set": "අවසර ප්‍රකාරය: {{mode}}",
  "command.permissionMode.bypass": "අවසර මඟහරින්න…",
  "command.plan": "සැලසුම් ප්‍රකාරය",
  ...
  "command.session.compact.hint": "[අවධාන උපදෙස්]",
  ...
  "command.session.export.hint": "[ගොනු නාමය]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode මඟින් සපයනු ලබන නිදහස් මාදිලි",
  ...
  "provider.connect.apiKey.description":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට ඔබගේ {{provider}} API යතුර ඇතුලත් කරන්න සහ AgentCode හි {{provider}} මාදිලි භාවිතා කරන්න.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට සහ AgentCode හි {{provider}} මාදිලි භාවිතා කිරීමට ඔබගේ අවසර කේතය එකතු කිරීමට.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "සහ ඔබගේ ගිණුම සම්බන්ධ කිරීමට පහත කේතය ඇතුළු කර {{provider}} මාදිලි AgentCode තුළ භාවිතා කරන්න.",
  ...
  "prompt.permissionMode.label": "අවසර ප්‍රකාරය",
  "prompt.permissionMode.default": "අවසර අහන්න",
  "prompt.permissionMode.default.description": "විධාන, සංස්කරණ සහ වෙබ් ප්‍රවේශයට පෙර අසයි",
  "prompt.permissionMode.acceptEdits": "සංස්කරණ පිළිගන්න",
  "prompt.permissionMode.acceptEdits.description": "මෙම ව්‍යාපෘතියේ සංස්කරණ අනුමත වේ; විධාන සඳහා තවමත් අසයි",
  "prompt.permissionMode.plan": "සැලසුම් ප්‍රකාරය",
  "prompt.permissionMode.plan.description": "කියවීමට පමණක් වූ පර්යේෂණය; සැලසුම් ගොනුව පමණක් සංස්කරණය කළ හැක",
  "prompt.permissionMode.bypassPermissions": "අවසර මඟහරින්න",
  "prompt.permissionMode.bypassPermissions.description":
    "ආරක්ෂිත මාර්ග, තීරණාත්මක මකාදැමීම් සහ ඔබගේ අසන නීති හැර, නොඅසා ක්‍රියාත්මක වේ",
  "prompt.permissionMode.dontAsk": "අහන්න එපා",
  "prompt.permissionMode.dontAsk.description": "ඇසීමට සිදුවන ඕනෑම දෙයක් ප්‍රතික්ෂේප වේ",
  ...
  "prompt.slash.badge.builtin": "ගොඩනඟන ලද",
  "prompt.slash.hint.arguments": "[තර්ක]",
  "prompt.slash.hint.positional": "<තර්ක{{n}}>",
  "prompt.slash.unknown.title": "නොදන්නා විධානය: /{{name}}",
  "prompt.slash.unknown.description": "පෙළ ලෙස යැවීමට පණිවිඩය හිස් තැනකින් අරඹන්න.",
  "prompt.slash.unavailable.title": "/{{name}} මෙහි නොමැත",
  "prompt.slash.noArguments.title": "/{{name}} තර්ක භාර නොගනී",
  ...
  "dialog.bypassPermissions.title": "අවසර මඟහරින්නද?",
  "dialog.bypassPermissions.body":
    "නියෝජිතයා නොඅසා විධාන ක්‍රියාත්මක කරයි, ගොනු සංස්කරණය කරයි සහ වෙබයට ප්‍රවේශ වේ. ආරක්ෂිත මාර්ග (.git, නියෝජිත වින්‍යාසය, ෂෙල් ආරම්භක ගොනු), තීරණාත්මක මකාදැමීම් සහ ඔබගේම අසන නීති සඳහා තවමත් අසයි; ප්‍රතික්ෂේප නීති තවමත් අදාළ වේ. ඔබ විශ්වාස කරන ව්‍යාපෘතියක පමණක් මෙය භාවිතා කරන්න.",
  "dialog.bypassPermissions.confirm": "අවසර මඟහරින්න",
  "dialog.bypassPermissions.cancel": "අවලංගු කරන්න",
  "ui.permission.always.project": "මෙම ව්‍යාපෘතියේ සෑම විටම ඉඩ දෙන්න",
  "ui.permission.always.session": "මෙම සැසිය සඳහා ඉඩ දෙන්න",
  "ui.permission.always.acceptEdits": "සියලු සංස්කරණවලට ඉඩ දෙන්න (සංස්කරණ පිළිගන්න)",
  "ui.permission.always.everything": "මෙම මෙවලම සඳහා සියල්ල",
  "ui.permission.guard.floor.title": "ආරක්ෂිත ක්‍රියාව",
  "ui.permission.guard.guard.title": "සමාලෝචනය අවශ්‍යයි",
  "ui.permission.guard.noAlways": "මෙය එක් වරක් පමණක් අනුමත කළ හැක",
  "ui.permission.writes": "ලියන ගොනු",
  "ui.question.planFeedback.placeholder": "සැලැස්මේ වෙනස් කළ යුතු දේ නියෝජිතයාට කියන්න",
  ...
  "dialog.server.description": "මෙම යෙදුම සම්බන්ධ වන්නේ කුමන AgentCode සේවාදායකයටද යන්න මාරු කරන්න.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode පරීක්ෂා කරමින්...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} හි AgentCode පරීක්ෂා කරමින්...",
  "wsl.onboarding.updatingOpencode": "AgentCode යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} හි AgentCode යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} හි AgentCode යාවත්කාලීන කරන්න.",
  "wsl.onboarding.updateOpencode": "AgentCode යාවත්කාලීන කරන්න",
  "wsl.onboarding.opencodeReadyIn": "AgentCode {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.opencodeReady": "AgentCode සූදානම්.",
  "wsl.onboarding.installOpencodeIn": "{{distro}} හි AgentCode ස්ථාපනය කරන්න.",
  "wsl.onboarding.installOpencode": "AgentCode ස්ථාපනය කරන්න",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ස්ථාපනය කර නැත",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux සඳහා උප පද්ධතිය) AgentCode WSL සේවාදායකයක් එක් කිරීමට පෙර අවශ්‍ය වේ",
  "wsl.onboarding.wslUnavailable.title": "WSL නොමැත",
  "wsl.onboarding.wslUnavailable.description": "AgentCode හට මෙම යන්ත්‍රයේ WSL සත්‍යාපනය කළ නොහැක.",
  "wsl.onboarding.installWsl": "WSL ස්ථාපනය කරන්න",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ස්ථාපනය අවසන් කිරීමට Windows නැවත අරඹන්න, පසුව AgentCode නැවත විවෘත කරන්න.",
  ...
  "help.tabs.introduction": "AgentCode ඩෙස්ක්ටොප් එක දැන් ටැබ් වටා ගොඩනගා ඇත.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "ස්වයං-පිළිගැනීම දැන් සංස්කරණ පිළිගන්න වේ",
  "toast.permissions.modeMigrated.description":
    "මෙම ෆෝල්ඩරයේ සංස්කරණ ස්වයංක්‍රීයව අනුමත වේ; විධාන සඳහා තවමත් අසයි. සම්පූර්ණ ස්වාධීනත්වය සඳහා නිර්මාපකයේ අවසර මඟහරින්න තෝරන්න.",
  "toast.permissions.autoAcceptRemoved.title": "ස්වයං-පිළිගැනීම අක්‍රිය කරන ලදී",
  "toast.permissions.autoAcceptRemoved.modes":
    "අවසර ඉල්ලීම් නැවත අසයි. සංස්කරණ ස්වයංක්‍රීයව අනුමත කිරීමට, ප්‍රොම්ප්ට් එක අසල ඇති ප්‍රකාර මෙනුවෙන් සංස්කරණ පිළිගන්න තෝරන්න හෝ Shift+Tab ඔබන්න.",
  "toast.permissions.autoAcceptRemoved.rules":
    "අවසර ඉල්ලීම් නැවත අසයි. ඒවා මඟහැරීමට, මෙම සේවාදායකයේ අවසර වින්‍යාසයේ එම මෙවලම්වලට ඉඩ දෙන්න.",
  "toast.permissions.mode.error.title": "අවසර ප්‍රකාරය වෙනස් කළ නොහැකි විය",
  ...
  "toast.model.selected.title": "ආකෘතිය: {{name}}",
  "toast.model.selected.others": "වෙනත් ගැළපීම්: {{count}}. එකක් තේරීමට /model ධාවනය කරන්න.",
  "toast.model.noMatch.title": "“{{query}}” හා ගැළපෙන ආකෘතියක් නැත",
  "toast.agent.noMatch.title": "“{{query}}” නමින් නියෝජිතයෙක් නැත",
  ...
  "toast.update.description": "AgentCode හි නව අනුවාදයක් ({{version}}) ස්ථාපනය කිරීමට දැන් තිබේ.",
  ...
  "error.page.report.prefix": "කරුණාකර මෙම දෝෂය AgentCode කණ්ඩායමට වාර්තා කරන්න",
  "error.page.report.discord": "GitHub මත",
  ...
  "error.chain.mcpFailed": 'MCP සේවාදායකය "{{name}}" අසාර්ථක විය. සටහන, AgentCode තවමත් MCP සත්‍යාපනයට සහය නොදක්වයි.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode නොමිලේ ආකෘති ඇතුළත් වන නිසා ඔබට වහාම ආරම්භ කළ හැක.",
  ...
  "app.name.desktop": "AgentCode ඩෙස්ක්ටොප්",
  ...
  "settings.desktop.wsl.description": "Windows හි WSL තුළ AgentCode සේවාදායකය ධාවනය කරන්න.",
  ...
  "settings.general.row.language.description": "AgentCode සඳහා සංදර්ශක භාෂාව වෙනස් කරන්න",
  "settings.general.permissionMode.title": "පෙරනිමි අවසර ප්‍රකාරය",
  "settings.general.permissionMode.description": "මෙම ෆෝල්ඩරයේ නව සැසි සඳහා භාවිතා වේ",
  ...
  "settings.general.row.appearance.description": "ඔබගේ උපාංගයේ AgentCode පෙනෙන ආකාරය අභිරුචිකරණය කරන්න",
  "settings.general.row.colorScheme.title": "වර්ණ පටිපාටිය",
  "settings.general.row.colorScheme.description": "AgentCode පද්ධතිය, ආලෝකය හෝ අඳුරු තේමාව අනුගමනය කරන්නේද යන්න තෝරන්න",
  "settings.general.row.theme.title": "තේමාව",
  "settings.general.row.theme.description": "AgentCode තේමා කර ඇති ආකාරය අභිරුචිකරණය කරන්න.",
  ...
  "settings.updates.row.startup.description": "AgentCode දියත් කරන විට යාවත්කාලීන සඳහා ස්වයංක්‍රීයව පරීක්ෂා කරන්න",
  ...
  "settings.updates.toast.latest.description": "ඔබ AgentCode හි නවතම අනුවාදය ධාවනය කරයි.",
