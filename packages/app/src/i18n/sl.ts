export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCode meni",
  ...
  "desktop.recovery.loadFailed": "AgentCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno AgentCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "AgentCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev AgentCode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev AgentCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "command.permissionMode.cycle": "Preklopi način dovoljenj",
  "command.permissionMode.set": "Način dovoljenj: {{mode}}",
  "command.permissionMode.bypass": "Obidi dovoljenja…",
  "command.plan": "Način načrtovanja",
  ...
  "command.session.compact.hint": "[navodila za fokus]",
  ...
  "command.session.export.hint": "[ime datoteke]",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v AgentCode.",
  ...
  "prompt.permissionMode.label": "Način dovoljenj",
  "prompt.permissionMode.default": "Sprašuj za dovoljenja",
  "prompt.permissionMode.default.description": "Vpraša pred ukazi, urejanji in dostopom do spleta",
  "prompt.permissionMode.acceptEdits": "Sprejmi urejanja",
  "prompt.permissionMode.acceptEdits.description": "Urejanja v tem projektu so odobrena; za ukaze še vedno vpraša",
  "prompt.permissionMode.plan": "Način načrtovanja",
  "prompt.permissionMode.plan.description": "Raziskovanje samo za branje; urejati je mogoče samo datoteko načrta",
  "prompt.permissionMode.bypassPermissions": "Obidi dovoljenja",
  "prompt.permissionMode.bypassPermissions.description":
    "Deluje brez spraševanja, razen za zaščitene poti, kritična brisanja in vaša pravila »Vprašajte«",
  "prompt.permissionMode.dontAsk": "Ne sprašuj",
  "prompt.permissionMode.dontAsk.description": "Vse, kar bi zahtevalo vprašanje, je zavrnjeno",
  ...
  "prompt.slash.badge.builtin": "vgrajeno",
  "prompt.slash.hint.arguments": "[argumenti]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Neznan ukaz: /{{name}}",
  "prompt.slash.unknown.description": "Sporočilo začnite s presledkom, da ga pošljete kot besedilo.",
  "prompt.slash.unavailable.title": "/{{name}} tukaj ni na voljo",
  "prompt.slash.noArguments.title": "/{{name}} ne sprejema argumentov",
  ...
  "dialog.bypassPermissions.title": "Želite obiti dovoljenja?",
  "dialog.bypassPermissions.body":
    "Agent bo zaganjal ukaze, urejal datoteke in dostopal do spleta brez spraševanja. Za zaščitene poti (.git, konfiguracija agenta, zagonske datoteke lupine), kritična brisanja in vaša lastna pravila »Vprašajte« še vedno vpraša; pravila »Zavrni« še vedno veljajo. To uporabljajte samo v projektu, ki mu zaupate.",
  "dialog.bypassPermissions.confirm": "Obidi dovoljenja",
  "dialog.bypassPermissions.cancel": "Prekliči",
  "ui.permission.always.project": "Vedno dovoli v tem projektu",
  "ui.permission.always.session": "Dovoli za to sejo",
  "ui.permission.always.acceptEdits": "Dovoli vsa urejanja (Sprejmi urejanja)",
  "ui.permission.always.everything": "vse za to orodje",
  "ui.permission.guard.floor.title": "Zaščiteno dejanje",
  "ui.permission.guard.guard.title": "Potreben je pregled",
  "ui.permission.guard.noAlways": "To je mogoče odobriti samo enkrat",
  "ui.permission.writes": "Piše v",
  "ui.question.planFeedback.placeholder": "Povejte agentu, kaj naj spremeni v načrtu",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom AgentCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje AgentCode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje AgentCode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje AgentCode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje AgentCode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite AgentCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite AgentCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko AgentCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Samodejno sprejemanje je zdaj Sprejmi urejanja",
  "toast.permissions.modeMigrated.description":
    "Urejanja v tej mapi so samodejno odobrena; za ukaze še vedno vpraša. Za popolno samostojnost v vnosnem polju izberite Obidi dovoljenja.",
  "toast.permissions.autoAcceptRemoved.title": "Samodejno sprejemanje je izklopljeno",
  "toast.permissions.autoAcceptRemoved.modes":
    "Zahteve za dovoljenje se znova prikazujejo. Če želite urejanja odobravati samodejno, v meniju načina poleg poziva izberite Sprejmi urejanja ali pritisnite Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Zahteve za dovoljenje se znova prikazujejo. Če jih želite preskočiti, dovolite ta orodja v konfiguraciji dovoljenj tega strežnika.",
  "toast.permissions.mode.error.title": "Načina dovoljenj ni bilo mogoče spremeniti",
  ...
  "toast.model.selected.others": "Druga ujemanja: {{count}}. Zaženite /model, da izberete enega.",
  "toast.model.noMatch.title": "Noben model se ne ujema z „{{query}}“",
  "toast.agent.noMatch.title": "Ni agenta z imenom „{{query}}“",
  ...
  "toast.update.description": "Nova različica AgentCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi AgentCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, AgentCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik AgentCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za AgentCode",
  "settings.general.permissionMode.title": "Privzeti način dovoljenj",
  "settings.general.permissionMode.description": "Uporablja se za nove seje v tej mapi",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako AgentCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali AgentCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo AgentCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene AgentCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico AgentCode.",
