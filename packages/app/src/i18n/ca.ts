export const dict = {
  ...
  "desktop.menu.documentation": "Documentació",
  ...
  "desktop.menu.ariaLabel": "menú AgentCode.",
  ...
  "desktop.recovery.loadFailed": "AgentCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra AgentCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "AgentCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de AgentCode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "command.permissionMode.cycle": "Canvia el mode de permisos",
  "command.permissionMode.set": "Mode de permisos: {{mode}}",
  "command.permissionMode.bypass": "Omet els permisos…",
  "command.plan": "Mode de planificació",
  ...
  "command.session.compact.hint": "[instruccions d'enfocament]",
  ...
  "command.session.export.hint": "[nom del fitxer]",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a AgentCode.",
  ...
  "prompt.permissionMode.label": "Mode de permisos",
  "prompt.permissionMode.default": "Demana permisos",
  "prompt.permissionMode.default.description": "Pregunta abans d'executar ordres, fer edicions i accedir al web",
  "prompt.permissionMode.acceptEdits": "Accepta les edicions",
  "prompt.permissionMode.acceptEdits.description":
    "Les edicions en aquest projecte s'aproven; les ordres encara pregunten",
  "prompt.permissionMode.plan": "Mode de planificació",
  "prompt.permissionMode.plan.description": "Recerca només de lectura; només es pot editar el fitxer del pla",
  "prompt.permissionMode.bypassPermissions": "Omet els permisos",
  "prompt.permissionMode.bypassPermissions.description":
    "S'executa sense preguntar, excepte camins protegits, supressions crítiques i les vostres regles de preguntar",
  "prompt.permissionMode.dontAsk": "No preguntis",
  "prompt.permissionMode.dontAsk.description": "Es denega tot el que requeriria preguntar",
  ...
  "prompt.slash.badge.builtin": "integrat",
  "prompt.slash.hint.arguments": "[arguments]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Ordre desconeguda: /{{name}}",
  "prompt.slash.unknown.description": "Comenceu el missatge amb un espai per enviar-lo com a text.",
  "prompt.slash.unavailable.title": "/{{name}} no està disponible aquí",
  "prompt.slash.noArguments.title": "/{{name}} no accepta arguments",
  ...
  "dialog.bypassPermissions.title": "Voleu ometre els permisos?",
  "dialog.bypassPermissions.body":
    "L'agent executarà ordres, editarà fitxers i accedirà al web sense preguntar. Els camins protegits (.git, configuració de l'agent, fitxers d'inici del shell), les supressions crítiques i les vostres pròpies regles de preguntar encara pregunten; les regles de denegació continuen aplicant-se. Utilitzeu-ho només en un projecte de confiança.",
  "dialog.bypassPermissions.confirm": "Omet els permisos",
  "dialog.bypassPermissions.cancel": "Cancel·la",
  "ui.permission.always.project": "Permet sempre en aquest projecte",
  "ui.permission.always.session": "Permet en aquesta sessió",
  "ui.permission.always.acceptEdits": "Permet totes les edicions (Accepta les edicions)",
  "ui.permission.always.everything": "tot per a aquesta eina",
  "ui.permission.guard.floor.title": "Acció protegida",
  "ui.permission.guard.guard.title": "Cal revisió",
  "ui.permission.guard.noAlways": "Això només es pot aprovar una vegada",
  "ui.permission.writes": "Escriu a",
  "ui.question.planFeedback.placeholder": "Digueu a l'agent què cal canviar del pla",
  ...
  "dialog.server.description": "Canvia a quin AgentCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant AgentCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant AgentCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza AgentCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu AgentCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que AgentCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AgentCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "L'acceptació automàtica ara és «Accepta les edicions»",
  "toast.permissions.modeMigrated.description":
    "Les edicions en aquesta carpeta s'aproven automàticament; les ordres encara pregunten. Trieu «Omet els permisos» al compositor per tenir autonomia total.",
  "toast.permissions.autoAcceptRemoved.title": "S'ha desactivat l'acceptació automàtica",
  "toast.permissions.autoAcceptRemoved.modes":
    "Les sol·licituds de permís tornen a aparèixer. Per aprovar edicions automàticament, trieu «Accepta les edicions» al menú de modes que hi ha al costat de la indicació o premeu Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Les sol·licituds de permís tornen a aparèixer. Per ometre-les, permeteu aquestes eines a la configuració de permisos d'aquest servidor.",
  "toast.permissions.mode.error.title": "No s'ha pogut canviar el mode de permisos",
  ...
  "toast.model.selected.others": "Altres coincidències: {{count}}. Executeu /model per triar-ne un.",
  "toast.model.noMatch.title": "Cap model coincideix amb «{{query}}»",
  "toast.agent.noMatch.title": "No hi ha cap agent anomenat «{{query}}»",
  ...
  "toast.update.description": "Una nova versió de AgentCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip AgentCode.",
  "error.page.report.discord": "a GitHub",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que AgentCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "AgentCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor AgentCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a AgentCode",
  "settings.general.permissionMode.title": "Mode de permisos per defecte",
  "settings.general.permissionMode.description": "S'utilitza per a les sessions noves en aquesta carpeta",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu AgentCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si AgentCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de AgentCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï AgentCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de AgentCode.",
