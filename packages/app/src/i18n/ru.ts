export const dict = {
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить AgentCode",
  "desktop.recovery.terminated": "Окно AgentCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "AgentCode не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление AgentCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "command.session.compact.hint": "[на чём сосредоточиться]",
  ...
  "command.session.export.hint": "[имя файла]",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в AgentCode.",
  ...
  "prompt.slash.badge.builtin": "встроенная",
  "prompt.slash.hint.arguments": "[аргументы]",
  "prompt.slash.hint.positional": "<арг{{n}}>",
  "prompt.slash.unknown.title": "Неизвестная команда: /{{name}}",
  "prompt.slash.unknown.description": "Начните сообщение с пробела, чтобы отправить его как текст.",
  "prompt.slash.unavailable.title": "/{{name}} здесь недоступна",
  "prompt.slash.noArguments.title": "/{{name}} не принимает аргументы",
  ...
  "dialog.server.description": "Выберите сервер AgentCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка AgentCode в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление AgentCode в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите AgentCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "AgentCode готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите AgentCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в AgentCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AgentCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте AgentCode.",
  ...
  "help.tabs.introduction": "Теперь работа в AgentCode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Другие совпадения: {{count}}. Выполните /model, чтобы выбрать.",
  "toast.model.noMatch.title": "Нет модели, соответствующей «{{query}}»",
  "toast.agent.noMatch.title": "Нет агента с именем «{{query}}»",
  ...
  "toast.update.description": "Новая версия AgentCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде AgentCode",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: AgentCode пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер AgentCode внутри WSL на Windows.",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид AgentCode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли AgentCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление AgentCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске AgentCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию AgentCode.",
