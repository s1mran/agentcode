...
export const dict = {
  ...
  "command.model.choose.hint": "[Modell]",
  ...
  "command.agent.cycle.hint": "[Agent]",
  ...
  "command.permissionMode.cycle": "Berechtigungsmodus wechseln",
  "command.permissionMode.set": "Berechtigungsmodus: {{mode}}",
  "command.permissionMode.bypass": "Berechtigungen umgehen…",
  "command.plan": "Planmodus",
  ...
  "command.session.compact.hint": "[Fokus-Anweisungen]",
  ...
  "command.session.export.hint": "[Dateiname]",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AgentCode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in AgentCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AgentCode zu nutzen.",
  ...
  "prompt.permissionMode.label": "Berechtigungsmodus",
  "prompt.permissionMode.default": "Nach Berechtigung fragen",
  "prompt.permissionMode.default.description": "Fragt vor Befehlen, Bearbeitungen und Webzugriffen",
  "prompt.permissionMode.acceptEdits": "Bearbeitungen akzeptieren",
  "prompt.permissionMode.acceptEdits.description":
    "Bearbeitungen in diesem Projekt werden genehmigt; bei Befehlen wird weiterhin gefragt",
  "prompt.permissionMode.plan": "Planmodus",
  "prompt.permissionMode.plan.description": "Recherche nur mit Lesezugriff; nur die Plandatei kann bearbeitet werden",
  "prompt.permissionMode.bypassPermissions": "Berechtigungen umgehen",
  "prompt.permissionMode.bypassPermissions.description":
    "Läuft ohne Nachfrage, außer bei geschützten Pfaden, kritischen Löschvorgängen und Ihren „Fragen“-Regeln",
  "prompt.permissionMode.dontAsk": "Nicht fragen",
  "prompt.permissionMode.dontAsk.description": "Alles, wofür nachgefragt würde, wird verweigert",
  ...
  "prompt.slash.badge.builtin": "integriert",
  "prompt.slash.hint.arguments": "[Argumente]",
  "prompt.slash.hint.positional": "<Arg{{n}}>",
  "prompt.slash.unknown.title": "Unbekannter Befehl: /{{name}}",
  "prompt.slash.unknown.description": "Beginnen Sie die Nachricht mit einem Leerzeichen, um sie als Text zu senden.",
  "prompt.slash.unavailable.title": "/{{name}} ist hier nicht verfügbar",
  "prompt.slash.noArguments.title": "/{{name}} akzeptiert keine Argumente",
  ...
  "dialog.bypassPermissions.title": "Berechtigungen umgehen?",
  "dialog.bypassPermissions.body":
    "Der Agent führt ohne Nachfrage Befehle aus, bearbeitet Dateien und greift auf das Web zu. Bei geschützten Pfaden (.git, Agent-Konfiguration, Shell-Startdateien), kritischen Löschvorgängen und Ihren eigenen „Fragen“-Regeln wird weiterhin gefragt; „Verweigern“-Regeln gelten weiterhin. Verwenden Sie dies nur in einem Projekt, dem Sie vertrauen.",
  "dialog.bypassPermissions.confirm": "Berechtigungen umgehen",
  "dialog.bypassPermissions.cancel": "Abbrechen",
  "ui.permission.always.project": "In diesem Projekt immer erlauben",
  "ui.permission.always.session": "Für diese Sitzung erlauben",
  "ui.permission.always.acceptEdits": "Alle Bearbeitungen erlauben (Bearbeitungen akzeptieren)",
  "ui.permission.always.everything": "alles für dieses Tool",
  "ui.permission.guard.floor.title": "Geschützte Aktion",
  "ui.permission.guard.guard.title": "Prüfung erforderlich",
  "ui.permission.guard.noAlways": "Dies kann nur einmalig genehmigt werden",
  "ui.permission.writes": "Schreibt in",
  "ui.question.planFeedback.placeholder": "Sagen Sie dem Agenten, was am Plan geändert werden soll",
  ...
  "dialog.server.description": "Wechseln Sie den AgentCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "AgentCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "AgentCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie AgentCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AgentCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "AgentCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "AgentCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie AgentCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "AgentCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor AgentCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "AgentCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann AgentCode erneut.",
  ...
  "toast.permissions.modeMigrated.title": "Automatische Akzeptanz heißt jetzt „Bearbeitungen akzeptieren“",
  "toast.permissions.modeMigrated.description":
    "Bearbeitungen in diesem Ordner werden automatisch genehmigt; bei Befehlen wird weiterhin gefragt. Wählen Sie im Eingabebereich „Berechtigungen umgehen“ für volle Autonomie.",
  "toast.permissions.autoAcceptRemoved.title": "Automatische Akzeptanz wurde deaktiviert",
  "toast.permissions.autoAcceptRemoved.modes":
    "Berechtigungsanfragen werden wieder angezeigt. Um Bearbeitungen automatisch zu genehmigen, wählen Sie „Bearbeitungen akzeptieren“ im Modusmenü neben dem Prompt oder drücken Sie Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Berechtigungsanfragen werden wieder angezeigt. Um sie zu überspringen, erlauben Sie diese Tools in der Berechtigungskonfiguration dieses Servers.",
  "toast.permissions.mode.error.title": "Berechtigungsmodus konnte nicht geändert werden",
  ...
  "toast.model.selected.title": "Modell: {{name}}",
  "toast.model.selected.others": "Weitere Treffer: {{count}}. Führen Sie /model aus, um eines auszuwählen.",
  "toast.model.noMatch.title": "Kein Modell passt zu „{{query}}“",
  "toast.agent.noMatch.title": "Kein Agent namens „{{query}}“",
  ...
  "toast.update.description": "Eine neue Version von AgentCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem AgentCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: AgentCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "AgentCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "AgentCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "AgentCode Desktop",
  ...
  "settings.desktop.wsl.description": "AgentCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für AgentCode ändern",
  "settings.general.permissionMode.title": "Standard-Berechtigungsmodus",
  "settings.general.permissionMode.description": "Wird für neue Sitzungen in diesem Ordner verwendet",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie AgentCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob AgentCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von AgentCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von AgentCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "AgentCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von AgentCode wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "AgentCode-Menü",
  ...
  "desktop.recovery.loadFailed": "AgentCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das AgentCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "AgentCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das AgentCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "AgentCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
