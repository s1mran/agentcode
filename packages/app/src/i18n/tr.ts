...
export const dict = {
  ...
  "desktop.menu.ariaLabel": "AgentCode menüsü",
  ...
  "desktop.recovery.loadFailed": "AgentCode yüklenemedi",
  "desktop.recovery.terminated": "AgentCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "AgentCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "AgentCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "command.session.compact.hint": "[odak talimatları]",
  ...
  "command.session.export.hint": "[dosya adı]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AgentCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak AgentCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AgentCode'da {{provider}} modellerini kullanın.",
  ...
  "prompt.slash.badge.builtin": "yerleşik",
  "prompt.slash.hint.arguments": "[argümanlar]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Bilinmeyen komut: /{{name}}",
  "prompt.slash.unknown.description": "Metin olarak göndermek için mesaja bir boşlukla başlayın.",
  "prompt.slash.unavailable.title": "/{{name}} burada kullanılamıyor",
  "prompt.slash.noArguments.title": "/{{name}} argüman almaz",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AgentCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AgentCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "AgentCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde AgentCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki AgentCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "AgentCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde AgentCode hazır.",
  "wsl.onboarding.opencodeReady": "AgentCode hazır.",
  "wsl.onboarding.installOpencodeIn": "AgentCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "AgentCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "AgentCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından AgentCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "AgentCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.model.selected.others": "Diğer eşleşmeler: {{count}}. Birini seçmek için /model çalıştırın.",
  "toast.model.noMatch.title": "“{{query}}” ile eşleşen model yok",
  "toast.agent.noMatch.title": "“{{query}}” adlı ajan yok",
  ...
  "toast.update.description": "AgentCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AgentCode ekibine",
  "error.page.report.discord": "GitHub üzerinden bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: AgentCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AgentCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "AgentCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.appearance.description": "AgentCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AgentCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AgentCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AgentCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AgentCode'un en son sürümünü kullanıyorsunuz.",
