export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać AgentCode",
  "desktop.recovery.terminated": "Okno AgentCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "AgentCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować AgentCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja AgentCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "command.permissionMode.cycle": "Przełącz tryb uprawnień",
  "command.permissionMode.set": "Tryb uprawnień: {{mode}}",
  "command.permissionMode.bypass": "Pomiń uprawnienia…",
  "command.plan": "Tryb planowania",
  ...
  "command.session.compact.hint": "[instrukcje skupienia]",
  ...
  "command.session.export.hint": "[nazwa pliku]",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AgentCode.",
  ...
  "prompt.permissionMode.label": "Tryb uprawnień",
  "prompt.permissionMode.default": "Pytaj o uprawnienia",
  "prompt.permissionMode.default.description": "Pyta przed poleceniami, zmianami i dostępem do sieci",
  "prompt.permissionMode.acceptEdits": "Akceptuj zmiany",
  "prompt.permissionMode.acceptEdits.description":
    "Zmiany w tym projekcie są zatwierdzane; przed poleceniami nadal pyta",
  "prompt.permissionMode.plan": "Tryb planowania",
  "prompt.permissionMode.plan.description": "Analiza tylko do odczytu; edytować można wyłącznie plik planu",
  "prompt.permissionMode.bypassPermissions": "Pomiń uprawnienia",
  "prompt.permissionMode.bypassPermissions.description":
    "Działa bez pytania, z wyjątkiem chronionych ścieżek, krytycznych usunięć i Twoich reguł „Pytaj”",
  "prompt.permissionMode.dontAsk": "Nie pytaj",
  "prompt.permissionMode.dontAsk.description": "Wszystko, co wymagałoby pytania, jest odrzucane",
  ...
  "prompt.slash.badge.builtin": "wbudowane",
  "prompt.slash.hint.arguments": "[argumenty]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Nieznane polecenie: /{{name}}",
  "prompt.slash.unknown.description": "Zacznij wiadomość od spacji, aby wysłać ją jako tekst.",
  "prompt.slash.unavailable.title": "/{{name}} nie jest tu dostępne",
  "prompt.slash.noArguments.title": "/{{name}} nie przyjmuje argumentów",
  ...
  "dialog.bypassPermissions.title": "Pominąć uprawnienia?",
  "dialog.bypassPermissions.body":
    "Agent będzie uruchamiał polecenia, edytował pliki i korzystał z sieci bez pytania. W przypadku chronionych ścieżek (.git, konfiguracja agenta, pliki startowe powłoki), krytycznych usunięć i Twoich własnych reguł „Pytaj” nadal pojawi się pytanie; reguły „Odmów” nadal obowiązują. Używaj tego tylko w projekcie, któremu ufasz.",
  "dialog.bypassPermissions.confirm": "Pomiń uprawnienia",
  "dialog.bypassPermissions.cancel": "Anuluj",
  "ui.permission.always.project": "Zawsze zezwalaj w tym projekcie",
  "ui.permission.always.session": "Zezwól w tej sesji",
  "ui.permission.always.acceptEdits": "Zezwól na wszystkie zmiany (Akceptuj zmiany)",
  "ui.permission.always.everything": "wszystko dla tego narzędzia",
  "ui.permission.guard.floor.title": "Chroniona operacja",
  "ui.permission.guard.guard.title": "Wymaga przeglądu",
  "ui.permission.guard.noAlways": "Można to zatwierdzić tylko jednorazowo",
  "ui.permission.writes": "Zapisuje do",
  "ui.question.planFeedback.placeholder": "Powiedz agentowi, co zmienić w planie",
  ...
  "dialog.server.description": "Przełącz serwer AgentCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie AgentCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie AgentCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj AgentCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj AgentCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim AgentCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automatyczna akceptacja to teraz tryb Akceptuj zmiany",
  "toast.permissions.modeMigrated.description":
    "Zmiany w tym folderze są zatwierdzane automatycznie; przed poleceniami nadal pyta. Aby uzyskać pełną autonomię, wybierz Pomiń uprawnienia w edytorze wiadomości.",
  "toast.permissions.autoAcceptRemoved.title": "Automatyczna akceptacja została wyłączona",
  "toast.permissions.autoAcceptRemoved.modes":
    "Żądania uprawnień znów się pojawiają. Aby automatycznie zatwierdzać zmiany, wybierz Akceptuj zmiany w menu trybu obok pola zapytania lub naciśnij Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Żądania uprawnień znów się pojawiają. Aby je pominąć, zezwól na te narzędzia w konfiguracji uprawnień tego serwera.",
  "toast.permissions.mode.error.title": "Nie udało się zmienić trybu uprawnień",
  ...
  "toast.model.selected.others": "Inne dopasowania: {{count}}. Uruchom /model, aby wybrać jeden.",
  "toast.model.noMatch.title": "Żaden model nie pasuje do „{{query}}”",
  "toast.agent.noMatch.title": "Brak agenta o nazwie „{{query}}”",
  ...
  "toast.update.description": "Nowa wersja AgentCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AgentCode",
  "error.page.report.discord": "na GitHubie",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: AgentCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "AgentCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer AgentCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AgentCode",
  "settings.general.permissionMode.title": "Domyślny tryb uprawnień",
  "settings.general.permissionMode.description": "Używany dla nowych sesji w tym folderze",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd AgentCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AgentCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AgentCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AgentCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AgentCode.",
