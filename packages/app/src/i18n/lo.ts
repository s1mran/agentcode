export const dict = {
  ...
  "desktop.menu.documentation": "ເອກະສານ",
  ...
  "desktop.menu.ariaLabel": "ເມນູ AgentCode",
  ...
  "desktop.recovery.loadFailed": "AgentCode ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ AgentCode ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "AgentCode ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installOpencode": "ການຕິດຕັ້ງ AgentCode ລົ້ມເຫລວ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ AgentCode ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "command.model.choose.hint": "[ຕົວແບບ]",
  ...
  "command.agent.cycle.hint": "[ຕົວແທນ]",
  ...
  "command.permissionMode.cycle": "ສະຫຼັບໂໝດການອະນຸຍາດ",
  "command.permissionMode.set": "ໂໝດການອະນຸຍາດ: {{mode}}",
  "command.permissionMode.bypass": "ຂ້າມການອະນຸຍາດ…",
  "command.plan": "ໂໝດວາງແຜນ",
  ...
  "command.session.compact.hint": "[ຄຳແນະນຳຈຸດເນັ້ນ]",
  ...
  "command.session.export.hint": "[ຊື່ໄຟລ໌]",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ AgentCode",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ AgentCode.",
  ...
  "prompt.permissionMode.label": "ໂໝດການອະນຸຍາດ",
  "prompt.permissionMode.default": "ຖາມການອະນຸຍາດ",
  "prompt.permissionMode.default.description": "ຖາມກ່ອນເອີ້ນໃຊ້ຄໍາສັ່ງ, ແກ້ໄຂ ແລະ ເຂົ້າເຖິງເວັບ",
  "prompt.permissionMode.acceptEdits": "ຍອມຮັບການແກ້ໄຂ",
  "prompt.permissionMode.acceptEdits.description": "ການແກ້ໄຂໃນໂຄງການນີ້ຖືກອະນຸມັດ; ຄໍາສັ່ງຍັງຖາມຢູ່",
  "prompt.permissionMode.plan": "ໂໝດວາງແຜນ",
  "prompt.permissionMode.plan.description": "ການຄົ້ນຄວ້າແບບອ່ານຢ່າງດຽວ; ແກ້ໄຂໄດ້ສະເພາະໄຟລ໌ແຜນເທົ່ານັ້ນ",
  "prompt.permissionMode.bypassPermissions": "ຂ້າມການອະນຸຍາດ",
  "prompt.permissionMode.bypassPermissions.description":
    "ເຮັດວຽກໂດຍບໍ່ຖາມ, ຍົກເວັ້ນເສັ້ນທາງທີ່ຖືກປ້ອງກັນ, ການລຶບທີ່ສໍາຄັນ ແລະ ກົດການຖາມຂອງທ່ານ",
  "prompt.permissionMode.dontAsk": "ບໍ່ຖາມ",
  "prompt.permissionMode.dontAsk.description": "ທຸກຢ່າງທີ່ຕ້ອງຖາມຈະຖືກປະຕິເສດ",
  ...
  "prompt.slash.badge.builtin": "ມີໃນຕົວ",
  "prompt.slash.hint.arguments": "[ອາກິວເມັນ]",
  "prompt.slash.hint.positional": "<ອາກິວ{{n}}>",
  "prompt.slash.unknown.title": "ຄຳສັ່ງທີ່ບໍ່ຮູ້ຈັກ: /{{name}}",
  "prompt.slash.unknown.description": "ເລີ່ມຂໍ້ຄວາມດ້ວຍຍະຫວ່າງເພື່ອສົ່ງເປັນຂໍ້ຄວາມ.",
  "prompt.slash.unavailable.title": "/{{name}} ບໍ່ມີຢູ່ບ່ອນນີ້",
  "prompt.slash.noArguments.title": "/{{name}} ບໍ່ຮັບອາກິວເມັນ",
  ...
  "dialog.bypassPermissions.title": "ຂ້າມການອະນຸຍາດບໍ?",
  "dialog.bypassPermissions.body":
    "ຕົວແທນຈະເອີ້ນໃຊ້ຄໍາສັ່ງ, ແກ້ໄຂໄຟລ໌ ແລະ ເຂົ້າເຖິງເວັບໂດຍບໍ່ຖາມ. ເສັ້ນທາງທີ່ຖືກປ້ອງກັນ (.git, ການຕັ້ງຄ່າຕົວແທນ, ໄຟລ໌ເລີ່ມຕົ້ນ shell), ການລຶບທີ່ສໍາຄັນ ແລະ ກົດການຖາມຂອງທ່ານເອງຍັງຖາມຢູ່; ກົດການປະຕິເສດຍັງມີຜົນ. ໃຊ້ສິ່ງນີ້ສະເພາະໃນໂຄງການທີ່ທ່ານໄວ້ວາງໃຈເທົ່ານັ້ນ.",
  "dialog.bypassPermissions.confirm": "ຂ້າມການອະນຸຍາດ",
  "dialog.bypassPermissions.cancel": "ຍົກເລີກ",
  "ui.permission.always.project": "ອະນຸຍາດສະເໝີໃນໂຄງການນີ້",
  "ui.permission.always.session": "ອະນຸຍາດສໍາລັບເຊດຊັນນີ້",
  "ui.permission.always.acceptEdits": "ອະນຸຍາດການແກ້ໄຂທັງໝົດ (ຍອມຮັບການແກ້ໄຂ)",
  "ui.permission.always.everything": "ທຸກຢ່າງສໍາລັບເຄື່ອງມືນີ້",
  "ui.permission.guard.floor.title": "ການກະທໍາທີ່ຖືກປ້ອງກັນ",
  "ui.permission.guard.guard.title": "ຕ້ອງທົບທວນ",
  "ui.permission.guard.noAlways": "ອັນນີ້ອະນຸມັດໄດ້ພຽງຄັ້ງດຽວ",
  "ui.permission.writes": "ຂຽນໄປທີ່",
  "ui.question.planFeedback.placeholder": "ບອກຕົວແທນວ່າຈະປ່ຽນຫຍັງໃນແຜນ",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ AgentCode ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingOpencode": "ກຳລັງກວດສອບ AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "ກຳລັງກວດສອບ AgentCode ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "ກຳລັງອັບເດດ AgentCode ໃນ {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ອັບເດດ AgentCode ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpencodeIn": "ຕິດຕັ້ງ AgentCode ໃນ {{distro}}.",
  "wsl.onboarding.installOpencode": "ຕິດຕັ້ງ AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ AgentCode ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ AgentCode ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "AgentCode Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "ການຍອມຮັບອັດຕະໂນມັດຕອນນີ້ແມ່ນ “ຍອມຮັບການແກ້ໄຂ”",
  "toast.permissions.modeMigrated.description":
    "ການແກ້ໄຂໃນໂຟນເດີນີ້ຖືກອະນຸມັດອັດຕະໂນມັດ; ຄໍາສັ່ງຍັງຖາມຢູ່. ເລືອກ “ຂ້າມການອະນຸຍາດ” ໃນຊ່ອງພິມ ເພື່ອໃຫ້ເຮັດວຽກເອງໄດ້ເຕັມທີ່.",
  "toast.permissions.autoAcceptRemoved.title": "ການຍອມຮັບອັດຕະໂນມັດຖືກປິດແລ້ວ",
  "toast.permissions.autoAcceptRemoved.modes":
    "ຈະມີການຮ້ອງຂໍການອະນຸຍາດອີກຄັ້ງ. ເພື່ອອະນຸມັດການແກ້ໄຂອັດຕະໂນມັດ, ເລືອກ “ຍອມຮັບການແກ້ໄຂ” ໃນເມນູໂໝດຂ້າງ Prompt ຫຼື ກົດ Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "ຈະມີການຮ້ອງຂໍການອະນຸຍາດອີກຄັ້ງ. ເພື່ອຂ້າມ, ໃຫ້ອະນຸຍາດເຄື່ອງມືເຫຼົ່ານັ້ນໃນການຕັ້ງຄ່າການອະນຸຍາດຂອງເຊີບເວີນີ້.",
  "toast.permissions.mode.error.title": "ບໍ່ສາມາດປ່ຽນໂໝດການອະນຸຍາດໄດ້",
  "toast.model.none.title": "ບໍ່ໄດ້ເລືອກຕົວແບບ",
  "toast.model.none.description": "ເຊື່ອມຕໍ່ຜູ້ໃຫ້ບໍລິການເພື່ອສະຫຼຸບກອງປະຊຸມນີ້",
  "toast.model.selected.title": "ຕົວແບບ: {{name}}",
  "toast.model.selected.others": "ລາຍການທີ່ກົງກັນອື່ນ: {{count}}. ແລ່ນ /model ເພື່ອເລືອກໜຶ່ງ.",
  "toast.model.noMatch.title": "ບໍ່ມີຕົວແບບທີ່ກົງກັບ “{{query}}”",
  "toast.agent.noMatch.title": "ບໍ່ມີຕົວແທນຊື່ “{{query}}”",
  ...
  "toast.update.description": "ເວີຊັນໃໝ່ຂອງ AgentCode ({{version}}) ມີໃຫ້ຕິດຕັ້ງແລ້ວ.",
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ AgentCode",
  ...
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, AgentCode ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ AgentCode ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ AgentCode",
  "settings.general.permissionMode.title": "ໂໝດການອະນຸຍາດເລີ່ມຕົ້ນ",
  "settings.general.permissionMode.description": "ໃຊ້ສໍາລັບເຊດຊັນໃໝ່ໃນໂຟນເດີນີ້",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ AgentCode ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ AgentCode ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ AgentCode ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ AgentCode ເປີດ",
  ...
  "settings.updates.toast.latest.description": "ທ່ານກຳລັງໃຊ້ AgentCode ເວີຊັນຫຼ້າສຸດ.",
