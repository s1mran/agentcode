export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "AgentCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "AgentCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "AgentCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "command.model.choose.hint": "[mudel]",
  ...
  "command.permissionMode.cycle": "Vaheta lubade režiimi",
  "command.permissionMode.set": "Lubade režiim: {{mode}}",
  "command.permissionMode.bypass": "Jäta load vahele…",
  "command.plan": "Planeerimisrežiim",
  ...
  "command.session.compact.hint": "[fookusjuhised]",
  ...
  "command.session.export.hint": "[failinimi]",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid AgentCode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises AgentCode.",
  ...
  "prompt.permissionMode.label": "Lubade režiim",
  "prompt.permissionMode.default": "Küsi luba",
  "prompt.permissionMode.default.description": "Küsib enne käske, muudatusi ja veebijuurdepääsu",
  "prompt.permissionMode.acceptEdits": "Aktsepteeri muudatused",
  "prompt.permissionMode.acceptEdits.description":
    "Selle projekti muudatused kinnitatakse; käskude puhul küsitakse endiselt",
  "prompt.permissionMode.plan": "Planeerimisrežiim",
  "prompt.permissionMode.plan.description": "Kirjutuskaitstud uurimine; muuta saab ainult plaanifaili",
  "prompt.permissionMode.bypassPermissions": "Jäta load vahele",
  "prompt.permissionMode.bypassPermissions.description":
    "Töötab küsimata, välja arvatud kaitstud teed, kriitilised kustutamised ja teie küsimisreeglid",
  "prompt.permissionMode.dontAsk": "Ära küsi",
  "prompt.permissionMode.dontAsk.description": "Kõik, mille puhul küsitaks, keelatakse",
  ...
  "prompt.slash.badge.builtin": "sisseehitatud",
  "prompt.slash.hint.arguments": "[argumendid]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Tundmatu käsk: /{{name}}",
  "prompt.slash.unknown.description": "Teksti saatmiseks alustage sõnumit tühikuga.",
  "prompt.slash.unavailable.title": "/{{name}} pole siin saadaval",
  "prompt.slash.noArguments.title": "/{{name}} ei võta argumente",
  ...
  "dialog.bypassPermissions.title": "Kas jätta load vahele?",
  "dialog.bypassPermissions.body":
    "Agent käivitab käske, muudab faile ja kasutab veebi küsimata. Kaitstud teede (.git, agendi konfiguratsioon, shelli käivitusfailid), kriitiliste kustutamiste ja teie enda küsimisreeglite puhul küsitakse endiselt; keelureeglid kehtivad endiselt. Kasutage seda ainult projektis, mida usaldate.",
  "dialog.bypassPermissions.confirm": "Jäta load vahele",
  "dialog.bypassPermissions.cancel": "Tühista",
  "ui.permission.always.project": "Luba alati selles projektis",
  "ui.permission.always.session": "Luba selle seansi jaoks",
  "ui.permission.always.acceptEdits": "Luba kõik muudatused (Aktsepteeri muudatused)",
  "ui.permission.always.everything": "kõik selle tööriista jaoks",
  "ui.permission.guard.floor.title": "Kaitstud toiming",
  "ui.permission.guard.guard.title": "Vajab ülevaatust",
  "ui.permission.guard.noAlways": "Seda saab kinnitada ainult ühe korra",
  "ui.permission.writes": "Kirjutamise sihtkohad",
  "ui.question.planFeedback.placeholder": "Öelge agendile, mida plaanis muuta",
  ...
  "dialog.server.description": "Lülitage, millise AgentCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "AgentCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AgentCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "AgentCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda AgentCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige AgentCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui AgentCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automaatne aktsepteerimine on nüüd „Aktsepteeri muudatused“",
  "toast.permissions.modeMigrated.description":
    "Selle kausta muudatused kinnitatakse automaatselt; käskude puhul küsitakse endiselt. Täieliku autonoomia jaoks valige sisestusväljal „Jäta load vahele“.",
  "toast.permissions.autoAcceptRemoved.title": "Automaatne aktsepteerimine lülitati välja",
  "toast.permissions.autoAcceptRemoved.modes":
    "Loataotlusi kuvatakse taas. Muudatuste automaatseks kinnitamiseks valige viiba kõrval olevast režiimimenüüst „Aktsepteeri muudatused“ või vajutage Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Loataotlusi kuvatakse taas. Nende vahelejätmiseks lubage need tööriistad selle serveri lubade konfiguratsioonis.",
  "toast.permissions.mode.error.title": "Lubade režiimi ei õnnestunud muuta",
  ...
  "toast.model.selected.title": "Mudel: {{name}}",
  "toast.model.selected.others": "Muud vasted: {{count}}. Ühe valimiseks käivitage /model.",
  "toast.model.noMatch.title": "Ükski mudel ei vasta päringule „{{query}}“",
  "toast.agent.noMatch.title": "Agenti nimega „{{query}}“ pole",
  ...
  "toast.update.description": "Rakenduse AgentCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast AgentCode meeskonnale",
  "error.page.report.discord": "GitHubis",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, AgentCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "AgentCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage AgentCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke AgentCode kuvakeelt",
  "settings.general.permissionMode.title": "Vaikimisi lubade režiim",
  "settings.general.permissionMode.description": "Kasutatakse selle kausta uute seansside jaoks",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas AgentCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas AgentCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas AgentCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui AgentCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse AgentCode uusimat versiooni.",
