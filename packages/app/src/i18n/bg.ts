export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът AgentCode приключи неочаквано",
  "desktop.recovery.unresponsive": "AgentCode не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на AgentCode е неуспешно",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCode актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "command.permissionMode.cycle": "Смяна на режима на разрешения",
  "command.permissionMode.set": "Режим на разрешения: {{mode}}",
  "command.permissionMode.bypass": "Заобикаляне на разрешенията…",
  "command.plan": "Режим на планиране",
  ...
  "command.session.compact.hint": "[инструкции за фокус]",
  ...
  "command.session.export.hint": "[име на файл]",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в AgentCode.",
  ...
  "prompt.permissionMode.label": "Режим на разрешения",
  "prompt.permissionMode.default": "Питане за разрешения",
  "prompt.permissionMode.default.description": "Пита преди команди, редакции и достъп до уеб",
  "prompt.permissionMode.acceptEdits": "Приемане на редакции",
  "prompt.permissionMode.acceptEdits.description":
    "Редакциите в този проект се одобряват; за командите все още се пита",
  "prompt.permissionMode.plan": "Режим на планиране",
  "prompt.permissionMode.plan.description": "Проучване само за четене; може да се редактира само файлът на плана",
  "prompt.permissionMode.bypassPermissions": "Заобикаляне на разрешенията",
  "prompt.permissionMode.bypassPermissions.description":
    "Работи без питане, освен за защитени пътища, критични изтривания и вашите правила за питане",
  "prompt.permissionMode.dontAsk": "Без питане",
  "prompt.permissionMode.dontAsk.description": "Всичко, за което би се питало, се отказва",
  ...
  "prompt.slash.badge.builtin": "вграден",
  "prompt.slash.hint.arguments": "[аргументи]",
  "prompt.slash.hint.positional": "<арг{{n}}>",
  "prompt.slash.unknown.title": "Непозната команда: /{{name}}",
  "prompt.slash.unknown.description": "Започнете съобщението с интервал, за да го изпратите като текст.",
  "prompt.slash.unavailable.title": "/{{name}} не е налична тук",
  "prompt.slash.noArguments.title": "/{{name}} не приема аргументи",
  ...
  "dialog.bypassPermissions.title": "Заобикаляне на разрешенията?",
  "dialog.bypassPermissions.body":
    "Агентът ще изпълнява команди, ще редактира файлове и ще достъпва уеб без питане. За защитени пътища (.git, конфигурация на агента, стартови файлове на shell), критични изтривания и вашите собствени правила за питане все още се пита; правилата за отказ продължават да важат. Използвайте това само в проект, на който имате доверие.",
  "dialog.bypassPermissions.confirm": "Заобикаляне на разрешенията",
  "dialog.bypassPermissions.cancel": "Отказ",
  "ui.permission.always.project": "Винаги разрешавай в този проект",
  "ui.permission.always.session": "Разреши за тази сесия",
  "ui.permission.always.acceptEdits": "Разреши всички редакции (Приемане на редакции)",
  "ui.permission.always.everything": "всичко за този инструмент",
  "ui.permission.guard.floor.title": "Защитено действие",
  "ui.permission.guard.guard.title": "Нужен е преглед",
  "ui.permission.guard.noAlways": "Това може да бъде одобрено само еднократно",
  "ui.permission.writes": "Записва в",
  "ui.question.planFeedback.placeholder": "Кажете на агента какво да промени в плана",
  ...
  "dialog.server.description": "Превключете към кой AgentCode сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се AgentCode в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Актуализиране на AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на AgentCode в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте AgentCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode е готов в {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте AgentCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте AgentCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди AgentCode да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "AgentCode не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново AgentCode.",
  ...
  "help.tabs.introduction": "AgentCode Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Автоматичното приемане вече е „Приемане на редакции“",
  "toast.permissions.modeMigrated.description":
    "Редакциите в тази папка се одобряват автоматично; за командите все още се пита. За пълна автономност изберете „Заобикаляне на разрешенията“ в полето за въвеждане.",
  "toast.permissions.autoAcceptRemoved.title": "Автоматичното приемане е изключено",
  "toast.permissions.autoAcceptRemoved.modes":
    "Заявките за разрешение отново се показват. За да одобрявате редакциите автоматично, изберете „Приемане на редакции“ в менюто с режими до подканата или натиснете Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Заявките за разрешение отново се показват. За да ги пропуснете, разрешете тези инструменти в конфигурацията за разрешения на този сървър.",
  "toast.permissions.mode.error.title": "Режимът на разрешения не може да бъде променен",
  ...
  "toast.model.selected.others": "Други съвпадения: {{count}}. Изпълнете /model, за да изберете.",
  "toast.model.noMatch.title": "Няма модел, съвпадащ с „{{query}}“",
  "toast.agent.noMatch.title": "Няма агент с име „{{query}}“",
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на AgentCode ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на AgentCode",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че AgentCode все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра AgentCode вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за AgentCode",
  "settings.general.permissionMode.title": "Режим на разрешения по подразбиране",
  "settings.general.permissionMode.description": "Използва се за нови сесии в тази папка",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда AgentCode на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали AgentCode следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично AgentCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на AgentCode",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на AgentCode.",
