...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "AgentCode se nije uspio učitati",
  "Prozor aplikacije AgentCode neočekivano je zatvoren",
  "AgentCode ne reagira",
  ...
  "Instalacija aplikacije AgentCode nije uspjela",
  ...
  "AgentCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije AgentCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "command.permissionMode.cycle": "Promijeni način dopuštenja",
  "command.permissionMode.set": "Način dopuštenja: {{mode}}",
  "command.permissionMode.bypass": "Zaobiđi dopuštenja…",
  ...
  "command.session.compact.hint": "[upute za fokus]",
  ...
  "command.session.export.hint": "[naziv datoteke]",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi AgentCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u AgentCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u AgentCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u AgentCode.",
  ...
  "prompt.permissionMode.label": "Način dopuštenja",
  "prompt.permissionMode.default": "Traži dopuštenja",
  "prompt.permissionMode.default.description": "Pita prije naredbi, uređivanja i pristupa webu",
  "prompt.permissionMode.acceptEdits": "Prihvati uređivanja",
  "prompt.permissionMode.acceptEdits.description":
    "Uređivanja u ovom projektu se odobravaju; za naredbe se i dalje pita",
  ...
  "prompt.permissionMode.bypassPermissions": "Zaobiđi dopuštenja",
  "prompt.permissionMode.bypassPermissions.description":
    "Radi bez pitanja, osim za zaštićene putanje, kritična brisanja i vaša pravila za pitanje",
  "prompt.permissionMode.dontAsk": "Ne pitaj",
  "prompt.permissionMode.dontAsk.description": "Odbija se sve za što bi se pitalo",
  ...
  "prompt.slash.badge.builtin": "ugrađeno",
  "prompt.slash.hint.arguments": "[argumenti]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Nepoznata naredba: /{{name}}",
  "prompt.slash.unknown.description": "Započnite poruku razmakom da biste je poslali kao tekst.",
  "prompt.slash.unavailable.title": "/{{name}} ovdje nije dostupna",
  "prompt.slash.noArguments.title": "/{{name}} ne prima argumente",
  ...
  "dialog.bypassPermissions.title": "Zaobići dopuštenja?",
  "dialog.bypassPermissions.body":
    "Agent će pokretati naredbe, uređivati datoteke i pristupati webu bez pitanja. Za zaštićene putanje (.git, konfiguracija agenta, datoteke za pokretanje ljuske), kritična brisanja i vaša vlastita pravila za pitanje i dalje se pita; pravila zabrane i dalje vrijede. Koristite ovo samo u projektu kojem vjerujete.",
  "dialog.bypassPermissions.confirm": "Zaobiđi dopuštenja",
  "dialog.bypassPermissions.cancel": "Otkazati",
  "ui.permission.always.project": "Uvijek dopusti u ovom projektu",
  "ui.permission.always.session": "Dopusti za ovu sesiju",
  "ui.permission.always.acceptEdits": "Dopusti sva uređivanja (Prihvati uređivanja)",
  ...
  "ui.question.planFeedback.placeholder": "Recite agentu što treba promijeniti u planu",
  ...
  "dialog.server.description": "Promijenite na koji se AgentCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera AgentCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AgentCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte AgentCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte AgentCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što AgentCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "AgentCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite AgentCode.",
  ...
  "help.tabs.introduction": "Radna površina AgentCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "Automatsko prihvaćanje sada je „Prihvati uređivanja”",
  "toast.permissions.modeMigrated.description":
    "Uređivanja u ovoj mapi odobravaju se automatski; za naredbe se i dalje pita. Za potpunu autonomiju odaberite „Zaobiđi dopuštenja” u polju za upit.",
  "toast.permissions.autoAcceptRemoved.title": "Automatsko prihvaćanje je isključeno",
  "toast.permissions.autoAcceptRemoved.modes":
    "Ponovno ćete dobivati zahtjeve za dopuštenje. Za automatsko odobravanje uređivanja odaberite „Prihvati uređivanja” u izborniku načina pokraj upita ili pritisnite Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Ponovno ćete dobivati zahtjeve za dopuštenje. Da ih preskočite, dopustite te alate u konfiguraciji dopuštenja ovog poslužitelja.",
  "toast.permissions.mode.error.title": "Nije moguće promijeniti način dopuštenja",
  ...
  "toast.model.selected.others": "Ostala podudaranja: {{count}}. Pokrenite /model da odaberete jedan.",
  "toast.model.noMatch.title": "Nijedan model ne odgovara „{{query}}“",
  "toast.agent.noMatch.title": "Nema agenta imena „{{query}}“",
  ...
  "toast.update.description": "Nova verzija AgentCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku AgentCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, AgentCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "AgentCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite AgentCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za AgentCode",
  "settings.general.permissionMode.title": "Zadani način dopuštenja",
  "settings.general.permissionMode.description": "Koristi se za nove sesije u ovoj mapi",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako AgentCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li AgentCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je AgentCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se AgentCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju AgentCode.",
