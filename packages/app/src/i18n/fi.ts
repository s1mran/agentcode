export const dict = {
  ...
  "command.model.choose.hint": "[malli]",
  ...
  "command.agent.cycle.hint": "[agentti]",
  ...
  "command.permissionMode.cycle": "Vaihda käyttöoikeustilaa",
  "command.permissionMode.set": "Käyttöoikeustila: {{mode}}",
  "command.permissionMode.bypass": "Ohita käyttöoikeudet…",
  "command.plan": "Suunnittelutila",
  ...
  "command.session.compact.hint": "[tarkennusohjeet]",
  ...
  "command.session.export.hint": "[tiedostonimi]",
  ...
  "dialog.model.unpaid.freeModels.title": "AgentCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AgentCodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja AgentCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AgentCodessa.",
  ...
  "prompt.permissionMode.label": "Käyttöoikeustila",
  "prompt.permissionMode.default": "Kysy lupaa",
  "prompt.permissionMode.default.description": "Kysyy ennen komentoja, muokkauksia ja verkon käyttöä",
  "prompt.permissionMode.acceptEdits": "Hyväksy muokkaukset",
  "prompt.permissionMode.acceptEdits.description": "Tämän projektin muokkaukset hyväksytään; komennoista kysytään yhä",
  "prompt.permissionMode.plan": "Suunnittelutila",
  "prompt.permissionMode.plan.description": "Tutkimus vain lukuoikeuksin; vain suunnitelmatiedostoa voi muokata",
  "prompt.permissionMode.bypassPermissions": "Ohita käyttöoikeudet",
  "prompt.permissionMode.bypassPermissions.description":
    "Toimii kysymättä, paitsi suojatuissa poluissa, kriittisissä poistoissa ja omissa kysy-säännöissäsi",
  "prompt.permissionMode.dontAsk": "Älä kysy",
  "prompt.permissionMode.dontAsk.description": "Kaikki, mistä kysyttäisiin, kielletään",
  ...
  "prompt.slash.badge.builtin": "sisäänrakennettu",
  "prompt.slash.hint.arguments": "[argumentit]",
  "prompt.slash.hint.positional": "<arg{{n}}>",
  "prompt.slash.unknown.title": "Tuntematon komento: /{{name}}",
  "prompt.slash.unknown.description": "Aloita viesti välilyönnillä lähettääksesi sen tekstinä.",
  "prompt.slash.unavailable.title": "/{{name}} ei ole käytettävissä tässä",
  "prompt.slash.noArguments.title": "/{{name}} ei ota argumentteja",
  ...
  "dialog.bypassPermissions.title": "Ohitetaanko käyttöoikeudet?",
  "dialog.bypassPermissions.body":
    "Agentti suorittaa komentoja, muokkaa tiedostoja ja käyttää verkkoa kysymättä. Suojatuista poluista (.git, agentin määritykset, shellin käynnistystiedostot), kriittisistä poistoista ja omista kysy-säännöistäsi kysytään yhä; kieltosäännöt ovat yhä voimassa. Käytä tätä vain projektissa, johon luotat.",
  "dialog.bypassPermissions.confirm": "Ohita käyttöoikeudet",
  "dialog.bypassPermissions.cancel": "Peruuta",
  "ui.permission.always.project": "Salli aina tässä projektissa",
  "ui.permission.always.session": "Salli tässä istunnossa",
  "ui.permission.always.acceptEdits": "Salli kaikki muokkaukset (Hyväksy muokkaukset)",
  "ui.permission.always.everything": "kaikki tälle työkalulle",
  "ui.permission.guard.floor.title": "Suojattu toiminto",
  "ui.permission.guard.guard.title": "Vaatii tarkistuksen",
  "ui.permission.guard.noAlways": "Tämän voi hyväksyä vain kerran",
  "ui.permission.writes": "Kirjoituskohteet",
  "ui.question.planFeedback.placeholder": "Kerro agentille, mitä suunnitelmassa pitää muuttaa",
  ...
  "dialog.server.description": "Vaihda AgentCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan AgentCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan AgentCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään AgentCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään AgentCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä AgentCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna AgentCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin AgentCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "AgentCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten AgentCode uudelleen.",
  ...
  "toast.permissions.modeMigrated.title": "Automaattinen hyväksyntä on nyt ”Hyväksy muokkaukset”",
  "toast.permissions.modeMigrated.description":
    "Tämän kansion muokkaukset hyväksytään automaattisesti; komennoista kysytään yhä. Saat täyden autonomian valitsemalla viestikentästä ”Ohita käyttöoikeudet”.",
  "toast.permissions.autoAcceptRemoved.title": "Automaattinen hyväksyntä poistettiin käytöstä",
  "toast.permissions.autoAcceptRemoved.modes":
    "Lupapyynnöt näytetään taas. Jos haluat hyväksyä muokkaukset automaattisesti, valitse ”Hyväksy muokkaukset” kehotteen vieressä olevasta tilavalikosta tai paina Shift+Tab.",
  "toast.permissions.autoAcceptRemoved.rules":
    "Lupapyynnöt näytetään taas. Jos haluat ohittaa ne, salli kyseiset työkalut tämän palvelimen käyttöoikeusmäärityksissä.",
  "toast.permissions.mode.error.title": "Käyttöoikeustilan vaihtaminen epäonnistui",
  ...
  "toast.model.selected.title": "Malli: {{name}}",
  "toast.model.selected.others": "Muut osumat: {{count}}. Valitse yksi suorittamalla /model.",
  "toast.model.noMatch.title": "Mikään malli ei vastaa hakua ”{{query}}”",
  "toast.agent.noMatch.title": "Agenttia nimeltä ”{{query}}” ei ole",
  ...
  "toast.update.description": "AgentCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä AgentCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että AgentCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "AgentCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita AgentCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda AgentCoden näyttökieli",
  "settings.general.permissionMode.title": "Oletuskäyttöoikeustila",
  "settings.general.permissionMode.description": "Käytetään tämän kansion uusissa istunnoissa",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä AgentCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö AgentCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta AgentCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun AgentCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät AgentCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "AgentCode-valikko",
  ...
  "desktop.recovery.loadFailed": "AgentCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "AgentCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "AgentCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "AgentCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AgentCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AgentCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "AgentCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
