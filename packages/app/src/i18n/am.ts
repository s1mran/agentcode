export const dict = {
  ...
  "desktop.recovery.loadFailed": "AgentCode መጫን አልቻለም",
  "desktop.recovery.terminated": "AgentCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "AgentCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "AgentCodeመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.opencodeMissing": "opencode በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.opencodeCannotRun": "opencode ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.opencodeNotInstalled": "AgentCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "AgentCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "command.permissionMode.cycle": "የፈቃድ ሁነታን ቀይር",
  "command.permissionMode.set": "የፈቃድ ሁነታ: {{mode}}",
  "command.permissionMode.bypass": "ፈቃዶችን እለፍ…",
  "command.plan": "የዕቅድ ሁነታ",
  ...
  "command.session.compact.hint": "[የትኩረት መመሪያዎች]",
  ...
  "command.session.export.hint": "[የፋይል ስም]",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በAgentCode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በAgentCode ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በAgentCode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በAgentCode ይጠቀሙ።",
  ...
  "prompt.permissionMode.label": "የፈቃድ ሁነታ",
  "prompt.permissionMode.default": "ፈቃድ ጠይቅ",
  "prompt.permissionMode.default.description": "ከትዕዛዞች፣ ከአርትዖቶች እና ከድር መዳረሻ በፊት ይጠይቃል",
  "prompt.permissionMode.acceptEdits": "አርትዖቶችን ተቀበል",
  "prompt.permissionMode.acceptEdits.description": "በዚህ ፕሮጀክት ውስጥ ያሉ አርትዖቶች ይጸድቃሉ፤ ለትዕዛዞች አሁንም ይጠይቃል",
  "prompt.permissionMode.plan": "የዕቅድ ሁነታ",
  "prompt.permissionMode.plan.description": "ለንባብ ብቻ የሆነ ምርምር፤ የዕቅድ ፋይሉ ብቻ ነው ሊስተካከል የሚችለው",
  "prompt.permissionMode.bypassPermissions": "ፈቃዶችን እለፍ",
  "prompt.permissionMode.bypassPermissions.description": "ሳይጠይቅ ይሠራል፤ ከተጠበቁ ዱካዎች፣ ከወሳኝ ስረዛዎች እና ከእርስዎ የጥያቄ ደንቦች በስተቀር",
  "prompt.permissionMode.dontAsk": "አትጠይቅ",
  "prompt.permissionMode.dontAsk.description": "መጠየቅ የሚያስፈልገው ማንኛውም ነገር ይከለከላል",
  ...
  "prompt.slash.badge.builtin": "አብሮ የተሰራ",
  "prompt.slash.hint.arguments": "[ነጋሪ እሴቶች]",
  "prompt.slash.hint.positional": "<ነጋሪ{{n}}>",
  "prompt.slash.unknown.title": "ያልታወቀ ትዕዛዝ፦ /{{name}}",
  "prompt.slash.unknown.description": "እንደ ጽሑፍ ለመላክ መልዕክቱን በክፍተት ይጀምሩ።",
  "prompt.slash.unavailable.title": "/{{name}} እዚህ አይገኝም",
  "prompt.slash.noArguments.title": "/{{name}} ነጋሪ እሴቶችን አይቀበልም",
  ...
  "dialog.bypassPermissions.title": "ፈቃዶችን ማለፍ ይፈልጋሉ?",
  "dialog.bypassPermissions.body":
    "ወኪሉ ሳይጠይቅ ትዕዛዞችን ያሂዳል፣ ፋይሎችን ያስተካክላል እና ድሩን ይደርሳል። ለተጠበቁ ዱካዎች (.git፣ የወኪል ውቅረት፣ የሼል ማስጀመሪያ ፋይሎች)፣ ለወሳኝ ስረዛዎች እና ለእርስዎ የጥያቄ ደንቦች አሁንም ይጠይቃል፤ የመከልከል ደንቦችም አሁንም ይተገበራሉ። ይህንን በሚያምኑት ፕሮጀክት ውስጥ ብቻ ይጠቀሙ።",
  "dialog.bypassPermissions.confirm": "ፈቃዶችን እለፍ",
  "dialog.bypassPermissions.cancel": "ሰርዝ",
  "ui.permission.always.project": "በዚህ ፕሮጀክት ውስጥ ሁልጊዜ ፍቀድ",
  "ui.permission.always.session": "ለዚህ ክፍለ ጊዜ ፍቀድ",
  "ui.permission.always.acceptEdits": "ሁሉንም አርትዖቶች ፍቀድ (አርትዖቶችን ተቀበል)",
  "ui.permission.always.everything": "ለዚህ መሳሪያ ሁሉም ነገር",
  "ui.permission.guard.floor.title": "የተጠበቀ እርምጃ",
  "ui.permission.guard.guard.title": "ግምገማ ያስፈልጋል",
  "ui.permission.guard.noAlways": "ይህ አንድ ጊዜ ብቻ ሊጸድቅ ይችላል",
  "ui.permission.writes": "የሚጽፍባቸው",
  "ui.question.planFeedback.placeholder": "በዕቅዱ ውስጥ ምን መቀየር እንዳለበት ለወኪሉ ይንገሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው AgentCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ AgentCode...",
  "wsl.onboarding.checkingOpencodeIn": "AgentCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ AgentCode...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ AgentCode በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን AgentCode በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን AgentCode",
  "wsl.onboarding.opencodeReadyIn": "AgentCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "AgentCode ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን AgentCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን AgentCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) AgentCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "AgentCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ AgentCode።",
  ...
  "help.tabs.introduction": "AgentCode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.permissions.modeMigrated.title": "በራስ-መቀበል አሁን «አርትዖቶችን ተቀበል» ሆኗል",
  "toast.permissions.modeMigrated.description":
    "በዚህ አቃፊ ውስጥ ያሉ አርትዖቶች በራስ-ሰር ይጸድቃሉ፤ ለትዕዛዞች አሁንም ይጠይቃል። ሙሉ ነጻነት ለመስጠት በአቀናባሪው ውስጥ «ፈቃዶችን እለፍ»ን ይምረጡ።",
  "toast.permissions.autoAcceptRemoved.title": "በራስ-መቀበል ጠፍቷል",
  "toast.permissions.autoAcceptRemoved.modes":
    "የፈቃድ ጥያቄዎች እንደገና ይታያሉ። አርትዖቶችን በራስ-ሰር ለማጽደቅ ከፕሮምፕቱ አጠገብ ባለው የሁነታ ምናሌ ውስጥ «አርትዖቶችን ተቀበል»ን ይምረጡ ወይም Shift+Tab ይጫኑ።",
  "toast.permissions.autoAcceptRemoved.rules":
    "የፈቃድ ጥያቄዎች እንደገና ይታያሉ። እነሱን ለመዝለል በዚህ አገልጋይ የፈቃድ ውቅረት ውስጥ እነዚያን መሳሪያዎች ይፍቀዱ።",
  "toast.permissions.mode.error.title": "የፈቃድ ሁነታን መቀየር አልተቻለም",
  "toast.model.none.title": "ምንም ሞዴል አልተመረጠም",
  "toast.model.none.description": "ይህን ክፍለ ጊዜ ለማጠቃለል አቅራቢን ያገናኙ",
  "toast.model.selected.title": "ሞዴል፦ {{name}}",
  "toast.model.selected.others": "ሌሎች ተዛማጆች፦ {{count}}። አንዱን ለመምረጥ /model ያሂዱ።",
  "toast.model.noMatch.title": "ከ«{{query}}» ጋር የሚዛመድ ሞዴል የለም",
  "toast.agent.noMatch.title": "«{{query}}» የተባለ ወኪል የለም",
  ...
  "toast.update.description": "አዲሱ የAgentCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለAgentCode ቡድን ያሳውቁ",
  "error.page.report.discord": "በGitHub",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ AgentCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "AgentCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "AgentCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የAgentCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለAgentCode",
  "settings.general.permissionMode.title": "ነባሪ የፈቃድ ሁነታ",
  "settings.general.permissionMode.description": "በዚህ አቃፊ ውስጥ ላሉ አዲስ ክፍለ ጊዜዎች ጥቅም ላይ ይውላል",
  ...
  "settings.general.row.appearance.description": "AgentCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "AgentCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "AgentCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "AgentCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የAgentCode እትም እያሄዱ ነው።",
