export const dict = {
  ...
  "ui.message.revertMessage.partial.one": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.message.revertMessage.partial.other": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.message.revertMessage.partial.zero": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.message.revertMessage.partial.two": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.message.revertMessage.partial.few": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.message.revertMessage.partial.many": "التراجع عن الرسالة (ملفات لا يمكن استعادتها: {{count}})",
  "ui.checkpoint.skipped.one": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.skipped.other": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.skipped.zero": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.skipped.two": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.skipped.few": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.skipped.many": "ملفات تغيّرت هنا ولا يمكن للتراجع استعادتها: {{count}}",
  "ui.checkpoint.reason.ignored": "متجاهَل، لم يُحفظ",
  "ui.checkpoint.reason.large": "أكبر من 2 ميغابايت",
  "ui.checkpoint.reason.outside": "خارج مجلد المشروع",
  "ui.checkpoint.reason.offline": "ملف سحابي غير مُنزَّل",
  "ui.checkpoint.reason.unavailable": "نقاط الاستعادة معطّلة",
  "ui.checkpoint.unavailable.root":
    "نقاط الاستعادة معطّلة لأن هذا جذر محرك أقراص. لا يمكن للتراجع استعادة هذه الملفات.",
  "ui.checkpoint.unavailable.home": "نقاط الاستعادة معطّلة في مجلد المنزل. افتح مجلد مشروع للحصول على التراجع.",
  "ui.checkpoint.unavailable.data-dir": "نقاط الاستعادة معطّلة لأن هذا المجلد يحتوي على بيانات AgentCode الخاصة.",
  "ui.checkpoint.unavailable.too-many-files":
    "نقاط الاستعادة معطّلة: يحتوي هذا المجلد على أكثر من 20,000 ملف بعد استبعاد التبعيات ومخرجات البناء.",
  "ui.checkpoint.unavailable.too-large": "نقاط الاستعادة معطّلة: يحتوي هذا المجلد على أكثر من 512 ميغابايت من الملفات.",
  "ui.checkpoint.unavailable.slow":
    "نقاط الاستعادة معطّلة مؤقتًا: استغرق فحص هذا المجلد وقتًا طويلًا. ستتم المحاولة مرة أخرى قريبًا.",
  "ui.checkpoint.unavailable.no-git": "نقاط الاستعادة معطّلة: Git غير مثبّت. ثبّت Git لتتمكن من التراجع.",
