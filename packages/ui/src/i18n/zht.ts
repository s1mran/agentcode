...
export const dict = {
  ...
  "ui.message.revertMessage.partial.one": "重設至此點（{{count}} 個檔案無法還原）",
  "ui.message.revertMessage.partial.other": "重設至此點（{{count}} 個檔案無法還原）",
  "ui.checkpoint.skipped.one": "復原無法還原此處變更的 {{count}} 個檔案",
  "ui.checkpoint.skipped.other": "復原無法還原此處變更的 {{count}} 個檔案",
  "ui.checkpoint.reason.ignored": "已忽略，未擷取",
  "ui.checkpoint.reason.large": "大於 2 MB",
  "ui.checkpoint.reason.outside": "位於專案資料夾之外",
  "ui.checkpoint.reason.offline": "雲端檔案未下載",
  "ui.checkpoint.reason.unavailable": "檢查點已關閉",
  "ui.checkpoint.unavailable.root": "此處是磁碟機根目錄，因此檢查點已關閉。復原無法還原這些檔案。",
  "ui.checkpoint.unavailable.home": "主資料夾中的檢查點已關閉。請開啟專案資料夾以使用復原。",
  "ui.checkpoint.unavailable.data-dir": "此資料夾包含 AgentCode 本身的資料，因此檢查點已關閉。",
  "ui.checkpoint.unavailable.too-many-files":
    "檢查點已關閉：略過相依套件和建置輸出後，此資料夾仍有超過 20,000 個檔案。",
  "ui.checkpoint.unavailable.too-large": "檢查點已關閉：此資料夾中的檔案超過 512 MB。",
  "ui.checkpoint.unavailable.slow": "檢查點暫時關閉：掃描此資料夾耗時過長，稍後將重試。",
  "ui.checkpoint.unavailable.no-git": "檢查點已關閉：未安裝 Git。請安裝 Git 以使用復原。",
