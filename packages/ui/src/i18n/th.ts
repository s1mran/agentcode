export const dict = {
  ...
  "ui.promptInput.chooseMode": "โหมดสิทธิ์",
  ...
  "ui.message.revertMessage.partial.one": "รีเซ็ตไปยังจุดนี้ (กู้คืนไฟล์ {{count}} ไฟล์ไม่ได้)",
  "ui.message.revertMessage.partial.other": "รีเซ็ตไปยังจุดนี้ (กู้คืนไฟล์ {{count}} ไฟล์ไม่ได้)",
  "ui.checkpoint.skipped.one": "การเลิกทำกู้คืนไฟล์ {{count}} ไฟล์ที่เปลี่ยนแปลงที่นี่ไม่ได้",
  "ui.checkpoint.skipped.other": "การเลิกทำกู้คืนไฟล์ {{count}} ไฟล์ที่เปลี่ยนแปลงที่นี่ไม่ได้",
  "ui.checkpoint.reason.ignored": "ถูกละเว้น ไม่ได้บันทึก",
  "ui.checkpoint.reason.large": "ใหญ่กว่า 2 MB",
  "ui.checkpoint.reason.outside": "อยู่นอกโฟลเดอร์โปรเจกต์",
  "ui.checkpoint.reason.offline": "ไฟล์คลาวด์ยังไม่ได้ดาวน์โหลด",
  "ui.checkpoint.reason.unavailable": "ปิดจุดตรวจสอบ",
  "ui.checkpoint.unavailable.root": "จุดตรวจสอบถูกปิดเพราะนี่คือรากของไดรฟ์ การเลิกทำกู้คืนไฟล์เหล่านี้ไม่ได้",
  "ui.checkpoint.unavailable.home": "จุดตรวจสอบถูกปิดในโฟลเดอร์หลักของคุณ เปิดโฟลเดอร์โปรเจกต์เพื่อใช้การเลิกทำ",
  "ui.checkpoint.unavailable.data-dir": "จุดตรวจสอบถูกปิดเพราะโฟลเดอร์นี้มีข้อมูลของ AgentCode เอง",
  "ui.checkpoint.unavailable.too-many-files":
    "จุดตรวจสอบถูกปิด: โฟลเดอร์นี้มีไฟล์มากกว่า 20,000 ไฟล์หลังจากข้าม dependencies และผลลัพธ์การ build",
  "ui.checkpoint.unavailable.too-large": "จุดตรวจสอบถูกปิด: โฟลเดอร์นี้มีไฟล์มากกว่า 512 MB",
  "ui.checkpoint.unavailable.slow":
    "จุดตรวจสอบปิดชั่วคราว: การสแกนโฟลเดอร์นี้ใช้เวลานานเกินไป จะลองใหม่อีกครั้งในไม่ช้า",
  "ui.checkpoint.unavailable.no-git": "จุดตรวจสอบถูกปิด: ยังไม่ได้ติดตั้ง Git ติดตั้ง Git เพื่อให้เลิกทำได้",
