...
export const dict = {
  ...
  "ui.promptInput.chooseMode": "权限模式",
  ...
  "ui.message.revertMessage.partial.one": "撤销此消息（{{count}} 个文件无法恢复）",
  "ui.message.revertMessage.partial.other": "撤销此消息（{{count}} 个文件无法恢复）",
  "ui.checkpoint.skipped.one": "撤销无法恢复此处更改的 {{count}} 个文件",
  "ui.checkpoint.skipped.other": "撤销无法恢复此处更改的 {{count}} 个文件",
  "ui.checkpoint.reason.ignored": "已忽略，未捕获",
  "ui.checkpoint.reason.large": "大于 2 MB",
  "ui.checkpoint.reason.outside": "位于项目文件夹之外",
  "ui.checkpoint.reason.offline": "云端文件未下载",
  "ui.checkpoint.reason.unavailable": "检查点已关闭",
  "ui.checkpoint.unavailable.root": "此处是驱动器根目录，因此检查点已关闭。撤销无法恢复这些文件。",
  "ui.checkpoint.unavailable.home": "主文件夹中的检查点已关闭。请打开项目文件夹以使用撤销。",
  "ui.checkpoint.unavailable.data-dir": "此文件夹包含 AgentCode 自身的数据，因此检查点已关闭。",
  "ui.checkpoint.unavailable.too-many-files": "检查点已关闭：跳过依赖项和构建输出后，此文件夹仍有超过 20,000 个文件。",
  "ui.checkpoint.unavailable.too-large": "检查点已关闭：此文件夹中的文件超过 512 MB。",
  "ui.checkpoint.unavailable.slow": "检查点暂时关闭：扫描此文件夹耗时过长，稍后将重试。",
  "ui.checkpoint.unavailable.no-git": "检查点已关闭：未安装 Git。请安装 Git 以使用撤销。",
